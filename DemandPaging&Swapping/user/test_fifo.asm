...
user/_test_fifo:     file format elf64-littleriscv
...
int main(void) {
  ...
  printf("FIFO test start\n");
   ...
   c:	8b850513          	addi	a0,a0,-1864 # 8c0 <malloc+0x104>
  10:	6f8000ef          	jal	708 <printf>
  char *p = sbrk(PAGES * 4096);
  14:	01ec3537          	lui	a0,0x1ec3
  18:	28c000ef          	jal	2a4 <sbrk>
  for (int i = 0; i < PAGES * 4096; i += 4096) {
  1c:	01ec37b7          	lui	a5,0x1ec3
  20:	97aa                	add	a5,a5,a0
    p[i] = 42;  // touch each page once
  22:	02a00693          	li	a3,42
  for (int i = 0; i < PAGES * 4096; i += 4096) {
  26:	6705                	lui	a4,0x1
    p[i] = 42;  // touch each page once
  28:	00d50023          	sb	a3,0(a0) # 1ec3000 <base+0x1ec1ff0>
  for (int i = 0; i < PAGES * 4096; i += 4096) {
  2c:	953a                	add	a0,a0,a4
  2e:	fef51de3          	bne	a0,a5,28 <main+0x28>
  }
  printf("FIFO test end\n");
  32:	00001517          	auipc	a0,0x1
  36:	8a650513          	addi	a0,a0,-1882 # 8d8 <malloc+0x11c>
  3a:	6ce000ef          	jal	708 <printf>
  exit(0);
  3e:	4501                	li	a0,0
...
strcpy(char *s, const char *t)
{
  ...
  5e:	0785                	addi	a5,a5,1 # 1ec3001 <base+0x1ec1ff1>
...
atoi(const char *s)
{
 ...
 1d0:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
 1d2:	0705                	addi	a4,a4,1 # 1001 <freep+0x1>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ac:	0805c363          	bltz	a1,432 <printint+0x94>
  neg = 0;
 3b0:	4881                	li	a7,0
 ...
 3bc:	53850513          	addi	a0,a0,1336 # 8f0 <digits>
 3c0:	883e                	mv	a6,a5
 3c2:	2785                	addiw	a5,a5,1
 3c4:	02c5f733          	remu	a4,a1,a2
 3c8:	972a                	add	a4,a4,a0
 3ca:	00074703          	lbu	a4,0(a4)
 3ce:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
 3d2:	872e                	mv	a4,a1
 3d4:	02c5d5b3          	divu	a1,a1,a2
 3d8:	0685                	addi	a3,a3,1
 3da:	fec773e3          	bgeu	a4,a2,3c0 <printint+0x22>
  if(neg)
 3de:	00088b63          	beqz	a7,3f4 <printint+0x56>
    buf[i++] = '-';
 3e2:	fd078793          	addi	a5,a5,-48
 3e6:	97a2                	add	a5,a5,s0
 3e8:	02d00713          	li	a4,45
 3ec:	fee78423          	sb	a4,-24(a5)
 3f0:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
 3f4:	02f05a63          	blez	a5,428 <printint+0x8a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 538:	855a                	mv	a0,s6
 53a:	e47ff0ef          	jal	380 <putc>
        putc(fd, c0);
 53e:	85ca                	mv	a1,s2
 540:	855a                	mv	a0,s6
 542:	e3fff0ef          	jal	380 <putc>
      state = 0;
 546:	4981                	li	s3,0
 ...
 6b4:	23890913          	addi	s2,s2,568 # 8e8 <malloc+0x12c>
        for(; *s; s++)
