...
user/_test_invalid:     file format elf64-littleriscv
...
int main(void)
{
  ...
  printf("[test_invalid] start\n");
   ...
   c:	98850513          	addi	a0,a0,-1656 # 990 <malloc+0xfc>
  10:	7d0000ef          	jal	7e0 <printf>

  int pid = fork();
  14:	394000ef          	jal	3a8 <fork>
  if (pid < 0) {
  18:	02054f63          	bltz	a0,56 <main+0x56>
  ...
  20:	6509                	lui	a0,0x2
  22:	370000ef          	jal	392 <sbrklazy>
  26:	84aa                	mv	s1,a0
    if (heap == (char*)-1) exit(2);
  28:	57fd                	li	a5,-1
  2a:	04f50063          	beq	a0,a5,6a <main+0x6a>
    heap[0] = 0x13; // write ok
  2e:	47cd                	li	a5,19
  30:	00f50023          	sb	a5,0(a0) # 2000 <base+0xff0>
  ...
  3a:	9a250513          	addi	a0,a0,-1630 # 9d8 <malloc+0x144>
  3e:	7a2000ef          	jal	7e0 <printf>
    fn(); // should cause KILL invalid-access access=exec
  42:	9482                	jalr	s1
    // If we get here, failure
    printf("[test_invalid] unexpected: executed from heap\n");
  44:	00001517          	auipc	a0,0x1
  48:	9cc50513          	addi	a0,a0,-1588 # a10 <malloc+0x17c>
  4c:	794000ef          	jal	7e0 <printf>
    exit(3);
  50:	450d                	li	a0,3
  52:	35e000ef          	jal	3b0 <exit>
  56:	ec26                	sd	s1,24(sp)
    printf("[test_invalid] fork failed\nTEST FAILED\n");
  58:	00001517          	auipc	a0,0x1
  5c:	95850513          	addi	a0,a0,-1704 # 9b0 <malloc+0x11c>
  60:	780000ef          	jal	7e0 <printf>
    exit(1);
  64:	4505                	li	a0,1
  66:	34a000ef          	jal	3b0 <exit>
    if (heap == (char*)-1) exit(2);
  6a:	4509                	li	a0,2
  6c:	344000ef          	jal	3b0 <exit>
  }
  int st = 0;
  70:	fc042e23          	sw	zero,-36(s0)
  wait(&st);
  74:	fdc40513          	addi	a0,s0,-36
  78:	340000ef          	jal	3b8 <wait>
  if (st != 0) {
  7c:	fdc42583          	lw	a1,-36(s0)
  80:	c1a9                	beqz	a1,c2 <main+0xc2>
    printf("[test_invalid] child killed as expected (status=%d)\n", st);
  82:	00001517          	auipc	a0,0x1
  86:	9be50513          	addi	a0,a0,-1602 # a40 <malloc+0x1ac>
  8a:	756000ef          	jal	7e0 <printf>
  ...
  pid = fork();
  8e:	31a000ef          	jal	3a8 <fork>
  if (pid == 0) {
  92:	c131                	beqz	a0,d6 <main+0xd6>
  94:	ec26                	sd	s1,24(sp)
  ...
  wait(&st);
  96:	fdc40513          	addi	a0,s0,-36
  9a:	31e000ef          	jal	3b8 <wait>
  if (st != 0) {
  9e:	fdc42783          	lw	a5,-36(s0)
  a2:	c7a5                	beqz	a5,10a <main+0x10a>
    printf("[test_invalid] child killed on invalid read as expected\n");
  a4:	00001517          	auipc	a0,0x1
  a8:	a7450513          	addi	a0,a0,-1420 # b18 <malloc+0x284>
  ac:	734000ef          	jal	7e0 <printf>
    printf("TEST PASSED\n");
  b0:	00001517          	auipc	a0,0x1
  b4:	aa850513          	addi	a0,a0,-1368 # b58 <malloc+0x2c4>
  b8:	728000ef          	jal	7e0 <printf>
    exit(0);
  bc:	4501                	li	a0,0
  be:	2f2000ef          	jal	3b0 <exit>
  c2:	ec26                	sd	s1,24(sp)
    printf("[test_invalid] child exited cleanly (unexpected)\nTEST FAILED\n");
  c4:	00001517          	auipc	a0,0x1
  c8:	9b450513          	addi	a0,a0,-1612 # a78 <malloc+0x1e4>
  cc:	714000ef          	jal	7e0 <printf>
    exit(1);
  d0:	4505                	li	a0,1
  d2:	2de000ef          	jal	3b0 <exit>
  d6:	ec26                	sd	s1,24(sp)
    printf("[test_invalid] child reading invalid VA %p\n", bad);
  d8:	4585                	li	a1,1
  da:	15ba                	slli	a1,a1,0x2e
  dc:	00001517          	auipc	a0,0x1
  e0:	9dc50513          	addi	a0,a0,-1572 # ab8 <malloc+0x224>
  e4:	6fc000ef          	jal	7e0 <printf>
    x = *bad;
  e8:	4785                	li	a5,1
  ea:	17ba                	slli	a5,a5,0x2e
  ec:	0007c783          	lbu	a5,0(a5)
  f0:	fcf40da3          	sb	a5,-37(s0)
    printf("[test_invalid] unexpected: read succeeded (%d)\n", x);
  f4:	fdb44583          	lbu	a1,-37(s0)
  f8:	00001517          	auipc	a0,0x1
  fc:	9f050513          	addi	a0,a0,-1552 # ae8 <malloc+0x254>
 100:	6e0000ef          	jal	7e0 <printf>
    exit(4);
 104:	4511                	li	a0,4
 106:	2aa000ef          	jal	3b0 <exit>
  }
  printf("[test_invalid] child exited cleanly (unexpected)\nTEST FAILED\n");
 10a:	00001517          	auipc	a0,0x1
 10e:	96e50513          	addi	a0,a0,-1682 # a78 <malloc+0x1e4>
 112:	6ce000ef          	jal	7e0 <printf>
  exit(1);
 116:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 494:	6e050513          	addi	a0,a0,1760 # b70 <digits>
 498:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72a:	44ab8b93          	addi	s7,s7,1098 # b70 <digits>
 ...
 78c:	3e090913          	addi	s2,s2,992 # b68 <malloc+0x2d4>
        for(; *s; s++)
