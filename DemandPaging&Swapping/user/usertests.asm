...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	8c278793          	addi	a5,a5,-1854 # 78d0 <malloc+0x267c>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	2ea50513          	addi	a0,a0,746 # 5350 <malloc+0xfc>
      6e:	132050ef          	jal	51a0 <printf>
      exit(1);
      72:	4505                	li	a0,1
      74:	4fd040ef          	jal	4d70 <exit>
      ...
      94:	8082                	ret
{
      ...
      a4:	2d050513          	addi	a0,a0,720 # 5370 <malloc+0x11c>
      a8:	0f8050ef          	jal	51a0 <printf>
      exit(1);
      ac:	4505                	li	a0,1
      ae:	4c3040ef          	jal	4d70 <exit>
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	2c850513          	addi	a0,a0,712 # 5388 <malloc+0x134>
      c8:	4e9040ef          	jal	4db0 <open>
  if(fd < 0){
      cc:	02054263          	bltz	a0,f0 <opentest+0x3e>
  close(fd);
      d0:	4c9040ef          	jal	4d98 <close>
  fd = open("doesnotexist", 0);
      d4:	4581                	li	a1,0
      d6:	00005517          	auipc	a0,0x5
      da:	2d250513          	addi	a0,a0,722 # 53a8 <malloc+0x154>
      de:	4d3040ef          	jal	4db0 <open>
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	29e50513          	addi	a0,a0,670 # 5390 <malloc+0x13c>
      fa:	0a6050ef          	jal	51a0 <printf>
    exit(1);
      fe:	4505                	li	a0,1
     100:	471040ef          	jal	4d70 <exit>
    printf("%s: open doesnotexist succeeded!\n", s);
     104:	85a6                	mv	a1,s1
     106:	00005517          	auipc	a0,0x5
     10a:	2b250513          	addi	a0,a0,690 # 53b8 <malloc+0x164>
     10e:	092050ef          	jal	51a0 <printf>
    exit(1);
     112:	4505                	li	a0,1
     114:	45d040ef          	jal	4d70 <exit>
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     12c:	2b850513          	addi	a0,a0,696 # 53e0 <malloc+0x18c>
     130:	491040ef          	jal	4dc0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     134:	60100593          	li	a1,1537
     138:	00005517          	auipc	a0,0x5
     13c:	2a850513          	addi	a0,a0,680 # 53e0 <malloc+0x18c>
     140:	471040ef          	jal	4db0 <open>
     144:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     146:	4611                	li	a2,4
     148:	00005597          	auipc	a1,0x5
     14c:	2a858593          	addi	a1,a1,680 # 53f0 <malloc+0x19c>
     150:	441040ef          	jal	4d90 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     154:	40100593          	li	a1,1025
     158:	00005517          	auipc	a0,0x5
     15c:	28850513          	addi	a0,a0,648 # 53e0 <malloc+0x18c>
     160:	451040ef          	jal	4db0 <open>
     164:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     166:	4605                	li	a2,1
     168:	00005597          	auipc	a1,0x5
     16c:	29058593          	addi	a1,a1,656 # 53f8 <malloc+0x1a4>
     170:	8526                	mv	a0,s1
     172:	41f040ef          	jal	4d90 <write>
  if(n != -1){
     176:	57fd                	li	a5,-1
     178:	02f51563          	bne	a0,a5,1a2 <truncate2+0x8a>
  unlink("truncfile");
     17c:	00005517          	auipc	a0,0x5
     180:	26450513          	addi	a0,a0,612 # 53e0 <malloc+0x18c>
     184:	43d040ef          	jal	4dc0 <unlink>
  close(fd1);
     188:	8526                	mv	a0,s1
     18a:	40f040ef          	jal	4d98 <close>
  close(fd2);
     18e:	854a                	mv	a0,s2
     190:	409040ef          	jal	4d98 <close>
}
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	25a50513          	addi	a0,a0,602 # 5400 <malloc+0x1ac>
     1ae:	7f3040ef          	jal	51a0 <printf>
    exit(1);
     1b2:	4505                	li	a0,1
     1b4:	3bd040ef          	jal	4d70 <exit>
...
00000000000001b8 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     1e4:	3cd040ef          	jal	4db0 <open>
    close(fd);
     1e8:	3b1040ef          	jal	4d98 <close>
  for(i = 0; i < N; i++){
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	1e450513          	addi	a0,a0,484 # 5428 <malloc+0x1d4>
     24c:	375040ef          	jal	4dc0 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	1d4a8a93          	addi	s5,s5,468 # 5428 <malloc+0x1d4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    if(fd < 0){
     ...
     28a:	85d2                	mv	a1,s4
     28c:	854a                	mv	a0,s2
     28e:	303040ef          	jal	4d90 <write>
      if(cc != sz){
     292:	04951263          	bne	a0,s1,2d6 <bigwrite+0xaa>
    close(fd);
     296:	854a                	mv	a0,s2
     298:	301040ef          	jal	4d98 <close>
    unlink("bigwrite");
     29c:	8556                	mv	a0,s5
     29e:	323040ef          	jal	4dc0 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	17650513          	addi	a0,a0,374 # 5438 <malloc+0x1e4>
     2ca:	6d7040ef          	jal	51a0 <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     2d0:	2a1040ef          	jal	4d70 <exit>
      if(cc != sz){
     2d4:	89a6                	mv	s3,s1
     ...
     2e0:	17c50513          	addi	a0,a0,380 # 5458 <malloc+0x204>
     2e4:	6bd040ef          	jal	51a0 <printf>
        exit(1);
     2e8:	4505                	li	a0,1
     2ea:	287040ef          	jal	4d70 <exit>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	17250513          	addi	a0,a0,370 # 5470 <malloc+0x21c>
     306:	2bb040ef          	jal	4dc0 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	16298993          	addi	s3,s3,354 # 5470 <malloc+0x21c>
    if(fd < 0){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     32c:	4605                	li	a2,1
     32e:	85d2                	mv	a1,s4
     330:	261040ef          	jal	4d90 <write>
    close(fd);
     334:	8526                	mv	a0,s1
     336:	263040ef          	jal	4d98 <close>
    unlink("junk");
     33a:	854e                	mv	a0,s3
     33c:	285040ef          	jal	4dc0 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	12650513          	addi	a0,a0,294 # 5470 <malloc+0x21c>
     352:	25f040ef          	jal	4db0 <open>
     356:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	09a58593          	addi	a1,a1,154 # 53f8 <malloc+0x1a4>
     366:	22b040ef          	jal	4d90 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	12050513          	addi	a0,a0,288 # 5490 <malloc+0x23c>
     378:	629040ef          	jal	51a0 <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	1f3040ef          	jal	4d70 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	0f650513          	addi	a0,a0,246 # 5478 <malloc+0x224>
     38a:	617040ef          	jal	51a0 <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	1e1040ef          	jal	4d70 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	0e450513          	addi	a0,a0,228 # 5478 <malloc+0x224>
     39c:	605040ef          	jal	51a0 <printf>
    exit(1);
     3a0:	4505                	li	a0,1
     3a2:	1cf040ef          	jal	4d70 <exit>
  }
  close(fd);
     3a6:	8526                	mv	a0,s1
     3a8:	1f1040ef          	jal	4d98 <close>
  unlink("junk");
     3ac:	00005517          	auipc	a0,0x5
     3b0:	0c450513          	addi	a0,a0,196 # 5470 <malloc+0x21c>
     3b4:	20d040ef          	jal	4dc0 <unlink>

  exit(0);
     3b8:	4501                	li	a0,0
     3ba:	1b7040ef          	jal	4d70 <exit>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	44078793          	addi	a5,a5,1088 # 78d0 <malloc+0x267c>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	fe2a0a13          	addi	s4,s4,-30 # 54a0 <malloc+0x24c>
    uint64 addr = addrs[ai];
     4c6:	00093983          	ld	s3,0(s2)
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     4ca:	20100593          	li	a1,513
     4ce:	8552                	mv	a0,s4
     4d0:	0e1040ef          	jal	4db0 <open>
     4d4:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	f6450513          	addi	a0,a0,-156 # 54a8 <malloc+0x254>
     54c:	455040ef          	jal	51a0 <printf>
      exit(1);
     550:	4505                	li	a0,1
     552:	01f040ef          	jal	4d70 <exit>
      printf("write(fd, %p, 8192) returned %d, not -1\n", (void*)addr, n);
     556:	862a                	mv	a2,a0
     558:	85ce                	mv	a1,s3
     55a:	00005517          	auipc	a0,0x5
     55e:	f6650513          	addi	a0,a0,-154 # 54c0 <malloc+0x26c>
     562:	43f040ef          	jal	51a0 <printf>
      exit(1);
     566:	4505                	li	a0,1
     568:	009040ef          	jal	4d70 <exit>
      printf("write(1, %p, 8192) returned %d, not -1 or 0\n", (void*)addr, n);
     56c:	862a                	mv	a2,a0
     56e:	85ce                	mv	a1,s3
     570:	00005517          	auipc	a0,0x5
     574:	f8050513          	addi	a0,a0,-128 # 54f0 <malloc+0x29c>
     578:	429040ef          	jal	51a0 <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	7f2040ef          	jal	4d70 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	f9e50513          	addi	a0,a0,-98 # 5520 <malloc+0x2cc>
     58a:	417040ef          	jal	51a0 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     590:	7e0040ef          	jal	4d70 <exit>
      printf("write(pipe, %p, 8192) returned %d, not -1 or 0\n", (void*)addr, n);
     594:	862a                	mv	a2,a0
     596:	85ce                	mv	a1,s3
     598:	00005517          	auipc	a0,0x5
     59c:	f9850513          	addi	a0,a0,-104 # 5530 <malloc+0x2dc>
     5a0:	401040ef          	jal	51a0 <printf>
      exit(1);
     5a4:	4505                	li	a0,1
     5a6:	7ca040ef          	jal	4d70 <exit>
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	31278793          	addi	a5,a5,786 # 78d0 <malloc+0x267c>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	f6ea0a13          	addi	s4,s4,-146 # 5560 <malloc+0x30c>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	dfea8a93          	addi	s5,s5,-514 # 53f8 <malloc+0x1a4>
    uint64 addr = addrs[ai];
     602:	00093983          	ld	s3,0(s2)
    int fd = open("README", 0);
     606:	4581                	li	a1,0
     608:	8552                	mv	a0,s4
     60a:	7a6040ef          	jal	4db0 <open>
     60e:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	eea50513          	addi	a0,a0,-278 # 5568 <malloc+0x314>
     686:	31b040ef          	jal	51a0 <printf>
      exit(1);
     68a:	4505                	li	a0,1
     68c:	6e4040ef          	jal	4d70 <exit>
      printf("read(fd, %p, 8192) returned %d, not -1 or 0\n", (void*)addr, n);
     690:	862a                	mv	a2,a0
     692:	85ce                	mv	a1,s3
     694:	00005517          	auipc	a0,0x5
     698:	eec50513          	addi	a0,a0,-276 # 5580 <malloc+0x32c>
     69c:	305040ef          	jal	51a0 <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	6ce040ef          	jal	4d70 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	e7a50513          	addi	a0,a0,-390 # 5520 <malloc+0x2cc>
     6ae:	2f3040ef          	jal	51a0 <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	6bc040ef          	jal	4d70 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	ef850513          	addi	a0,a0,-264 # 55b0 <malloc+0x35c>
     6c0:	2e1040ef          	jal	51a0 <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     6c6:	6aa040ef          	jal	4d70 <exit>
      printf("read(pipe, %p, 8192) returned %d, not -1 or 0\n", (void*)addr, n);
     6ca:	862a                	mv	a2,a0
     6cc:	85ce                	mv	a1,s3
     6ce:	00005517          	auipc	a0,0x5
     6d2:	efa50513          	addi	a0,a0,-262 # 55c8 <malloc+0x374>
     6d6:	2cb040ef          	jal	51a0 <printf>
      exit(1);
     6da:	4505                	li	a0,1
     6dc:	694040ef          	jal	4d70 <exit>
...
00000000000006e0 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     6f8:	cec50513          	addi	a0,a0,-788 # 53e0 <malloc+0x18c>
     6fc:	6c4040ef          	jal	4dc0 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     700:	60100593          	li	a1,1537
     704:	00005517          	auipc	a0,0x5
     708:	cdc50513          	addi	a0,a0,-804 # 53e0 <malloc+0x18c>
     70c:	6a4040ef          	jal	4db0 <open>
     710:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     712:	4611                	li	a2,4
     714:	00005597          	auipc	a1,0x5
     718:	cdc58593          	addi	a1,a1,-804 # 53f0 <malloc+0x19c>
     71c:	674040ef          	jal	4d90 <write>
  close(fd1);
     720:	8526                	mv	a0,s1
     722:	676040ef          	jal	4d98 <close>
  int fd2 = open("truncfile", O_RDONLY);
     726:	4581                	li	a1,0
     728:	00005517          	auipc	a0,0x5
     72c:	cb850513          	addi	a0,a0,-840 # 53e0 <malloc+0x18c>
     730:	680040ef          	jal	4db0 <open>
     734:	84aa                	mv	s1,a0
  int n = read(fd2, buf, sizeof(buf));
     736:	02000613          	li	a2,32
     73a:	fa040593          	addi	a1,s0,-96
     73e:	64a040ef          	jal	4d88 <read>
  if(n != 4){
     742:	4791                	li	a5,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	c9450513          	addi	a0,a0,-876 # 53e0 <malloc+0x18c>
     754:	65c040ef          	jal	4db0 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	c8450513          	addi	a0,a0,-892 # 53e0 <malloc+0x18c>
     764:	64c040ef          	jal	4db0 <open>
     768:	892a                	mv	s2,a0
  n = read(fd3, buf, sizeof(buf));
     76a:	02000613          	li	a2,32
     76e:	fa040593          	addi	a1,s0,-96
     772:	616040ef          	jal	4d88 <read>
     776:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	eca58593          	addi	a1,a1,-310 # 5658 <malloc+0x404>
     796:	854e                	mv	a0,s3
     798:	5f8040ef          	jal	4d90 <write>
  n = read(fd3, buf, sizeof(buf));
     79c:	02000613          	li	a2,32
     7a0:	fa040593          	addi	a1,s0,-96
     7a4:	854a                	mv	a0,s2
     7a6:	5e2040ef          	jal	4d88 <read>
  if(n != 6){
     7aa:	4799                	li	a5,6
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     7b8:	8526                	mv	a0,s1
     7ba:	5ce040ef          	jal	4d88 <read>
  if(n != 2){
     7be:	4789                	li	a5,2
     7c0:	0af51463          	bne	a0,a5,868 <truncate1+0x188>
  unlink("truncfile");
     7c4:	00005517          	auipc	a0,0x5
     7c8:	c1c50513          	addi	a0,a0,-996 # 53e0 <malloc+0x18c>
     7cc:	5f4040ef          	jal	4dc0 <unlink>
  close(fd1);
     7d0:	854e                	mv	a0,s3
     7d2:	5c6040ef          	jal	4d98 <close>
  close(fd2);
     7d6:	8526                	mv	a0,s1
     7d8:	5c0040ef          	jal	4d98 <close>
  close(fd3);
     7dc:	854a                	mv	a0,s2
     7de:	5ba040ef          	jal	4d98 <close>
}
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e0050513          	addi	a0,a0,-512 # 55f8 <malloc+0x3a4>
     800:	1a1040ef          	jal	51a0 <printf>
    exit(1);
     804:	4505                	li	a0,1
     806:	56a040ef          	jal	4d70 <exit>
    printf("aaa fd3=%d\n", fd3);
     80a:	85ca                	mv	a1,s2
     80c:	00005517          	auipc	a0,0x5
     810:	e0c50513          	addi	a0,a0,-500 # 5618 <malloc+0x3c4>
     814:	18d040ef          	jal	51a0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e0c50513          	addi	a0,a0,-500 # 5628 <malloc+0x3d4>
     824:	17d040ef          	jal	51a0 <printf>
    exit(1);
     828:	4505                	li	a0,1
     82a:	546040ef          	jal	4d70 <exit>
    printf("bbb fd2=%d\n", fd2);
     82e:	85a6                	mv	a1,s1
     830:	00005517          	auipc	a0,0x5
     834:	e1850513          	addi	a0,a0,-488 # 5648 <malloc+0x3f4>
     838:	169040ef          	jal	51a0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	de850513          	addi	a0,a0,-536 # 5628 <malloc+0x3d4>
     848:	159040ef          	jal	51a0 <printf>
    exit(1);
     84c:	4505                	li	a0,1
     84e:	522040ef          	jal	4d70 <exit>
    printf("%s: read %d bytes, wanted 6\n", s, n);
     852:	862a                	mv	a2,a0
     854:	85d6                	mv	a1,s5
     856:	00005517          	auipc	a0,0x5
     85a:	e0a50513          	addi	a0,a0,-502 # 5660 <malloc+0x40c>
     85e:	143040ef          	jal	51a0 <printf>
    exit(1);
     862:	4505                	li	a0,1
     864:	50c040ef          	jal	4d70 <exit>
    printf("%s: read %d bytes, wanted 2\n", s, n);
     868:	862a                	mv	a2,a0
     86a:	85d6                	mv	a1,s5
     86c:	00005517          	auipc	a0,0x5
     870:	e1450513          	addi	a0,a0,-492 # 5680 <malloc+0x42c>
     874:	12d040ef          	jal	51a0 <printf>
    exit(1);
     878:	4505                	li	a0,1
     87a:	4f6040ef          	jal	4d70 <exit>
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e0850513          	addi	a0,a0,-504 # 56a0 <malloc+0x44c>
     8a0:	510040ef          	jal	4db0 <open>
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e1c98993          	addi	s3,s3,-484 # 56c8 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	e4ca8a93          	addi	s5,s5,-436 # 5700 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  close(fd);
     8e6:	854a                	mv	a0,s2
     8e8:	4b0040ef          	jal	4d98 <close>
  fd = open("small", O_RDONLY);
     8ec:	4581                	li	a1,0
     8ee:	00005517          	auipc	a0,0x5
     8f2:	db250513          	addi	a0,a0,-590 # 56a0 <malloc+0x44c>
     8f6:	4ba040ef          	jal	4db0 <open>
     8fa:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     90c:	47c040ef          	jal	4d88 <read>
  if(i != N*SZ*2){
     910:	7d000793          	li	a5,2000
     914:	08f51163          	bne	a0,a5,996 <writetest+0x118>
  close(fd);
     918:	8526                	mv	a0,s1
     91a:	47e040ef          	jal	4d98 <close>
  if(unlink("small") < 0){
     91e:	00005517          	auipc	a0,0x5
     922:	d8250513          	addi	a0,a0,-638 # 56a0 <malloc+0x44c>
     926:	49a040ef          	jal	4dc0 <unlink>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	d6450513          	addi	a0,a0,-668 # 56a8 <malloc+0x454>
     94c:	055040ef          	jal	51a0 <printf>
    exit(1);
     950:	4505                	li	a0,1
     952:	41e040ef          	jal	4d70 <exit>
      printf("%s: error: write aa %d new file failed\n", s, i);
     956:	8626                	mv	a2,s1
     958:	85da                	mv	a1,s6
     95a:	00005517          	auipc	a0,0x5
     95e:	d7e50513          	addi	a0,a0,-642 # 56d8 <malloc+0x484>
     962:	03f040ef          	jal	51a0 <printf>
      exit(1);
     966:	4505                	li	a0,1
     968:	408040ef          	jal	4d70 <exit>
      printf("%s: error: write bb %d new file failed\n", s, i);
     96c:	8626                	mv	a2,s1
     96e:	85da                	mv	a1,s6
     970:	00005517          	auipc	a0,0x5
     974:	da050513          	addi	a0,a0,-608 # 5710 <malloc+0x4bc>
     978:	029040ef          	jal	51a0 <printf>
      exit(1);
     97c:	4505                	li	a0,1
     97e:	3f2040ef          	jal	4d70 <exit>
    printf("%s: error: open small failed!\n", s);
     982:	85da                	mv	a1,s6
     984:	00005517          	auipc	a0,0x5
     988:	db450513          	addi	a0,a0,-588 # 5738 <malloc+0x4e4>
     98c:	015040ef          	jal	51a0 <printf>
    exit(1);
     990:	4505                	li	a0,1
     992:	3de040ef          	jal	4d70 <exit>
    printf("%s: read failed\n", s);
     996:	85da                	mv	a1,s6
     998:	00005517          	auipc	a0,0x5
     99c:	dc050513          	addi	a0,a0,-576 # 5758 <malloc+0x504>
     9a0:	001040ef          	jal	51a0 <printf>
    exit(1);
     9a4:	4505                	li	a0,1
     9a6:	3ca040ef          	jal	4d70 <exit>
    printf("%s: unlink small failed\n", s);
     9aa:	85da                	mv	a1,s6
     9ac:	00005517          	auipc	a0,0x5
     9b0:	dc450513          	addi	a0,a0,-572 # 5770 <malloc+0x51c>
     9b4:	7ec040ef          	jal	51a0 <printf>
    exit(1);
     9b8:	4505                	li	a0,1
     9ba:	3b6040ef          	jal	4d70 <exit>
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	dba50513          	addi	a0,a0,-582 # 5790 <malloc+0x53c>
     9de:	3d2040ef          	jal	4db0 <open>
     9e2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9e4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  close(fd);
     a14:	854e                	mv	a0,s3
     a16:	382040ef          	jal	4d98 <close>
  fd = open("big", O_RDONLY);
     a1a:	4581                	li	a1,0
     a1c:	00005517          	auipc	a0,0x5
     a20:	d7450513          	addi	a0,a0,-652 # 5790 <malloc+0x53c>
     a24:	38c040ef          	jal	4db0 <open>
     a28:	89aa                	mv	s3,a0
  n = 0;
     a2a:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	d3c50513          	addi	a0,a0,-708 # 5798 <malloc+0x544>
     a64:	73c040ef          	jal	51a0 <printf>
    exit(1);
     a68:	4505                	li	a0,1
     a6a:	306040ef          	jal	4d70 <exit>
      printf("%s: error: write big file failed i=%d\n", s, i);
     a6e:	8626                	mv	a2,s1
     a70:	85d6                	mv	a1,s5
     a72:	00005517          	auipc	a0,0x5
     a76:	d4650513          	addi	a0,a0,-698 # 57b8 <malloc+0x564>
     a7a:	726040ef          	jal	51a0 <printf>
      exit(1);
     a7e:	4505                	li	a0,1
     a80:	2f0040ef          	jal	4d70 <exit>
    printf("%s: error: open big failed!\n", s);
     a84:	85d6                	mv	a1,s5
     a86:	00005517          	auipc	a0,0x5
     a8a:	d5a50513          	addi	a0,a0,-678 # 57e0 <malloc+0x58c>
     a8e:	712040ef          	jal	51a0 <printf>
    exit(1);
     a92:	4505                	li	a0,1
     a94:	2dc040ef          	jal	4d70 <exit>
      if(n != MAXFILE){
     a98:	10c00793          	li	a5,268
     a9c:	02f49663          	bne	s1,a5,ac8 <writebig+0x10a>
  close(fd);
     aa0:	854e                	mv	a0,s3
     aa2:	2f6040ef          	jal	4d98 <close>
  if(unlink("big") < 0){
     aa6:	00005517          	auipc	a0,0x5
     aaa:	cea50513          	addi	a0,a0,-790 # 5790 <malloc+0x53c>
     aae:	312040ef          	jal	4dc0 <unlink>
     ...
     ad0:	d3450513          	addi	a0,a0,-716 # 5800 <malloc+0x5ac>
     ad4:	6cc040ef          	jal	51a0 <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ada:	296040ef          	jal	4d70 <exit>
      printf("%s: read failed %d\n", s, i);
     ade:	862a                	mv	a2,a0
     ae0:	85d6                	mv	a1,s5
     ae2:	00005517          	auipc	a0,0x5
     ae6:	d4650513          	addi	a0,a0,-698 # 5828 <malloc+0x5d4>
     aea:	6b6040ef          	jal	51a0 <printf>
      exit(1);
     aee:	4505                	li	a0,1
     af0:	280040ef          	jal	4d70 <exit>
      printf("%s: read content of block %d is %d\n", s,
     af4:	8626                	mv	a2,s1
     af6:	85d6                	mv	a1,s5
     af8:	00005517          	auipc	a0,0x5
     afc:	d4850513          	addi	a0,a0,-696 # 5840 <malloc+0x5ec>
     b00:	6a0040ef          	jal	51a0 <printf>
      exit(1);
     b04:	4505                	li	a0,1
     b06:	26a040ef          	jal	4d70 <exit>
    printf("%s: unlink big failed\n", s);
     b0a:	85d6                	mv	a1,s5
     b0c:	00005517          	auipc	a0,0x5
     b10:	d5c50513          	addi	a0,a0,-676 # 5868 <malloc+0x614>
     b14:	68c040ef          	jal	51a0 <printf>
    exit(1);
     b18:	4505                	li	a0,1
     b1a:	256040ef          	jal	4d70 <exit>
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	d4e50513          	addi	a0,a0,-690 # 5880 <malloc+0x62c>
     b3a:	276040ef          	jal	4db0 <open>
  if(fd < 0){
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	d6a58593          	addi	a1,a1,-662 # 58b0 <malloc+0x65c>
     b4e:	242040ef          	jal	4d90 <write>
  close(fd);
     b52:	8526                	mv	a0,s1
     b54:	244040ef          	jal	4d98 <close>
  fd = open("unlinkread", O_RDWR);
     b58:	4589                	li	a1,2
     b5a:	00005517          	auipc	a0,0x5
     b5e:	d2650513          	addi	a0,a0,-730 # 5880 <malloc+0x62c>
     b62:	24e040ef          	jal	4db0 <open>
     b66:	84aa                	mv	s1,a0
  if(fd < 0){
     b68:	0a054463          	bltz	a0,c10 <unlinkread+0xf2>
  if(unlink("unlinkread") != 0){
     b6c:	00005517          	auipc	a0,0x5
     b70:	d1450513          	addi	a0,a0,-748 # 5880 <malloc+0x62c>
     b74:	24c040ef          	jal	4dc0 <unlink>
     b78:	e555                	bnez	a0,c24 <unlinkread+0x106>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     b7a:	20200593          	li	a1,514
     b7e:	00005517          	auipc	a0,0x5
     b82:	d0250513          	addi	a0,a0,-766 # 5880 <malloc+0x62c>
     b86:	22a040ef          	jal	4db0 <open>
     b8a:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b8c:	460d                	li	a2,3
     b8e:	00005597          	auipc	a1,0x5
     b92:	d6a58593          	addi	a1,a1,-662 # 58f8 <malloc+0x6a4>
     b96:	1fa040ef          	jal	4d90 <write>
  close(fd1);
     b9a:	854a                	mv	a0,s2
     b9c:	1fc040ef          	jal	4d98 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ba0:	660d                	lui	a2,0x3
     ba2:	0000c597          	auipc	a1,0xc
     ba6:	11658593          	addi	a1,a1,278 # ccb8 <buf>
     baa:	8526                	mv	a0,s1
     bac:	1dc040ef          	jal	4d88 <read>
     bb0:	4795                	li	a5,5
  ...
  if(write(fd, buf, 10) != 10){
     ...
     bd0:	8526                	mv	a0,s1
     bd2:	1be040ef          	jal	4d90 <write>
     bd6:	47a9                	li	a5,10
     bd8:	08f51463          	bne	a0,a5,c60 <unlinkread+0x142>
  close(fd);
     bdc:	8526                	mv	a0,s1
     bde:	1ba040ef          	jal	4d98 <close>
  unlink("unlinkread");
     be2:	00005517          	auipc	a0,0x5
     be6:	c9e50513          	addi	a0,a0,-866 # 5880 <malloc+0x62c>
     bea:	1d6040ef          	jal	4dc0 <unlink>
}
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	c9250513          	addi	a0,a0,-878 # 5890 <malloc+0x63c>
     c06:	59a040ef          	jal	51a0 <printf>
    exit(1);
     c0a:	4505                	li	a0,1
     c0c:	164040ef          	jal	4d70 <exit>
    printf("%s: open unlinkread failed\n", s);
     c10:	85ce                	mv	a1,s3
     c12:	00005517          	auipc	a0,0x5
     c16:	ca650513          	addi	a0,a0,-858 # 58b8 <malloc+0x664>
     c1a:	586040ef          	jal	51a0 <printf>
    exit(1);
     c1e:	4505                	li	a0,1
     c20:	150040ef          	jal	4d70 <exit>
    printf("%s: unlink unlinkread failed\n", s);
     c24:	85ce                	mv	a1,s3
     c26:	00005517          	auipc	a0,0x5
     c2a:	cb250513          	addi	a0,a0,-846 # 58d8 <malloc+0x684>
     c2e:	572040ef          	jal	51a0 <printf>
    exit(1);
     c32:	4505                	li	a0,1
     c34:	13c040ef          	jal	4d70 <exit>
    printf("%s: unlinkread read failed", s);
     c38:	85ce                	mv	a1,s3
     c3a:	00005517          	auipc	a0,0x5
     c3e:	cc650513          	addi	a0,a0,-826 # 5900 <malloc+0x6ac>
     c42:	55e040ef          	jal	51a0 <printf>
    exit(1);
     c46:	4505                	li	a0,1
     c48:	128040ef          	jal	4d70 <exit>
    printf("%s: unlinkread wrong data\n", s);
     c4c:	85ce                	mv	a1,s3
     c4e:	00005517          	auipc	a0,0x5
     c52:	cd250513          	addi	a0,a0,-814 # 5920 <malloc+0x6cc>
     c56:	54a040ef          	jal	51a0 <printf>
    exit(1);
     c5a:	4505                	li	a0,1
     c5c:	114040ef          	jal	4d70 <exit>
    printf("%s: unlinkread write failed\n", s);
     c60:	85ce                	mv	a1,s3
     c62:	00005517          	auipc	a0,0x5
     c66:	cde50513          	addi	a0,a0,-802 # 5940 <malloc+0x6ec>
     c6a:	536040ef          	jal	51a0 <printf>
    exit(1);
     c6e:	4505                	li	a0,1
     c70:	100040ef          	jal	4d70 <exit>
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	cde50513          	addi	a0,a0,-802 # 5960 <malloc+0x70c>
     c8a:	136040ef          	jal	4dc0 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	cda50513          	addi	a0,a0,-806 # 5968 <malloc+0x714>
     c96:	12a040ef          	jal	4dc0 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	cc250513          	addi	a0,a0,-830 # 5960 <malloc+0x70c>
     ca6:	10a040ef          	jal	4db0 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	bfe58593          	addi	a1,a1,-1026 # 58b0 <malloc+0x65c>
     cba:	0d6040ef          	jal	4d90 <write>
     cbe:	4795                	li	a5,5
     cc0:	0cf51e63          	bne	a0,a5,d9c <linktest+0x128>
  close(fd);
     cc4:	8526                	mv	a0,s1
     cc6:	0d2040ef          	jal	4d98 <close>
  if(link("lf1", "lf2") < 0){
     cca:	00005597          	auipc	a1,0x5
     cce:	c9e58593          	addi	a1,a1,-866 # 5968 <malloc+0x714>
     cd2:	00005517          	auipc	a0,0x5
     cd6:	c8e50513          	addi	a0,a0,-882 # 5960 <malloc+0x70c>
     cda:	0f6040ef          	jal	4dd0 <link>
     cde:	0c054963          	bltz	a0,db0 <linktest+0x13c>
  unlink("lf1");
     ce2:	00005517          	auipc	a0,0x5
     ce6:	c7e50513          	addi	a0,a0,-898 # 5960 <malloc+0x70c>
     cea:	0d6040ef          	jal	4dc0 <unlink>
  if(open("lf1", 0) >= 0){
     cee:	4581                	li	a1,0
     cf0:	00005517          	auipc	a0,0x5
     cf4:	c7050513          	addi	a0,a0,-912 # 5960 <malloc+0x70c>
     cf8:	0b8040ef          	jal	4db0 <open>
     cfc:	0c055463          	bgez	a0,dc4 <linktest+0x150>
  fd = open("lf2", 0);
     d00:	4581                	li	a1,0
     d02:	00005517          	auipc	a0,0x5
     d06:	c6650513          	addi	a0,a0,-922 # 5968 <malloc+0x714>
     d0a:	0a6040ef          	jal	4db0 <open>
     d0e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     d1e:	06a040ef          	jal	4d88 <read>
     d22:	4795                	li	a5,5
     d24:	0cf51463          	bne	a0,a5,dec <linktest+0x178>
  close(fd);
     d28:	8526                	mv	a0,s1
     d2a:	06e040ef          	jal	4d98 <close>
  if(link("lf2", "lf2") >= 0){
     d2e:	00005597          	auipc	a1,0x5
     d32:	c3a58593          	addi	a1,a1,-966 # 5968 <malloc+0x714>
     d36:	852e                	mv	a0,a1
     d38:	098040ef          	jal	4dd0 <link>
     d3c:	0c055263          	bgez	a0,e00 <linktest+0x18c>
  unlink("lf2");
     d40:	00005517          	auipc	a0,0x5
     d44:	c2850513          	addi	a0,a0,-984 # 5968 <malloc+0x714>
     d48:	078040ef          	jal	4dc0 <unlink>
  if(link("lf2", "lf1") >= 0){
     d4c:	00005597          	auipc	a1,0x5
     d50:	c1458593          	addi	a1,a1,-1004 # 5960 <malloc+0x70c>
     d54:	00005517          	auipc	a0,0x5
     d58:	c1450513          	addi	a0,a0,-1004 # 5968 <malloc+0x714>
     d5c:	074040ef          	jal	4dd0 <link>
     d60:	0a055a63          	bgez	a0,e14 <linktest+0x1a0>
  if(link(".", "lf1") >= 0){
     d64:	00005597          	auipc	a1,0x5
     d68:	bfc58593          	addi	a1,a1,-1028 # 5960 <malloc+0x70c>
     d6c:	00005517          	auipc	a0,0x5
     d70:	d0450513          	addi	a0,a0,-764 # 5a70 <malloc+0x81c>
     d74:	05c040ef          	jal	4dd0 <link>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	be650513          	addi	a0,a0,-1050 # 5970 <malloc+0x71c>
     d92:	40e040ef          	jal	51a0 <printf>
    exit(1);
     d96:	4505                	li	a0,1
     d98:	7d9030ef          	jal	4d70 <exit>
    printf("%s: write lf1 failed\n", s);
     d9c:	85ca                	mv	a1,s2
     d9e:	00005517          	auipc	a0,0x5
     da2:	bea50513          	addi	a0,a0,-1046 # 5988 <malloc+0x734>
     da6:	3fa040ef          	jal	51a0 <printf>
    exit(1);
     daa:	4505                	li	a0,1
     dac:	7c5030ef          	jal	4d70 <exit>
    printf("%s: link lf1 lf2 failed\n", s);
     db0:	85ca                	mv	a1,s2
     db2:	00005517          	auipc	a0,0x5
     db6:	bee50513          	addi	a0,a0,-1042 # 59a0 <malloc+0x74c>
     dba:	3e6040ef          	jal	51a0 <printf>
    exit(1);
     dbe:	4505                	li	a0,1
     dc0:	7b1030ef          	jal	4d70 <exit>
    printf("%s: unlinked lf1 but it is still there!\n", s);
     dc4:	85ca                	mv	a1,s2
     dc6:	00005517          	auipc	a0,0x5
     dca:	bfa50513          	addi	a0,a0,-1030 # 59c0 <malloc+0x76c>
     dce:	3d2040ef          	jal	51a0 <printf>
    exit(1);
     dd2:	4505                	li	a0,1
     dd4:	79d030ef          	jal	4d70 <exit>
    printf("%s: open lf2 failed\n", s);
     dd8:	85ca                	mv	a1,s2
     dda:	00005517          	auipc	a0,0x5
     dde:	c1650513          	addi	a0,a0,-1002 # 59f0 <malloc+0x79c>
     de2:	3be040ef          	jal	51a0 <printf>
    exit(1);
     de6:	4505                	li	a0,1
     de8:	789030ef          	jal	4d70 <exit>
    printf("%s: read lf2 failed\n", s);
     dec:	85ca                	mv	a1,s2
     dee:	00005517          	auipc	a0,0x5
     df2:	c1a50513          	addi	a0,a0,-998 # 5a08 <malloc+0x7b4>
     df6:	3aa040ef          	jal	51a0 <printf>
    exit(1);
     dfa:	4505                	li	a0,1
     dfc:	775030ef          	jal	4d70 <exit>
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     e00:	85ca                	mv	a1,s2
     e02:	00005517          	auipc	a0,0x5
     e06:	c1e50513          	addi	a0,a0,-994 # 5a20 <malloc+0x7cc>
     e0a:	396040ef          	jal	51a0 <printf>
    exit(1);
     e0e:	4505                	li	a0,1
     e10:	761030ef          	jal	4d70 <exit>
    printf("%s: link non-existent succeeded! oops\n", s);
     e14:	85ca                	mv	a1,s2
     e16:	00005517          	auipc	a0,0x5
     e1a:	c3250513          	addi	a0,a0,-974 # 5a48 <malloc+0x7f4>
     e1e:	382040ef          	jal	51a0 <printf>
    exit(1);
     e22:	4505                	li	a0,1
     e24:	74d030ef          	jal	4d70 <exit>
    printf("%s: link . lf1 succeeded! oops\n", s);
     e28:	85ca                	mv	a1,s2
     e2a:	00005517          	auipc	a0,0x5
     e2e:	c4e50513          	addi	a0,a0,-946 # 5a78 <malloc+0x824>
     e32:	36e040ef          	jal	51a0 <printf>
    exit(1);
     e36:	4505                	li	a0,1
     e38:	739030ef          	jal	4d70 <exit>
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	c4498993          	addi	s3,s3,-956 # 5a98 <malloc+0x844>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c1c50513          	addi	a0,a0,-996 # 5aa8 <malloc+0x854>
     e94:	30c040ef          	jal	51a0 <printf>
      exit(1);
     e98:	4505                	li	a0,1
     e9a:	6d7030ef          	jal	4d70 <exit>
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c1450513          	addi	a0,a0,-1004 # 5ac8 <malloc+0x874>
     ebc:	705030ef          	jal	4dc0 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c0450513          	addi	a0,a0,-1020 # 5ac8 <malloc+0x874>
     ecc:	6e5030ef          	jal	4db0 <open>
  if(fd < 0){
     ed0:	0c054163          	bltz	a0,f92 <bigdir+0xf4>
  close(fd);
     ed4:	6c5030ef          	jal	4d98 <close>
  for(i = 0; i < N; i++){
     ed8:	4901                	li	s2,0
    name[0] = 'x';
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	beaa0a13          	addi	s4,s4,-1046 # 5ac8 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	b9c50513          	addi	a0,a0,-1124 # 5ac8 <malloc+0x874>
     f34:	68d030ef          	jal	4dc0 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	b3c50513          	addi	a0,a0,-1220 # 5ad0 <malloc+0x87c>
     f9c:	204040ef          	jal	51a0 <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     fa2:	5cf030ef          	jal	4d70 <exit>
      printf("%s: bigdir i=%d link(bd, %s) failed\n", s, i, name);
     fa6:	fb040693          	addi	a3,s0,-80
     faa:	864a                	mv	a2,s2
     fac:	85ce                	mv	a1,s3
     fae:	00005517          	auipc	a0,0x5
     fb2:	b4250513          	addi	a0,a0,-1214 # 5af0 <malloc+0x89c>
     fb6:	1ea040ef          	jal	51a0 <printf>
      exit(1);
     fba:	4505                	li	a0,1
     fbc:	5b5030ef          	jal	4d70 <exit>
      printf("%s: bigdir unlink failed", s);
     fc0:	85ce                	mv	a1,s3
     fc2:	00005517          	auipc	a0,0x5
     fc6:	b5650513          	addi	a0,a0,-1194 # 5b18 <malloc+0x8c4>
     fca:	1d6040ef          	jal	51a0 <printf>
      exit(1);
     fce:	4505                	li	a0,1
     fd0:	5a1030ef          	jal	4d70 <exit>
...
0000000000000fd4 <pgbug>:
{
  ...
  exec(big, argv);
     ...
     fee:	6088                	ld	a0,0(s1)
     ff0:	5b9030ef          	jal	4da8 <exec>
  pipe(big);
     ff4:	6088                	ld	a0,0(s1)
     ff6:	58b030ef          	jal	4d80 <pipe>
  exit(0);
     ffa:	4501                	li	a0,0
     ffc:	575030ef          	jal	4d70 <exit>
...
0000000000001000 <badarg>:
{
    ...
    101e:	36e98993          	addi	s3,s3,878 # 5388 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    10e8:	7ec78793          	addi	a5,a5,2028 # 78d0 <malloc+0x267c>
    ...
    110c:	28050513          	addi	a0,a0,640 # 5388 <malloc+0x134>
    1110:	499030ef          	jal	4da8 <exec>
    if(ret != -1){
    1114:	57fd                	li	a5,-1
    ...
    1120:	aa450513          	addi	a0,a0,-1372 # 5bc0 <malloc+0x96c>
    1124:	07c040ef          	jal	51a0 <printf>
      exit(1);
    1128:	4505                	li	a0,1
    112a:	447030ef          	jal	4d70 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    112e:	862a                	mv	a2,a0
    1130:	f6840593          	addi	a1,s0,-152
    1134:	00005517          	auipc	a0,0x5
    1138:	a0450513          	addi	a0,a0,-1532 # 5b38 <malloc+0x8e4>
    113c:	064040ef          	jal	51a0 <printf>
    exit(1);
    1140:	4505                	li	a0,1
    1142:	42f030ef          	jal	4d70 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    1146:	862a                	mv	a2,a0
    1148:	f6840593          	addi	a1,s0,-152
    114c:	00005517          	auipc	a0,0x5
    1150:	a0c50513          	addi	a0,a0,-1524 # 5b58 <malloc+0x904>
    1154:	04c040ef          	jal	51a0 <printf>
    exit(1);
    1158:	4505                	li	a0,1
    115a:	417030ef          	jal	4d70 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    115e:	86aa                	mv	a3,a0
    1160:	f6840613          	addi	a2,s0,-152
    1164:	85b2                	mv	a1,a2
    1166:	00005517          	auipc	a0,0x5
    116a:	a1250513          	addi	a0,a0,-1518 # 5b78 <malloc+0x924>
    116e:	032040ef          	jal	51a0 <printf>
    exit(1);
    1172:	4505                	li	a0,1
    1174:	3fd030ef          	jal	4d70 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    1178:	567d                	li	a2,-1
    117a:	f6840593          	addi	a1,s0,-152
    117e:	00005517          	auipc	a0,0x5
    1182:	a2250513          	addi	a0,a0,-1502 # 5ba0 <malloc+0x94c>
    1186:	01a040ef          	jal	51a0 <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	3e5030ef          	jal	4d70 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	03050513          	addi	a0,a0,48 # 71c0 <malloc+0x1f6c>
    1198:	008040ef          	jal	51a0 <printf>
    exit(1);
    119c:	4505                	li	a0,1
    119e:	3d3030ef          	jal	4d70 <exit>
    exit(747); // OK
    11a2:	2eb00513          	li	a0,747
    11a6:	3cb030ef          	jal	4d70 <exit>
  int st = 0;
    11aa:	f4042a23          	sw	zero,-172(s0)
  wait(&st);
    11ae:	f5440513          	addi	a0,s0,-172
    11b2:	3c7030ef          	jal	4d78 <wait>
  if(st != 747){
    ...
    11ce:	a1e50513          	addi	a0,a0,-1506 # 5be8 <malloc+0x994>
    11d2:	7cf030ef          	jal	51a0 <printf>
    exit(1);
    11d6:	4505                	li	a0,1
    11d8:	399030ef          	jal	4d70 <exit>
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	1f450513          	addi	a0,a0,500 # 53e0 <malloc+0x18c>
    11f4:	3bd030ef          	jal	4db0 <open>
    11f8:	3a1030ef          	jal	4d98 <close>
  pid = fork();
    11fc:	36d030ef          	jal	4d68 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    1216:	1cea0a13          	addi	s4,s4,462 # 53e0 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a2ea8a93          	addi	s5,s5,-1490 # 5c48 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    1226:	38b030ef          	jal	4db0 <open>
    122a:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    127a:	9a250513          	addi	a0,a0,-1630 # 5c18 <malloc+0x9c4>
    127e:	723030ef          	jal	51a0 <printf>
    exit(1);
    1282:	4505                	li	a0,1
    1284:	2ed030ef          	jal	4d70 <exit>
        printf("%s: open failed\n", s);
    1288:	85ca                	mv	a1,s2
    128a:	00005517          	auipc	a0,0x5
    128e:	9a650513          	addi	a0,a0,-1626 # 5c30 <malloc+0x9dc>
    1292:	70f030ef          	jal	51a0 <printf>
        exit(1);
    1296:	4505                	li	a0,1
    1298:	2d9030ef          	jal	4d70 <exit>
        printf("%s: write got %d, expected 10\n", s, n);
    129c:	862a                	mv	a2,a0
    129e:	85ca                	mv	a1,s2
    12a0:	00005517          	auipc	a0,0x5
    12a4:	9b850513          	addi	a0,a0,-1608 # 5c58 <malloc+0xa04>
    12a8:	6f9030ef          	jal	51a0 <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    12ae:	2c3030ef          	jal	4d70 <exit>
    ...
    12c2:	122a0a13          	addi	s4,s4,290 # 53e0 <malloc+0x18c>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	9b2a8a93          	addi	s5,s5,-1614 # 5c78 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    12ce:	60100593          	li	a1,1537
    12d2:	8552                	mv	a0,s4
    12d4:	2dd030ef          	jal	4db0 <open>
    12d8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    12de:	460d                	li	a2,3
    12e0:	85d6                	mv	a1,s5
    12e2:	2af030ef          	jal	4d90 <write>
    if(n != 3){
    12e6:	478d                	li	a5,3
    12e8:	04f51063          	bne	a0,a5,1328 <truncate3+0x14c>
    close(fd);
    12ec:	8526                	mv	a0,s1
    12ee:	2ab030ef          	jal	4d98 <close>
  for(int i = 0; i < 150; i++){
    12f2:	39fd                	addiw	s3,s3,-1
    12f4:	fc099de3          	bnez	s3,12ce <truncate3+0xf2>
  wait(&xstatus);
    12f8:	fbc40513          	addi	a0,s0,-68
    12fc:	27d030ef          	jal	4d78 <wait>
  unlink("truncfile");
    1300:	00004517          	auipc	a0,0x4
    1304:	0e050513          	addi	a0,a0,224 # 53e0 <malloc+0x18c>
    1308:	2b9030ef          	jal	4dc0 <unlink>
  exit(xstatus);
    130c:	fbc42503          	lw	a0,-68(s0)
    1310:	261030ef          	jal	4d70 <exit>
      printf("%s: open failed\n", s);
    1314:	85ca                	mv	a1,s2
    1316:	00005517          	auipc	a0,0x5
    131a:	91a50513          	addi	a0,a0,-1766 # 5c30 <malloc+0x9dc>
    131e:	683030ef          	jal	51a0 <printf>
      exit(1);
    1322:	4505                	li	a0,1
    1324:	24d030ef          	jal	4d70 <exit>
      printf("%s: write got %d, expected 3\n", s, n);
    1328:	862a                	mv	a2,a0
    132a:	85ca                	mv	a1,s2
    132c:	00005517          	auipc	a0,0x5
    1330:	95450513          	addi	a0,a0,-1708 # 5c80 <malloc+0xa2c>
    1334:	66d030ef          	jal	51a0 <printf>
      exit(1);
    1338:	4505                	li	a0,1
    133a:	237030ef          	jal	4d70 <exit>
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	03e78793          	addi	a5,a5,62 # 5388 <malloc+0x134>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	94a78793          	addi	a5,a5,-1718 # 5ca0 <malloc+0xa4c>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	94250513          	addi	a0,a0,-1726 # 5ca8 <malloc+0xa54>
    136e:	253030ef          	jal	4dc0 <unlink>
  pid = fork();
    1372:	1f7030ef          	jal	4d68 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    close(1);
    1380:	4505                	li	a0,1
    1382:	217030ef          	jal	4d98 <close>
    fd = open("echo-ok", O_CREATE|O_WRONLY);
    1386:	20100593          	li	a1,513
    138a:	00005517          	auipc	a0,0x5
    138e:	91e50513          	addi	a0,a0,-1762 # 5ca8 <malloc+0xa54>
    1392:	21f030ef          	jal	4db0 <open>
    if(fd < 0) {
    ...
    13a6:	92650513          	addi	a0,a0,-1754 # 5cc8 <malloc+0xa74>
    13aa:	5f7030ef          	jal	51a0 <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    13b0:	1c1030ef          	jal	4d70 <exit>
    13b4:	fc26                	sd	s1,56(sp)
     printf("%s: fork failed\n", s);
    13b6:	85ca                	mv	a1,s2
    13b8:	00005517          	auipc	a0,0x5
    13bc:	86050513          	addi	a0,a0,-1952 # 5c18 <malloc+0x9c4>
    13c0:	5e1030ef          	jal	51a0 <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    13c6:	1ab030ef          	jal	4d70 <exit>
      printf("%s: create failed\n", s);
    13ca:	85ca                	mv	a1,s2
    13cc:	00005517          	auipc	a0,0x5
    13d0:	8e450513          	addi	a0,a0,-1820 # 5cb0 <malloc+0xa5c>
    13d4:	5cd030ef          	jal	51a0 <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    13da:	197030ef          	jal	4d70 <exit>
    if(exec("echo", echoargv) < 0){
    13de:	fc040593          	addi	a1,s0,-64
    13e2:	00004517          	auipc	a0,0x4
    13e6:	fa650513          	addi	a0,a0,-90 # 5388 <malloc+0x134>
    13ea:	1bf030ef          	jal	4da8 <exec>
    13ee:	00054d63          	bltz	a0,1408 <exectest+0xca>
  if (wait(&xstatus) != pid) {
    13f2:	fdc40513          	addi	a0,s0,-36
    13f6:	183030ef          	jal	4d78 <wait>
    13fa:	02951163          	bne	a0,s1,141c <exectest+0xde>
  if(xstatus != 0)
    13fe:	fdc42503          	lw	a0,-36(s0)
    1402:	c50d                	beqz	a0,142c <exectest+0xee>
    exit(xstatus);
    1404:	16d030ef          	jal	4d70 <exit>
      printf("%s: exec echo failed\n", s);
    1408:	85ca                	mv	a1,s2
    140a:	00005517          	auipc	a0,0x5
    140e:	8ce50513          	addi	a0,a0,-1842 # 5cd8 <malloc+0xa84>
    1412:	58f030ef          	jal	51a0 <printf>
      exit(1);
    1416:	4505                	li	a0,1
    1418:	159030ef          	jal	4d70 <exit>
    printf("%s: wait failed!\n", s);
    141c:	85ca                	mv	a1,s2
    141e:	00005517          	auipc	a0,0x5
    1422:	8d250513          	addi	a0,a0,-1838 # 5cf0 <malloc+0xa9c>
    1426:	57b030ef          	jal	51a0 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	87a50513          	addi	a0,a0,-1926 # 5ca8 <malloc+0xa54>
    1436:	17b030ef          	jal	4db0 <open>
  if(fd < 0) {
    143a:	02054463          	bltz	a0,1462 <exectest+0x124>
  if (read(fd, buf, 2) != 2) {
    143e:	4609                	li	a2,2
    1440:	fb840593          	addi	a1,s0,-72
    1444:	145030ef          	jal	4d88 <read>
    1448:	4789                	li	a5,2
    144a:	02f50663          	beq	a0,a5,1476 <exectest+0x138>
    printf("%s: read failed\n", s);
    144e:	85ca                	mv	a1,s2
    1450:	00004517          	auipc	a0,0x4
    1454:	30850513          	addi	a0,a0,776 # 5758 <malloc+0x504>
    1458:	549030ef          	jal	51a0 <printf>
    exit(1);
    145c:	4505                	li	a0,1
    145e:	113030ef          	jal	4d70 <exit>
    printf("%s: open failed\n", s);
    1462:	85ca                	mv	a1,s2
    1464:	00004517          	auipc	a0,0x4
    1468:	7cc50513          	addi	a0,a0,1996 # 5c30 <malloc+0x9dc>
    146c:	535030ef          	jal	51a0 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	0ff030ef          	jal	4d70 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	83250513          	addi	a0,a0,-1998 # 5ca8 <malloc+0xa54>
    147e:	143030ef          	jal	4dc0 <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	86c50513          	addi	a0,a0,-1940 # 5d08 <malloc+0xab4>
    14a4:	4fd030ef          	jal	51a0 <printf>
    exit(1);
    14a8:	4505                	li	a0,1
    14aa:	0c7030ef          	jal	4d70 <exit>
    exit(0);
    14ae:	4501                	li	a0,0
    14b0:	0c1030ef          	jal	4d70 <exit>
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	7d850513          	addi	a0,a0,2008 # 5d20 <malloc+0xacc>
    1550:	451030ef          	jal	51a0 <printf>
    exit(1);
    1554:	4505                	li	a0,1
    1556:	01b030ef          	jal	4d70 <exit>
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    exit(0);
    15ba:	4501                	li	a0,0
    15bc:	7b4030ef          	jal	4d70 <exit>
        printf("%s: pipe1 oops 1\n", s);
    15c0:	85ce                	mv	a1,s3
    15c2:	00004517          	auipc	a0,0x4
    15c6:	77650513          	addi	a0,a0,1910 # 5d38 <malloc+0xae4>
    15ca:	3d7030ef          	jal	51a0 <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    15d0:	7a0030ef          	jal	4d70 <exit>
          printf("%s: pipe1 oops 2\n", s);
    15d4:	85ce                	mv	a1,s3
    15d6:	00004517          	auipc	a0,0x4
    15da:	77a50513          	addi	a0,a0,1914 # 5d50 <malloc+0xafc>
    15de:	3c3030ef          	jal	51a0 <printf>
          return;
    ...
    160a:	76250513          	addi	a0,a0,1890 # 5d68 <malloc+0xb14>
    160e:	393030ef          	jal	51a0 <printf>
      exit(1);
    1612:	4505                	li	a0,1
    1614:	75c030ef          	jal	4d70 <exit>
    1618:	f05a                	sd	s6,32(sp)
    161a:	ec5e                	sd	s7,24(sp)
    close(fds[0]);
    161c:	fa842503          	lw	a0,-88(s0)
    1620:	778030ef          	jal	4d98 <close>
    wait(&xstatus);
    1624:	fa440513          	addi	a0,s0,-92
    1628:	750030ef          	jal	4d78 <wait>
    exit(xstatus);
    162c:	fa442503          	lw	a0,-92(s0)
    1630:	740030ef          	jal	4d70 <exit>
    ...
    1642:	74a50513          	addi	a0,a0,1866 # 5d88 <malloc+0xb34>
    1646:	35b030ef          	jal	51a0 <printf>
    exit(1);
    164a:	4505                	li	a0,1
    164c:	724030ef          	jal	4d70 <exit>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	57850513          	addi	a0,a0,1400 # 5c18 <malloc+0x9c4>
    16a8:	2f9030ef          	jal	51a0 <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    16ae:	6c2030ef          	jal	4d70 <exit>
        printf("%s: wait wrong pid\n", s);
    16b2:	85d2                	mv	a1,s4
    16b4:	00004517          	auipc	a0,0x4
    16b8:	6ec50513          	addi	a0,a0,1772 # 5da0 <malloc+0xb4c>
    16bc:	2e5030ef          	jal	51a0 <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    16c2:	6ae030ef          	jal	4d70 <exit>
        printf("%s: wait wrong exit status\n", s);
    16c6:	85d2                	mv	a1,s4
    16c8:	00004517          	auipc	a0,0x4
    16cc:	6f050513          	addi	a0,a0,1776 # 5db8 <malloc+0xb64>
    16d0:	2d1030ef          	jal	51a0 <printf>
        exit(1);
    16d4:	4505                	li	a0,1
    16d6:	69a030ef          	jal	4d70 <exit>
      exit(i);
    16da:	854a                	mv	a0,s2
    16dc:	694030ef          	jal	4d70 <exit>
...
00000000000016e0 <twochildren>:
{
    ...
    1704:	c529                	beqz	a0,174e <twochildren+0x6e>
        wait(0);
    1706:	4501                	li	a0,0
    1708:	670030ef          	jal	4d78 <wait>
        wait(0);
    170c:	4501                	li	a0,0
    170e:	66a030ef          	jal	4d78 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1728:	4f450513          	addi	a0,a0,1268 # 5c18 <malloc+0x9c4>
    172c:	275030ef          	jal	51a0 <printf>
      exit(1);
    1730:	4505                	li	a0,1
    1732:	63e030ef          	jal	4d70 <exit>
      exit(0);
    1736:	63a030ef          	jal	4d70 <exit>
        printf("%s: fork failed\n", s);
    173a:	85ca                	mv	a1,s2
    173c:	00004517          	auipc	a0,0x4
    1740:	4dc50513          	addi	a0,a0,1244 # 5c18 <malloc+0x9c4>
    1744:	25d030ef          	jal	51a0 <printf>
        exit(1);
    1748:	4505                	li	a0,1
    174a:	626030ef          	jal	4d70 <exit>
        exit(0);
    174e:	622030ef          	jal	4d70 <exit>
...
0000000000001752 <forkfork>:
{
    ...
    179e:	63e50513          	addi	a0,a0,1598 # 5dd8 <malloc+0xb84>
    17a2:	1ff030ef          	jal	51a0 <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	5c8030ef          	jal	4d70 <exit>
{
    17ac:	0c800493          	li	s1,200
        int pid1 = fork();
    17b0:	5b8030ef          	jal	4d68 <fork>
        if(pid1 < 0){
    ...
    17b8:	cd01                	beqz	a0,17d0 <forkfork+0x7e>
        wait(0);
    17ba:	4501                	li	a0,0
    17bc:	5bc030ef          	jal	4d78 <wait>
      for(int j = 0; j < 200; j++){
    17c0:	34fd                	addiw	s1,s1,-1
    17c2:	f4fd                	bnez	s1,17b0 <forkfork+0x5e>
      exit(0);
    17c4:	4501                	li	a0,0
    17c6:	5aa030ef          	jal	4d70 <exit>
          exit(1);
    17ca:	4505                	li	a0,1
    17cc:	5a4030ef          	jal	4d70 <exit>
          exit(0);
    17d0:	5a0030ef          	jal	4d70 <exit>
      printf("%s: fork in child failed", s);
    17d4:	85a6                	mv	a1,s1
    17d6:	00004517          	auipc	a0,0x4
    17da:	61250513          	addi	a0,a0,1554 # 5de8 <malloc+0xb94>
    17de:	1c3030ef          	jal	51a0 <printf>
      exit(1);
    17e2:	4505                	li	a0,1
    17e4:	58c030ef          	jal	4d70 <exit>
...
00000000000017e8 <reparent2>:
{
    ...
    wait(0);
    1800:	4501                	li	a0,0
    1802:	576030ef          	jal	4d78 <wait>
  for(int i = 0; i < 800; i++){
    1806:	34fd                	addiw	s1,s1,-1
    1808:	f4fd                	bnez	s1,17f6 <reparent2+0xe>
  exit(0);
    180a:	4501                	li	a0,0
    180c:	564030ef          	jal	4d70 <exit>
      printf("fork failed\n");
    1810:	00006517          	auipc	a0,0x6
    1814:	9b050513          	addi	a0,a0,-1616 # 71c0 <malloc+0x1f6c>
    1818:	189030ef          	jal	51a0 <printf>
      exit(1);
    181c:	4505                	li	a0,1
    181e:	552030ef          	jal	4d70 <exit>
      fork();
    1822:	546030ef          	jal	4d68 <fork>
      fork();
    1826:	542030ef          	jal	4d68 <fork>
      exit(0);
    182a:	4501                	li	a0,0
    182c:	544030ef          	jal	4d70 <exit>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	38650513          	addi	a0,a0,902 # 5c18 <malloc+0x9c4>
    189a:	107030ef          	jal	51a0 <printf>
      exit(1);
    189e:	4505                	li	a0,1
    18a0:	4d0030ef          	jal	4d70 <exit>
      name[0] = 'p' + pi;
    ...
    18ba:	3fa50513          	addi	a0,a0,1018 # 5cb0 <malloc+0xa5c>
    18be:	0e3030ef          	jal	51a0 <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    18c4:	4ac030ef          	jal	4d70 <exit>
      for(i = 0; i < N; i++){
    ...
    18de:	4d2030ef          	jal	4db0 <open>
        if(fd < 0){
    18e2:	fc0549e3          	bltz	a0,18b4 <createdelete+0x84>
        close(fd);
    18e6:	4b2030ef          	jal	4d98 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    190a:	4b6030ef          	jal	4dc0 <unlink>
    190e:	fa055de3          	bgez	a0,18c8 <createdelete+0x98>
            printf("%s: unlink failed\n", s);
    1912:	85e6                	mv	a1,s9
    1914:	00004517          	auipc	a0,0x4
    1918:	4f450513          	addi	a0,a0,1268 # 5e08 <malloc+0xbb4>
    191c:	085030ef          	jal	51a0 <printf>
            exit(1);
    1920:	4505                	li	a0,1
    1922:	44e030ef          	jal	4d70 <exit>
      exit(0);
    1926:	4501                	li	a0,0
    1928:	448030ef          	jal	4d70 <exit>
      exit(1);
    192c:	4505                	li	a0,1
    192e:	442030ef          	jal	4d70 <exit>
        printf("%s: oops createdelete %s didn't exist\n", s, name);
    1932:	f8040613          	addi	a2,s0,-128
    1936:	85e6                	mv	a1,s9
    1938:	00004517          	auipc	a0,0x4
    193c:	4e850513          	addi	a0,a0,1256 # 5e20 <malloc+0xbcc>
    1940:	061030ef          	jal	51a0 <printf>
        exit(1);
    1944:	4505                	li	a0,1
    1946:	42a030ef          	jal	4d70 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    198e:	4be50513          	addi	a0,a0,1214 # 5e48 <malloc+0xbf4>
    1992:	00f030ef          	jal	51a0 <printf>
        exit(1);
    1996:	4505                	li	a0,1
    1998:	3d8030ef          	jal	4d70 <exit>
  for(i = 0; i < N; i++){
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	9d450513          	addi	a0,a0,-1580 # 53f8 <malloc+0x1a4>
    1a2c:	394030ef          	jal	4dc0 <unlink>
  pid = fork();
    1a30:	338030ef          	jal	4d68 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	9a0b0b13          	addi	s6,s6,-1632 # 53f8 <malloc+0x1a4>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	410c0c13          	addi	s8,s8,1040 # 5e70 <malloc+0xc1c>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	1ac50513          	addi	a0,a0,428 # 5c18 <malloc+0x9c4>
    1a74:	72c030ef          	jal	51a0 <printf>
    exit(1);
    1a78:	4505                	li	a0,1
    1a7a:	2f6030ef          	jal	4d70 <exit>
      close(open("x", O_RDWR | O_CREATE));
    1a7e:	20200593          	li	a1,514
    1a82:	855a                	mv	a0,s6
    1a84:	32c030ef          	jal	4db0 <open>
    1a88:	310030ef          	jal	4d98 <close>
  for(i = 0; i < 100; i++){
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	3b450513          	addi	a0,a0,948 # 5ec0 <malloc+0xc6c>
    1b14:	68c030ef          	jal	51a0 <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    1b1a:	256030ef          	jal	4d70 <exit>
      exit(0);
    1b1e:	252030ef          	jal	4d70 <exit>
    printf("%s: no fork at all!\n", s);
    1b22:	85ce                	mv	a1,s3
    1b24:	00004517          	auipc	a0,0x4
    1b28:	35450513          	addi	a0,a0,852 # 5e78 <malloc+0xc24>
    1b2c:	674030ef          	jal	51a0 <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    1b32:	23e030ef          	jal	4d70 <exit>
      printf("%s: wait stopped early\n", s);
    1b36:	85ce                	mv	a1,s3
    1b38:	00004517          	auipc	a0,0x4
    1b3c:	35850513          	addi	a0,a0,856 # 5e90 <malloc+0xc3c>
    1b40:	660030ef          	jal	51a0 <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    1b46:	22a030ef          	jal	4d70 <exit>
    printf("%s: wait got too many\n", s);
    1b4a:	85ce                	mv	a1,s3
    1b4c:	00004517          	auipc	a0,0x4
    1b50:	35c50513          	addi	a0,a0,860 # 5ea8 <malloc+0xc54>
    1b54:	64c030ef          	jal	51a0 <printf>
    exit(1);
    1b58:	4505                	li	a0,1
    1b5a:	216030ef          	jal	4d70 <exit>
  if (n == 0) {
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	02e50513          	addi	a0,a0,46 # 5c18 <malloc+0x9c4>
    1bf2:	5ae030ef          	jal	51a0 <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    1bf8:	178030ef          	jal	4d70 <exit>
      printf("%s: oops could read %p = %x\n", s, a, *a);
    1bfc:	0004c683          	lbu	a3,0(s1)
    1c00:	8626                	mv	a2,s1
    1c02:	85d6                	mv	a1,s5
    1c04:	00004517          	auipc	a0,0x4
    1c08:	2e450513          	addi	a0,a0,740 # 5ee8 <malloc+0xc94>
    1c0c:	594030ef          	jal	51a0 <printf>
      exit(1);
    1c10:	4505                	li	a0,1
    1c12:	15e030ef          	jal	4d70 <exit>
      exit(1);
    1c16:	4505                	li	a0,1
    1c18:	158030ef          	jal	4d70 <exit>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	fa650513          	addi	a0,a0,-90 # 5c18 <malloc+0x9c4>
    1c7a:	526030ef          	jal	51a0 <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    1c80:	0f0030ef          	jal	4d70 <exit>
      *(char*)a = 99;
    ...
    1c9a:	27250513          	addi	a0,a0,626 # 5f08 <malloc+0xcb4>
    1c9e:	502030ef          	jal	51a0 <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
    1ca4:	0cc030ef          	jal	4d70 <exit>
      exit(1);
    1ca8:	4505                	li	a0,1
    1caa:	0c6030ef          	jal	4d70 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	23a50513          	addi	a0,a0,570 # 5f20 <malloc+0xccc>
    1cee:	4b2030ef          	jal	51a0 <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    1cf4:	07c030ef          	jal	4d70 <exit>
    printf("%s: fork failed\n", s);
    1cf8:	85a6                	mv	a1,s1
    1cfa:	00004517          	auipc	a0,0x4
    1cfe:	f1e50513          	addi	a0,a0,-226 # 5c18 <malloc+0x9c4>
    1d02:	49e030ef          	jal	51a0 <printf>
    exit(1);
    1d06:	4505                	li	a0,1
    1d08:	068030ef          	jal	4d70 <exit>
    exit(0);
    1d0c:	4501                	li	a0,0
    1d0e:	062030ef          	jal	4d70 <exit>
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	bae78793          	addi	a5,a5,-1106 # 78d0 <malloc+0x267c>
  ...
  exit(0);
    ...
    1d8e:	1be50513          	addi	a0,a0,446 # 5f48 <malloc+0xcf4>
    1d92:	40e030ef          	jal	51a0 <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    1d98:	7d9020ef          	jal	4d70 <exit>
      printf("%s: fork failed\n", s);
    1d9c:	85ce                	mv	a1,s3
    1d9e:	00004517          	auipc	a0,0x4
    1da2:	e7a50513          	addi	a0,a0,-390 # 5c18 <malloc+0x9c4>
    1da6:	3fa030ef          	jal	51a0 <printf>
      exit(1);
    1daa:	4505                	li	a0,1
    1dac:	7c5020ef          	jal	4d70 <exit>
      exit(1);
    1db0:	4505                	li	a0,1
    1db2:	7bf020ef          	jal	4d70 <exit>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    1dfe:	4501                	li	a0,0
    1e00:	771020ef          	jal	4d70 <exit>
    1e04:	f852                	sd	s4,48(sp)
    1e06:	f05a                	sd	s6,32(sp)
    1e08:	ec5e                	sd	s7,24(sp)
      printf("fork failed\n");
    1e0a:	00005517          	auipc	a0,0x5
    1e0e:	3b650513          	addi	a0,a0,950 # 71c0 <malloc+0x1f6c>
    1e12:	38e030ef          	jal	51a0 <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    1e18:	759020ef          	jal	4d70 <exit>
    ...
    1e62:	85da                	mv	a1,s6
    1e64:	72d020ef          	jal	4d90 <write>
          if(cc != sz){
    1e68:	678d                	lui	a5,0x3
    1e6a:	04f51263          	bne	a0,a5,1eae <manywrites+0xf8>
          close(fd);
    1e6e:	854a                	mv	a0,s2
    1e70:	729020ef          	jal	4d98 <close>
        for(int i = 0; i < ci+1; i++){
    1e74:	2a05                	addiw	s4,s4,1
    1e76:	fd49dce3          	bge	s3,s4,1e4e <manywrites+0x98>
        unlink(name);
    1e7a:	fa840513          	addi	a0,s0,-88
    1e7e:	743020ef          	jal	4dc0 <unlink>
      for(int iters = 0; iters < howmany; iters++){
    1e82:	3bfd                	addiw	s7,s7,-1
    1e84:	fc0b92e3          	bnez	s7,1e48 <manywrites+0x92>
      unlink(name);
    1e88:	fa840513          	addi	a0,s0,-88
    1e8c:	735020ef          	jal	4dc0 <unlink>
      exit(0);
    1e90:	4501                	li	a0,0
    1e92:	6df020ef          	jal	4d70 <exit>
            printf("%s: cannot create %s\n", s, name);
    1e96:	fa840613          	addi	a2,s0,-88
    1e9a:	85d6                	mv	a1,s5
    1e9c:	00004517          	auipc	a0,0x4
    1ea0:	0cc50513          	addi	a0,a0,204 # 5f68 <malloc+0xd14>
    1ea4:	2fc030ef          	jal	51a0 <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    1eaa:	6c7020ef          	jal	4d70 <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    1eae:	86aa                	mv	a3,a0
    1eb0:	660d                	lui	a2,0x3
    1eb2:	85d6                	mv	a1,s5
    1eb4:	00003517          	auipc	a0,0x3
    1eb8:	5a450513          	addi	a0,a0,1444 # 5458 <malloc+0x204>
    1ebc:	2e4030ef          	jal	51a0 <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
    1ec2:	6af020ef          	jal	4d70 <exit>
      exit(st);
    1ec6:	6ab020ef          	jal	4d70 <exit>
...
0000000000001eca <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    1ed6:	667020ef          	jal	4d3c <sbrk>
  uint64 top = (uint64) sbrk(0);
    1eda:	4501                	li	a0,0
    1edc:	661020ef          	jal	4d3c <sbrk>
  if((top % PGSIZE) != 0){
    1ee0:	03451793          	slli	a5,a0,0x34
    1ee4:	e7bd                	bnez	a5,1f52 <copyinstr3+0x88>
  top = (uint64) sbrk(0);
    1ee6:	4501                	li	a0,0
    1ee8:	655020ef          	jal	4d3c <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  if(ret != -1){
    ...
    1f5c:	5e1020ef          	jal	4d3c <sbrk>
    1f60:	b759                	j	1ee6 <copyinstr3+0x1c>
    printf("oops\n");
    1f62:	00004517          	auipc	a0,0x4
    1f66:	01e50513          	addi	a0,a0,30 # 5f80 <malloc+0xd2c>
    1f6a:	236030ef          	jal	51a0 <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    1f70:	601020ef          	jal	4d70 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    1f74:	862a                	mv	a2,a0
    1f76:	85a6                	mv	a1,s1
    1f78:	00004517          	auipc	a0,0x4
    1f7c:	bc050513          	addi	a0,a0,-1088 # 5b38 <malloc+0x8e4>
    1f80:	220030ef          	jal	51a0 <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    1f86:	5eb020ef          	jal	4d70 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    1f8a:	862a                	mv	a2,a0
    1f8c:	85a6                	mv	a1,s1
    1f8e:	00004517          	auipc	a0,0x4
    1f92:	bca50513          	addi	a0,a0,-1078 # 5b58 <malloc+0x904>
    1f96:	20a030ef          	jal	51a0 <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    1f9c:	5d5020ef          	jal	4d70 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    1fa0:	86aa                	mv	a3,a0
    1fa2:	8626                	mv	a2,s1
    1fa4:	85a6                	mv	a1,s1
    1fa6:	00004517          	auipc	a0,0x4
    1faa:	bd250513          	addi	a0,a0,-1070 # 5b78 <malloc+0x924>
    1fae:	1f2030ef          	jal	51a0 <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    1fb4:	5bd020ef          	jal	4d70 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    1fb8:	567d                	li	a2,-1
    1fba:	85a6                	mv	a1,s1
    1fbc:	00004517          	auipc	a0,0x4
    1fc0:	be450513          	addi	a0,a0,-1052 # 5ba0 <malloc+0x94c>
    1fc4:	1dc030ef          	jal	51a0 <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
    1fca:	5a7020ef          	jal	4d70 <exit>
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	fc850513          	addi	a0,a0,-56 # 5fc0 <malloc+0xd6c>
    2000:	5b1020ef          	jal	4db0 <open>
    2004:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    2024:	fc050513          	addi	a0,a0,-64 # 5fe0 <malloc+0xd8c>
    2028:	178030ef          	jal	51a0 <printf>
    exit(1);
    202c:	4505                	li	a0,1
    202e:	543020ef          	jal	4d70 <exit>
    2032:	e426                	sd	s1,8(sp)
    2034:	e04a                	sd	s2,0(sp)
    printf("sbrk(rwsbrk) failed\n");
    2036:	00004517          	auipc	a0,0x4
    203a:	f5250513          	addi	a0,a0,-174 # 5f88 <malloc+0xd34>
    203e:	162030ef          	jal	51a0 <printf>
    exit(1);
    2042:	4505                	li	a0,1
    2044:	52d020ef          	jal	4d70 <exit>
    2048:	e04a                	sd	s2,0(sp)
    printf("sbrk(rwsbrk) shrink failed\n");
    204a:	00004517          	auipc	a0,0x4
    204e:	f5650513          	addi	a0,a0,-170 # 5fa0 <malloc+0xd4c>
    2052:	14e030ef          	jal	51a0 <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	519020ef          	jal	4d70 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	f6c50513          	addi	a0,a0,-148 # 5fc8 <malloc+0xd74>
    2064:	13c030ef          	jal	51a0 <printf>
    exit(1);
    2068:	4505                	li	a0,1
    206a:	507020ef          	jal	4d70 <exit>
  close(fd);
    206e:	854a                	mv	a0,s2
    2070:	529020ef          	jal	4d98 <close>
  unlink("rwsbrk");
    2074:	00004517          	auipc	a0,0x4
    2078:	f4c50513          	addi	a0,a0,-180 # 5fc0 <malloc+0xd6c>
    207c:	545020ef          	jal	4dc0 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	4de50513          	addi	a0,a0,1246 # 5560 <malloc+0x30c>
    208a:	527020ef          	jal	4db0 <open>
    208e:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  if(n >= 0){
    ...
    20a8:	f6c50513          	addi	a0,a0,-148 # 6010 <malloc+0xdbc>
    20ac:	0f4030ef          	jal	51a0 <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	4bf020ef          	jal	4d70 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	4b250513          	addi	a0,a0,1202 # 5568 <malloc+0x314>
    20be:	0e2030ef          	jal	51a0 <printf>
    exit(1);
    20c2:	4505                	li	a0,1
    20c4:	4ad020ef          	jal	4d70 <exit>
  close(fd);
    20c8:	854a                	mv	a0,s2
    20ca:	4cf020ef          	jal	4d98 <close>
  exit(0);
    20ce:	4501                	li	a0,0
    20d0:	4a1020ef          	jal	4d70 <exit>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	ee850513          	addi	a0,a0,-280 # 6058 <malloc+0xe04>
    2178:	028030ef          	jal	51a0 <printf>
    exit(1);
    217c:	4505                	li	a0,1
    217e:	3f3020ef          	jal	4d70 <exit>
    2182:	84be                	mv	s1,a5
    b = sbrk(1);
    2184:	4505                	li	a0,1
    2186:	3b7020ef          	jal	4d3c <sbrk>
    if(b != a){
  ...
  pid = fork();
    219e:	3cb020ef          	jal	4d68 <fork>
    21a2:	892a                	mv	s2,a0
  if(pid < 0){
    21a4:	04054263          	bltz	a0,21e8 <sbrkbasic+0x114>
  c = sbrk(1);
    21a8:	4505                	li	a0,1
    21aa:	393020ef          	jal	4d3c <sbrk>
  c = sbrk(1);
    21ae:	4505                	li	a0,1
    21b0:	38d020ef          	jal	4d3c <sbrk>
  if(c != a + 1){
    ...
    21c0:	efc50513          	addi	a0,a0,-260 # 60b8 <malloc+0xe64>
    21c4:	7dd020ef          	jal	51a0 <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    21ca:	3a7020ef          	jal	4d70 <exit>
    ...
    21da:	ea250513          	addi	a0,a0,-350 # 6078 <malloc+0xe24>
    21de:	7c3020ef          	jal	51a0 <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    21e4:	38d020ef          	jal	4d70 <exit>
    printf("%s: sbrk test fork failed\n", s);
    21e8:	85ce                	mv	a1,s3
    21ea:	00004517          	auipc	a0,0x4
    21ee:	eae50513          	addi	a0,a0,-338 # 6098 <malloc+0xe44>
    21f2:	7af020ef          	jal	51a0 <printf>
    exit(1);
    21f6:	4505                	li	a0,1
    21f8:	379020ef          	jal	4d70 <exit>
  if(pid == 0)
    21fc:	00091563          	bnez	s2,2206 <sbrkbasic+0x132>
    exit(0);
    2200:	4501                	li	a0,0
    2202:	36f020ef          	jal	4d70 <exit>
  wait(&xstatus);
    2206:	fcc40513          	addi	a0,s0,-52
    220a:	36f020ef          	jal	4d78 <wait>
  exit(xstatus);
    220e:	fcc42503          	lw	a0,-52(s0)
    2212:	35f020ef          	jal	4d70 <exit>
...
0000000000002216 <sbrkmuch>:
{
  ...
  oldbrk = sbrk(0);
    2228:	4501                	li	a0,0
    222a:	313020ef          	jal	4d3c <sbrk>
    222e:	892a                	mv	s2,a0
  a = sbrk(0);
    2230:	4501                	li	a0,0
    2232:	30b020ef          	jal	4d3c <sbrk>
    2236:	84aa                	mv	s1,a0
  p = sbrk(amt);
    2238:	06400537          	lui	a0,0x6400
    223c:	9d05                	subw	a0,a0,s1
    223e:	2ff020ef          	jal	4d3c <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2274:	4501                	li	a0,0
    2276:	2c7020ef          	jal	4d3c <sbrk>
    227a:	84aa                	mv	s1,a0
  c = sbrk(PGSIZE);
    227c:	6505                	lui	a0,0x1
    227e:	2bf020ef          	jal	4d3c <sbrk>
    2282:	8a2a                	mv	s4,a0
  if(c != a || sbrk(0) != a + PGSIZE){
    2284:	08a49663          	bne	s1,a0,2310 <sbrkmuch+0xfa>
    2288:	4501                	li	a0,0
    228a:	2b3020ef          	jal	4d3c <sbrk>
  ...
  a = sbrk(0);
    22a6:	4501                	li	a0,0
    22a8:	295020ef          	jal	4d3c <sbrk>
    22ac:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    22ae:	4501                	li	a0,0
    22b0:	28d020ef          	jal	4d3c <sbrk>
    22b4:	40a9053b          	subw	a0,s2,a0
    22b8:	285020ef          	jal	4d3c <sbrk>
  if(c != a){
    ...
    22d6:	e0650513          	addi	a0,a0,-506 # 60d8 <malloc+0xe84>
    22da:	6c7020ef          	jal	51a0 <printf>
    exit(1);
    22de:	4505                	li	a0,1
    22e0:	291020ef          	jal	4d70 <exit>
    printf("%s: sbrk could not deallocate\n", s);
    22e4:	85ce                	mv	a1,s3
    22e6:	00004517          	auipc	a0,0x4
    22ea:	e3a50513          	addi	a0,a0,-454 # 6120 <malloc+0xecc>
    22ee:	6b3020ef          	jal	51a0 <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    22f4:	27d020ef          	jal	4d70 <exit>
    printf("%s: sbrk deallocation produced wrong address, a %p c %p\n", s, a, c);
    22f8:	86aa                	mv	a3,a0
    22fa:	8626                	mv	a2,s1
    22fc:	85ce                	mv	a1,s3
    22fe:	00004517          	auipc	a0,0x4
    2302:	e4250513          	addi	a0,a0,-446 # 6140 <malloc+0xeec>
    2306:	69b020ef          	jal	51a0 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    230c:	265020ef          	jal	4d70 <exit>
    printf("%s: sbrk re-allocation failed, a %p c %p\n", s, a, c);
    2310:	86d2                	mv	a3,s4
    2312:	8626                	mv	a2,s1
    2314:	85ce                	mv	a1,s3
    2316:	00004517          	auipc	a0,0x4
    231a:	e6a50513          	addi	a0,a0,-406 # 6180 <malloc+0xf2c>
    231e:	683020ef          	jal	51a0 <printf>
    exit(1);
    2322:	4505                	li	a0,1
    2324:	24d020ef          	jal	4d70 <exit>
    printf("%s: sbrk de-allocation didn't really deallocate\n", s);
    2328:	85ce                	mv	a1,s3
    232a:	00004517          	auipc	a0,0x4
    232e:	e8650513          	addi	a0,a0,-378 # 61b0 <malloc+0xf5c>
    2332:	66f020ef          	jal	51a0 <printf>
    exit(1);
    2336:	4505                	li	a0,1
    2338:	239020ef          	jal	4d70 <exit>
    printf("%s: sbrk downsize failed, a %p c %p\n", s, a, c);
    233c:	86aa                	mv	a3,a0
    233e:	8626                	mv	a2,s1
    2340:	85ce                	mv	a1,s3
    2342:	00004517          	auipc	a0,0x4
    2346:	ea650513          	addi	a0,a0,-346 # 61e8 <malloc+0xf94>
    234a:	657020ef          	jal	51a0 <printf>
    exit(1);
    234e:	4505                	li	a0,1
    2350:	221020ef          	jal	4d70 <exit>
...
0000000000002354 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    2366:	1d7020ef          	jal	4d3c <sbrk>
    236a:	892a                	mv	s2,a0
  fd = open("sbrk", O_CREATE|O_WRONLY);
    236c:	20100593          	li	a1,513
    2370:	00004517          	auipc	a0,0x4
    2374:	ea050513          	addi	a0,a0,-352 # 6210 <malloc+0xfbc>
    2378:	239020ef          	jal	4db0 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	e9250513          	addi	a0,a0,-366 # 6210 <malloc+0xfbc>
    2386:	23b020ef          	jal	4dc0 <unlink>
  if(fd < 0)  {
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    2390:	85ca                	mv	a1,s2
    2392:	8526                	mv	a0,s1
    2394:	1fd020ef          	jal	4d90 <write>
    2398:	02054c63          	bltz	a0,23d0 <sbrkarg+0x7c>
  close(fd);
    239c:	8526                	mv	a0,s1
    239e:	1fb020ef          	jal	4d98 <close>
  a = sbrk(PGSIZE);
    23a2:	6505                	lui	a0,0x1
    23a4:	199020ef          	jal	4d3c <sbrk>
  if(pipe((int *) a) != 0){
    23a8:	1d9020ef          	jal	4d80 <pipe>
    ...
    23c2:	e5a50513          	addi	a0,a0,-422 # 6218 <malloc+0xfc4>
    23c6:	5db020ef          	jal	51a0 <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    23cc:	1a5020ef          	jal	4d70 <exit>
    printf("%s: write sbrk failed\n", s);
    23d0:	85ce                	mv	a1,s3
    23d2:	00004517          	auipc	a0,0x4
    23d6:	e5e50513          	addi	a0,a0,-418 # 6230 <malloc+0xfdc>
    23da:	5c7020ef          	jal	51a0 <printf>
    exit(1);
    23de:	4505                	li	a0,1
    23e0:	191020ef          	jal	4d70 <exit>
    printf("%s: pipe() failed\n", s);
    23e4:	85ce                	mv	a1,s3
    23e6:	00004517          	auipc	a0,0x4
    23ea:	93a50513          	addi	a0,a0,-1734 # 5d20 <malloc+0xacc>
    23ee:	5b3020ef          	jal	51a0 <printf>
    exit(1);
    23f2:	4505                	li	a0,1
    23f4:	17d020ef          	jal	4d70 <exit>
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	e4050513          	addi	a0,a0,-448 # 6248 <malloc+0xff4>
    2410:	1a1020ef          	jal	4db0 <open>
  if (fd < 0) {
    2414:	02054563          	bltz	a0,243e <argptest+0x46>
    2418:	84aa                	mv	s1,a0
  read(fd, sbrk(0) - 1, -1);
    241a:	4501                	li	a0,0
    241c:	121020ef          	jal	4d3c <sbrk>
    2420:	567d                	li	a2,-1
    2422:	fff50593          	addi	a1,a0,-1
    2426:	8526                	mv	a0,s1
    2428:	161020ef          	jal	4d88 <read>
  close(fd);
    242c:	8526                	mv	a0,s1
    242e:	16b020ef          	jal	4d98 <close>
}
    ...
    2444:	7f050513          	addi	a0,a0,2032 # 5c30 <malloc+0x9dc>
    2448:	559020ef          	jal	51a0 <printf>
    exit(1);
    244c:	4505                	li	a0,1
    244e:	123020ef          	jal	4d70 <exit>
...
0000000000002452 <sbrkbugs>:
{
  ...
  int pid = fork();
    245a:	10f020ef          	jal	4d68 <fork>
  if(pid < 0){
    245e:	00054c63          	bltz	a0,2476 <sbrkbugs+0x24>
  if(pid == 0){
    2462:	e11d                	bnez	a0,2488 <sbrkbugs+0x36>
    int sz = (uint64) sbrk(0);
    2464:	0d9020ef          	jal	4d3c <sbrk>
    sbrk(-sz);
    2468:	40a0053b          	negw	a0,a0
    246c:	0d1020ef          	jal	4d3c <sbrk>
    exit(0);
    2470:	4501                	li	a0,0
    2472:	0ff020ef          	jal	4d70 <exit>
    printf("fork failed\n");
    2476:	00005517          	auipc	a0,0x5
    247a:	d4a50513          	addi	a0,a0,-694 # 71c0 <malloc+0x1f6c>
    247e:	523020ef          	jal	51a0 <printf>
    exit(1);
    2482:	4505                	li	a0,1
    2484:	0ed020ef          	jal	4d70 <exit>
  wait(0);
    2488:	4501                	li	a0,0
    248a:	0ef020ef          	jal	4d78 <wait>
  pid = fork();
    248e:	0db020ef          	jal	4d68 <fork>
  if(pid < 0){
    2492:	00054f63          	bltz	a0,24b0 <sbrkbugs+0x5e>
  if(pid == 0){
    2496:	e515                	bnez	a0,24c2 <sbrkbugs+0x70>
    int sz = (uint64) sbrk(0);
    2498:	0a5020ef          	jal	4d3c <sbrk>
    sbrk(-(sz - 3500));
    249c:	6785                	lui	a5,0x1
    249e:	dac7879b          	addiw	a5,a5,-596 # dac <linktest+0x138>
    24a2:	40a7853b          	subw	a0,a5,a0
    24a6:	097020ef          	jal	4d3c <sbrk>
    exit(0);
    24aa:	4501                	li	a0,0
    24ac:	0c5020ef          	jal	4d70 <exit>
    printf("fork failed\n");
    24b0:	00005517          	auipc	a0,0x5
    24b4:	d1050513          	addi	a0,a0,-752 # 71c0 <malloc+0x1f6c>
    24b8:	4e9020ef          	jal	51a0 <printf>
    exit(1);
    24bc:	4505                	li	a0,1
    24be:	0b3020ef          	jal	4d70 <exit>
  wait(0);
    24c2:	4501                	li	a0,0
    24c4:	0b5020ef          	jal	4d78 <wait>
  pid = fork();
    24c8:	0a1020ef          	jal	4d68 <fork>
  if(pid < 0){
    24cc:	02054263          	bltz	a0,24f0 <sbrkbugs+0x9e>
  if(pid == 0){
    24d0:	e90d                	bnez	a0,2502 <sbrkbugs+0xb0>
    sbrk((10*PGSIZE + 2048) - (uint64)sbrk(0));
    24d2:	06b020ef          	jal	4d3c <sbrk>
    24d6:	67ad                	lui	a5,0xb
    24d8:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x258>
    24dc:	40a7853b          	subw	a0,a5,a0
    24e0:	05d020ef          	jal	4d3c <sbrk>
    sbrk(-10);
    24e4:	5559                	li	a0,-10
    24e6:	057020ef          	jal	4d3c <sbrk>
    exit(0);
    24ea:	4501                	li	a0,0
    24ec:	085020ef          	jal	4d70 <exit>
    printf("fork failed\n");
    24f0:	00005517          	auipc	a0,0x5
    24f4:	cd050513          	addi	a0,a0,-816 # 71c0 <malloc+0x1f6c>
    24f8:	4a9020ef          	jal	51a0 <printf>
    exit(1);
    24fc:	4505                	li	a0,1
    24fe:	073020ef          	jal	4d70 <exit>
  wait(0);
    2502:	4501                	li	a0,0
    2504:	075020ef          	jal	4d78 <wait>
  exit(0);
    2508:	4501                	li	a0,0
    250a:	067020ef          	jal	4d70 <exit>
...
000000000000250e <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    251e:	4501                	li	a0,0
    2520:	01d020ef          	jal	4d3c <sbrk>
  if((top % PGSIZE) != 0)
    2524:	03451793          	slli	a5,a0,0x34
    2528:	ebad                	bnez	a5,259a <sbrklast+0x8c>
  sbrk(PGSIZE);
    252a:	6505                	lui	a0,0x1
    252c:	011020ef          	jal	4d3c <sbrk>
  sbrk(10);
    2530:	4529                	li	a0,10
    2532:	00b020ef          	jal	4d3c <sbrk>
  sbrk(-20);
    2536:	5531                	li	a0,-20
    2538:	005020ef          	jal	4d3c <sbrk>
  top = (uint64) sbrk(0);
    253c:	4501                	li	a0,0
    253e:	7fe020ef          	jal	4d3c <sbrk>
    2542:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2558:	854a                	mv	a0,s2
    255a:	057020ef          	jal	4db0 <open>
    255e:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2560:	4605                	li	a2,1
    2562:	85ca                	mv	a1,s2
    2564:	02d020ef          	jal	4d90 <write>
  close(fd);
    2568:	854e                	mv	a0,s3
    256a:	02f020ef          	jal	4d98 <close>
  fd = open(p, O_RDWR);
    256e:	4589                	li	a1,2
    2570:	854a                	mv	a0,s2
    2572:	03f020ef          	jal	4db0 <open>
  p[0] = '\0';
    2576:	fc048023          	sb	zero,-64(s1)
  read(fd, p, 1);
    257a:	4605                	li	a2,1
    257c:	85ca                	mv	a1,s2
    257e:	00b020ef          	jal	4d88 <read>
  if(p[0] != 'x')
    ...
    25a4:	798020ef          	jal	4d3c <sbrk>
    25a8:	b749                	j	252a <sbrklast+0x1c>
    exit(1);
    25aa:	4505                	li	a0,1
    25ac:	7c4020ef          	jal	4d70 <exit>
...
00000000000025b0 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    25be:	77e020ef          	jal	4d3c <sbrk>
  volatile char *top = sbrk(0);
    25c2:	4501                	li	a0,0
    25c4:	778020ef          	jal	4d3c <sbrk>
  *(top-1) = *(top-1) + 1;
...
00000000000025de <execout>:
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    25fc:	c11d                	beqz	a0,2622 <execout+0x44>
      wait((int*)0);
    25fe:	4501                	li	a0,0
    2600:	778020ef          	jal	4d78 <wait>
  for(int avail = 0; avail < 15; avail++){
    2604:	2905                	addiw	s2,s2,1
    2606:	ff3916e3          	bne	s2,s3,25f2 <execout+0x14>
  exit(0);
    260a:	4501                	li	a0,0
    260c:	764020ef          	jal	4d70 <exit>
      printf("fork failed\n");
    2610:	00005517          	auipc	a0,0x5
    2614:	bb050513          	addi	a0,a0,-1104 # 71c0 <malloc+0x1f6c>
    2618:	389020ef          	jal	51a0 <printf>
      exit(1);
    261c:	4505                	li	a0,1
    261e:	752020ef          	jal	4d70 <exit>
        if(a == SBRK_ERROR)
    2622:	59fd                	li	s3,-1
        *(a + PGSIZE - 1) = 1;
    2624:	4a05                	li	s4,1
...
000000000000267a <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    268a:	d9a50513          	addi	a0,a0,-614 # 6420 <malloc+0x11cc>
    268e:	74a020ef          	jal	4dd8 <mkdir>
    2692:	e555                	bnez	a0,273e <fourteen+0xc4>
  if(mkdir("12345678901234/123456789012345") != 0){
    2694:	00004517          	auipc	a0,0x4
    2698:	be450513          	addi	a0,a0,-1052 # 6278 <malloc+0x1024>
    269c:	73c020ef          	jal	4dd8 <mkdir>
    26a0:	e94d                	bnez	a0,2752 <fourteen+0xd8>
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    26a2:	20000593          	li	a1,512
    26a6:	00004517          	auipc	a0,0x4
    26aa:	c2a50513          	addi	a0,a0,-982 # 62d0 <malloc+0x107c>
    26ae:	702020ef          	jal	4db0 <open>
  if(fd < 0){
    26b2:	0a054a63          	bltz	a0,2766 <fourteen+0xec>
  close(fd);
    26b6:	6e2020ef          	jal	4d98 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    26ba:	4581                	li	a1,0
    26bc:	00004517          	auipc	a0,0x4
    26c0:	c8c50513          	addi	a0,a0,-884 # 6348 <malloc+0x10f4>
    26c4:	6ec020ef          	jal	4db0 <open>
  if(fd < 0){
    26c8:	0a054963          	bltz	a0,277a <fourteen+0x100>
  close(fd);
    26cc:	6cc020ef          	jal	4d98 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    26d0:	00004517          	auipc	a0,0x4
    26d4:	ce850513          	addi	a0,a0,-792 # 63b8 <malloc+0x1164>
    26d8:	700020ef          	jal	4dd8 <mkdir>
    26dc:	c94d                	beqz	a0,278e <fourteen+0x114>
  if(mkdir("123456789012345/12345678901234") == 0){
    26de:	00004517          	auipc	a0,0x4
    26e2:	d3250513          	addi	a0,a0,-718 # 6410 <malloc+0x11bc>
    26e6:	6f2020ef          	jal	4dd8 <mkdir>
    26ea:	cd45                	beqz	a0,27a2 <fourteen+0x128>
  unlink("123456789012345/12345678901234");
    26ec:	00004517          	auipc	a0,0x4
    26f0:	d2450513          	addi	a0,a0,-732 # 6410 <malloc+0x11bc>
    26f4:	6cc020ef          	jal	4dc0 <unlink>
  unlink("12345678901234/12345678901234");
    26f8:	00004517          	auipc	a0,0x4
    26fc:	cc050513          	addi	a0,a0,-832 # 63b8 <malloc+0x1164>
    2700:	6c0020ef          	jal	4dc0 <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    2704:	00004517          	auipc	a0,0x4
    2708:	c4450513          	addi	a0,a0,-956 # 6348 <malloc+0x10f4>
    270c:	6b4020ef          	jal	4dc0 <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    2710:	00004517          	auipc	a0,0x4
    2714:	bc050513          	addi	a0,a0,-1088 # 62d0 <malloc+0x107c>
    2718:	6a8020ef          	jal	4dc0 <unlink>
  unlink("12345678901234/123456789012345");
    271c:	00004517          	auipc	a0,0x4
    2720:	b5c50513          	addi	a0,a0,-1188 # 6278 <malloc+0x1024>
    2724:	69c020ef          	jal	4dc0 <unlink>
  unlink("12345678901234");
    2728:	00004517          	auipc	a0,0x4
    272c:	cf850513          	addi	a0,a0,-776 # 6420 <malloc+0x11cc>
    2730:	690020ef          	jal	4dc0 <unlink>
}
    ...
    2744:	b1050513          	addi	a0,a0,-1264 # 6250 <malloc+0xffc>
    2748:	259020ef          	jal	51a0 <printf>
    exit(1);
    274c:	4505                	li	a0,1
    274e:	622020ef          	jal	4d70 <exit>
    printf("%s: mkdir 12345678901234/123456789012345 failed\n", s);
    2752:	85a6                	mv	a1,s1
    2754:	00004517          	auipc	a0,0x4
    2758:	b4450513          	addi	a0,a0,-1212 # 6298 <malloc+0x1044>
    275c:	245020ef          	jal	51a0 <printf>
    exit(1);
    2760:	4505                	li	a0,1
    2762:	60e020ef          	jal	4d70 <exit>
    printf("%s: create 123456789012345/123456789012345/123456789012345 failed\n", s);
    2766:	85a6                	mv	a1,s1
    2768:	00004517          	auipc	a0,0x4
    276c:	b9850513          	addi	a0,a0,-1128 # 6300 <malloc+0x10ac>
    2770:	231020ef          	jal	51a0 <printf>
    exit(1);
    2774:	4505                	li	a0,1
    2776:	5fa020ef          	jal	4d70 <exit>
    printf("%s: open 12345678901234/12345678901234/12345678901234 failed\n", s);
    277a:	85a6                	mv	a1,s1
    277c:	00004517          	auipc	a0,0x4
    2780:	bfc50513          	addi	a0,a0,-1028 # 6378 <malloc+0x1124>
    2784:	21d020ef          	jal	51a0 <printf>
    exit(1);
    2788:	4505                	li	a0,1
    278a:	5e6020ef          	jal	4d70 <exit>
    printf("%s: mkdir 12345678901234/12345678901234 succeeded!\n", s);
    278e:	85a6                	mv	a1,s1
    2790:	00004517          	auipc	a0,0x4
    2794:	c4850513          	addi	a0,a0,-952 # 63d8 <malloc+0x1184>
    2798:	209020ef          	jal	51a0 <printf>
    exit(1);
    279c:	4505                	li	a0,1
    279e:	5d2020ef          	jal	4d70 <exit>
    printf("%s: mkdir 12345678901234/123456789012345 succeeded!\n", s);
    27a2:	85a6                	mv	a1,s1
    27a4:	00004517          	auipc	a0,0x4
    27a8:	c8c50513          	addi	a0,a0,-884 # 6430 <malloc+0x11dc>
    27ac:	1f5020ef          	jal	51a0 <printf>
    exit(1);
    27b0:	4505                	li	a0,1
    27b2:	5be020ef          	jal	4d70 <exit>
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	c7c50513          	addi	a0,a0,-900 # 6468 <malloc+0x1214>
    27f4:	5cc020ef          	jal	4dc0 <unlink>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	c6050513          	addi	a0,a0,-928 # 6478 <malloc+0x1224>
    2820:	181020ef          	jal	51a0 <printf>
      break;
    2824:	a039                	j	2832 <diskfull+0x7c>
        close(fd);
    2826:	854a                	mv	a0,s2
    2828:	570020ef          	jal	4d98 <close>
    close(fd);
    282c:	854a                	mv	a0,s2
    282e:	56a020ef          	jal	4d98 <close>
  for(int i = 0; i < nzz; i++){
    2832:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2986:	43a020ef          	jal	4dc0 <unlink>
    int fd = open(name, O_CREATE|O_RDWR|O_TRUNC);
    298a:	60200593          	li	a1,1538
    298e:	b8040513          	addi	a0,s0,-1152
    2992:	41e020ef          	jal	4db0 <open>
    2996:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    29c0:	adc50513          	addi	a0,a0,-1316 # 6498 <malloc+0x1244>
    29c4:	7dc020ef          	jal	51a0 <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    29da:	af250513          	addi	a0,a0,-1294 # 64c8 <malloc+0x1274>
    29de:	3fa020ef          	jal	4dd8 <mkdir>
    29e2:	02054f63          	bltz	a0,2a20 <iputtest+0x56>
  if(chdir("iputdir") < 0){
    29e6:	00004517          	auipc	a0,0x4
    29ea:	ae250513          	addi	a0,a0,-1310 # 64c8 <malloc+0x1274>
    29ee:	3f2020ef          	jal	4de0 <chdir>
    29f2:	04054163          	bltz	a0,2a34 <iputtest+0x6a>
  if(unlink("../iputdir") < 0){
    29f6:	00004517          	auipc	a0,0x4
    29fa:	b1250513          	addi	a0,a0,-1262 # 6508 <malloc+0x12b4>
    29fe:	3c2020ef          	jal	4dc0 <unlink>
    2a02:	04054363          	bltz	a0,2a48 <iputtest+0x7e>
  if(chdir("/") < 0){
    2a06:	00004517          	auipc	a0,0x4
    2a0a:	b3250513          	addi	a0,a0,-1230 # 6538 <malloc+0x12e4>
    2a0e:	3d2020ef          	jal	4de0 <chdir>
    ...
    2a26:	aae50513          	addi	a0,a0,-1362 # 64d0 <malloc+0x127c>
    2a2a:	776020ef          	jal	51a0 <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    2a30:	340020ef          	jal	4d70 <exit>
    printf("%s: chdir iputdir failed\n", s);
    2a34:	85a6                	mv	a1,s1
    2a36:	00004517          	auipc	a0,0x4
    2a3a:	ab250513          	addi	a0,a0,-1358 # 64e8 <malloc+0x1294>
    2a3e:	762020ef          	jal	51a0 <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    2a44:	32c020ef          	jal	4d70 <exit>
    printf("%s: unlink ../iputdir failed\n", s);
    2a48:	85a6                	mv	a1,s1
    2a4a:	00004517          	auipc	a0,0x4
    2a4e:	ace50513          	addi	a0,a0,-1330 # 6518 <malloc+0x12c4>
    2a52:	74e020ef          	jal	51a0 <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    2a58:	318020ef          	jal	4d70 <exit>
    printf("%s: chdir / failed\n", s);
    2a5c:	85a6                	mv	a1,s1
    2a5e:	00004517          	auipc	a0,0x4
    2a62:	ae250513          	addi	a0,a0,-1310 # 6540 <malloc+0x12ec>
    2a66:	73a020ef          	jal	51a0 <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
    2a6c:	304020ef          	jal	4d70 <exit>
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a8a:	a4250513          	addi	a0,a0,-1470 # 64c8 <malloc+0x1274>
    2a8e:	34a020ef          	jal	4dd8 <mkdir>
    2a92:	02054f63          	bltz	a0,2ad0 <exitiputtest+0x60>
    if(chdir("iputdir") < 0){
    2a96:	00004517          	auipc	a0,0x4
    2a9a:	a3250513          	addi	a0,a0,-1486 # 64c8 <malloc+0x1274>
    2a9e:	342020ef          	jal	4de0 <chdir>
    2aa2:	04054163          	bltz	a0,2ae4 <exitiputtest+0x74>
    if(unlink("../iputdir") < 0){
    2aa6:	00004517          	auipc	a0,0x4
    2aaa:	a6250513          	addi	a0,a0,-1438 # 6508 <malloc+0x12b4>
    2aae:	312020ef          	jal	4dc0 <unlink>
    2ab2:	04054363          	bltz	a0,2af8 <exitiputtest+0x88>
    exit(0);
    2ab6:	4501                	li	a0,0
    2ab8:	2b8020ef          	jal	4d70 <exit>
    printf("%s: fork failed\n", s);
    2abc:	85a6                	mv	a1,s1
    2abe:	00003517          	auipc	a0,0x3
    2ac2:	15a50513          	addi	a0,a0,346 # 5c18 <malloc+0x9c4>
    2ac6:	6da020ef          	jal	51a0 <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    2acc:	2a4020ef          	jal	4d70 <exit>
      printf("%s: mkdir failed\n", s);
    2ad0:	85a6                	mv	a1,s1
    2ad2:	00004517          	auipc	a0,0x4
    2ad6:	9fe50513          	addi	a0,a0,-1538 # 64d0 <malloc+0x127c>
    2ada:	6c6020ef          	jal	51a0 <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    2ae0:	290020ef          	jal	4d70 <exit>
      printf("%s: child chdir failed\n", s);
    2ae4:	85a6                	mv	a1,s1
    2ae6:	00004517          	auipc	a0,0x4
    2aea:	a7250513          	addi	a0,a0,-1422 # 6558 <malloc+0x1304>
    2aee:	6b2020ef          	jal	51a0 <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    2af4:	27c020ef          	jal	4d70 <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    2af8:	85a6                	mv	a1,s1
    2afa:	00004517          	auipc	a0,0x4
    2afe:	a1e50513          	addi	a0,a0,-1506 # 6518 <malloc+0x12c4>
    2b02:	69e020ef          	jal	51a0 <printf>
      exit(1);
    2b06:	4505                	li	a0,1
    2b08:	268020ef          	jal	4d70 <exit>
  wait(&xstatus);
    2b0c:	fdc40513          	addi	a0,s0,-36
    2b10:	268020ef          	jal	4d78 <wait>
  exit(xstatus);
    2b14:	fdc42503          	lw	a0,-36(s0)
    2b18:	258020ef          	jal	4d70 <exit>
...
0000000000002b1c <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2b2c:	a4850513          	addi	a0,a0,-1464 # 6570 <malloc+0x131c>
    2b30:	2a8020ef          	jal	4dd8 <mkdir>
    2b34:	02054f63          	bltz	a0,2b72 <dirtest+0x56>
  if(chdir("dir0") < 0){
    2b38:	00004517          	auipc	a0,0x4
    2b3c:	a3850513          	addi	a0,a0,-1480 # 6570 <malloc+0x131c>
    2b40:	2a0020ef          	jal	4de0 <chdir>
    2b44:	04054163          	bltz	a0,2b86 <dirtest+0x6a>
  if(chdir("..") < 0){
    2b48:	00004517          	auipc	a0,0x4
    2b4c:	a4850513          	addi	a0,a0,-1464 # 6590 <malloc+0x133c>
    2b50:	290020ef          	jal	4de0 <chdir>
    2b54:	04054363          	bltz	a0,2b9a <dirtest+0x7e>
  if(unlink("dir0") < 0){
    2b58:	00004517          	auipc	a0,0x4
    2b5c:	a1850513          	addi	a0,a0,-1512 # 6570 <malloc+0x131c>
    2b60:	260020ef          	jal	4dc0 <unlink>
    ...
    2b78:	95c50513          	addi	a0,a0,-1700 # 64d0 <malloc+0x127c>
    2b7c:	624020ef          	jal	51a0 <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    2b82:	1ee020ef          	jal	4d70 <exit>
    printf("%s: chdir dir0 failed\n", s);
    2b86:	85a6                	mv	a1,s1
    2b88:	00004517          	auipc	a0,0x4
    2b8c:	9f050513          	addi	a0,a0,-1552 # 6578 <malloc+0x1324>
    2b90:	610020ef          	jal	51a0 <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    2b96:	1da020ef          	jal	4d70 <exit>
    printf("%s: chdir .. failed\n", s);
    2b9a:	85a6                	mv	a1,s1
    2b9c:	00004517          	auipc	a0,0x4
    2ba0:	9fc50513          	addi	a0,a0,-1540 # 6598 <malloc+0x1344>
    2ba4:	5fc020ef          	jal	51a0 <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    2baa:	1c6020ef          	jal	4d70 <exit>
    printf("%s: unlink dir0 failed\n", s);
    2bae:	85a6                	mv	a1,s1
    2bb0:	00004517          	auipc	a0,0x4
    2bb4:	a0050513          	addi	a0,a0,-1536 # 65b0 <malloc+0x135c>
    2bb8:	5e8020ef          	jal	51a0 <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
    2bbe:	1b2020ef          	jal	4d70 <exit>
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b2850513          	addi	a0,a0,-1240 # 66f8 <malloc+0x14a4>
    2bd8:	1e8020ef          	jal	4dc0 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	9ec50513          	addi	a0,a0,-1556 # 65c8 <malloc+0x1374>
    2be4:	1f4020ef          	jal	4dd8 <mkdir>
    2be8:	2e051263          	bnez	a0,2ecc <subdir+0x30a>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    2bec:	20200593          	li	a1,514
    2bf0:	00004517          	auipc	a0,0x4
    2bf4:	9f850513          	addi	a0,a0,-1544 # 65e8 <malloc+0x1394>
    2bf8:	1b8020ef          	jal	4db0 <open>
    2bfc:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    2c08:	af458593          	addi	a1,a1,-1292 # 66f8 <malloc+0x14a4>
    2c0c:	184020ef          	jal	4d90 <write>
  close(fd);
    2c10:	8526                	mv	a0,s1
    2c12:	186020ef          	jal	4d98 <close>
  if(unlink("dd") >= 0){
    2c16:	00004517          	auipc	a0,0x4
    2c1a:	9b250513          	addi	a0,a0,-1614 # 65c8 <malloc+0x1374>
    2c1e:	1a2020ef          	jal	4dc0 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a1a50513          	addi	a0,a0,-1510 # 6640 <malloc+0x13ec>
    2c2e:	1aa020ef          	jal	4dd8 <mkdir>
    2c32:	2c051b63          	bnez	a0,2f08 <subdir+0x346>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    2c36:	20200593          	li	a1,514
    2c3a:	00004517          	auipc	a0,0x4
    2c3e:	a2e50513          	addi	a0,a0,-1490 # 6668 <malloc+0x1414>
    2c42:	16e020ef          	jal	4db0 <open>
    2c46:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    2c52:	a4a58593          	addi	a1,a1,-1462 # 6698 <malloc+0x1444>
    2c56:	13a020ef          	jal	4d90 <write>
  close(fd);
    2c5a:	8526                	mv	a0,s1
    2c5c:	13c020ef          	jal	4d98 <close>
  fd = open("dd/dd/../ff", 0);
    2c60:	4581                	li	a1,0
    2c62:	00004517          	auipc	a0,0x4
    2c66:	a3e50513          	addi	a0,a0,-1474 # 66a0 <malloc+0x144c>
    2c6a:	146020ef          	jal	4db0 <open>
    2c6e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  close(fd);
    2c98:	8526                	mv	a0,s1
    2c9a:	0fe020ef          	jal	4d98 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2c9e:	00004597          	auipc	a1,0x4
    2ca2:	a5258593          	addi	a1,a1,-1454 # 66f0 <malloc+0x149c>
    2ca6:	00004517          	auipc	a0,0x4
    2caa:	9c250513          	addi	a0,a0,-1598 # 6668 <malloc+0x1414>
    2cae:	122020ef          	jal	4dd0 <link>
    2cb2:	2a051363          	bnez	a0,2f58 <subdir+0x396>
  if(unlink("dd/dd/ff") != 0){
    2cb6:	00004517          	auipc	a0,0x4
    2cba:	9b250513          	addi	a0,a0,-1614 # 6668 <malloc+0x1414>
    2cbe:	102020ef          	jal	4dc0 <unlink>
    2cc2:	2a051563          	bnez	a0,2f6c <subdir+0x3aa>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2cc6:	4581                	li	a1,0
    2cc8:	00004517          	auipc	a0,0x4
    2ccc:	9a050513          	addi	a0,a0,-1632 # 6668 <malloc+0x1414>
    2cd0:	0e0020ef          	jal	4db0 <open>
    2cd4:	2a055663          	bgez	a0,2f80 <subdir+0x3be>
  if(chdir("dd") != 0){
    2cd8:	00004517          	auipc	a0,0x4
    2cdc:	8f050513          	addi	a0,a0,-1808 # 65c8 <malloc+0x1374>
    2ce0:	100020ef          	jal	4de0 <chdir>
    2ce4:	2a051863          	bnez	a0,2f94 <subdir+0x3d2>
  if(chdir("dd/../../dd") != 0){
    2ce8:	00004517          	auipc	a0,0x4
    2cec:	aa050513          	addi	a0,a0,-1376 # 6788 <malloc+0x1534>
    2cf0:	0f0020ef          	jal	4de0 <chdir>
    2cf4:	2a051a63          	bnez	a0,2fa8 <subdir+0x3e6>
  if(chdir("dd/../../../dd") != 0){
    2cf8:	00004517          	auipc	a0,0x4
    2cfc:	ac050513          	addi	a0,a0,-1344 # 67b8 <malloc+0x1564>
    2d00:	0e0020ef          	jal	4de0 <chdir>
    2d04:	2a051c63          	bnez	a0,2fbc <subdir+0x3fa>
  if(chdir("./..") != 0){
    2d08:	00004517          	auipc	a0,0x4
    2d0c:	ae850513          	addi	a0,a0,-1304 # 67f0 <malloc+0x159c>
    2d10:	0d0020ef          	jal	4de0 <chdir>
    2d14:	2a051e63          	bnez	a0,2fd0 <subdir+0x40e>
  fd = open("dd/dd/ffff", 0);
    2d18:	4581                	li	a1,0
    2d1a:	00004517          	auipc	a0,0x4
    2d1e:	9d650513          	addi	a0,a0,-1578 # 66f0 <malloc+0x149c>
    2d22:	08e020ef          	jal	4db0 <open>
    2d26:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2d36:	052020ef          	jal	4d88 <read>
    2d3a:	4789                	li	a5,2
    2d3c:	2af51e63          	bne	a0,a5,2ff8 <subdir+0x436>
  close(fd);
    2d40:	8526                	mv	a0,s1
    2d42:	056020ef          	jal	4d98 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    2d46:	4581                	li	a1,0
    2d48:	00004517          	auipc	a0,0x4
    2d4c:	92050513          	addi	a0,a0,-1760 # 6668 <malloc+0x1414>
    2d50:	060020ef          	jal	4db0 <open>
    2d54:	2a055c63          	bgez	a0,300c <subdir+0x44a>
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    2d58:	20200593          	li	a1,514
    2d5c:	00004517          	auipc	a0,0x4
    2d60:	b2450513          	addi	a0,a0,-1244 # 6880 <malloc+0x162c>
    2d64:	04c020ef          	jal	4db0 <open>
    2d68:	2a055c63          	bgez	a0,3020 <subdir+0x45e>
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    2d6c:	20200593          	li	a1,514
    2d70:	00004517          	auipc	a0,0x4
    2d74:	b4050513          	addi	a0,a0,-1216 # 68b0 <malloc+0x165c>
    2d78:	038020ef          	jal	4db0 <open>
    2d7c:	2a055c63          	bgez	a0,3034 <subdir+0x472>
  if(open("dd", O_CREATE) >= 0){
    2d80:	20000593          	li	a1,512
    2d84:	00004517          	auipc	a0,0x4
    2d88:	84450513          	addi	a0,a0,-1980 # 65c8 <malloc+0x1374>
    2d8c:	024020ef          	jal	4db0 <open>
    2d90:	2a055c63          	bgez	a0,3048 <subdir+0x486>
  if(open("dd", O_RDWR) >= 0){
    2d94:	4589                	li	a1,2
    2d96:	00004517          	auipc	a0,0x4
    2d9a:	83250513          	addi	a0,a0,-1998 # 65c8 <malloc+0x1374>
    2d9e:	012020ef          	jal	4db0 <open>
    2da2:	2a055d63          	bgez	a0,305c <subdir+0x49a>
  if(open("dd", O_WRONLY) >= 0){
    2da6:	4585                	li	a1,1
    2da8:	00004517          	auipc	a0,0x4
    2dac:	82050513          	addi	a0,a0,-2016 # 65c8 <malloc+0x1374>
    2db0:	000020ef          	jal	4db0 <open>
    2db4:	2a055e63          	bgez	a0,3070 <subdir+0x4ae>
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    2db8:	00004597          	auipc	a1,0x4
    2dbc:	b8858593          	addi	a1,a1,-1144 # 6940 <malloc+0x16ec>
    2dc0:	00004517          	auipc	a0,0x4
    2dc4:	ac050513          	addi	a0,a0,-1344 # 6880 <malloc+0x162c>
    2dc8:	008020ef          	jal	4dd0 <link>
    2dcc:	2a050c63          	beqz	a0,3084 <subdir+0x4c2>
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    2dd0:	00004597          	auipc	a1,0x4
    2dd4:	b7058593          	addi	a1,a1,-1168 # 6940 <malloc+0x16ec>
    2dd8:	00004517          	auipc	a0,0x4
    2ddc:	ad850513          	addi	a0,a0,-1320 # 68b0 <malloc+0x165c>
    2de0:	7f1010ef          	jal	4dd0 <link>
    2de4:	2a050a63          	beqz	a0,3098 <subdir+0x4d6>
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2de8:	00004597          	auipc	a1,0x4
    2dec:	90858593          	addi	a1,a1,-1784 # 66f0 <malloc+0x149c>
    2df0:	00003517          	auipc	a0,0x3
    2df4:	7f850513          	addi	a0,a0,2040 # 65e8 <malloc+0x1394>
    2df8:	7d9010ef          	jal	4dd0 <link>
    2dfc:	2a050863          	beqz	a0,30ac <subdir+0x4ea>
  if(mkdir("dd/ff/ff") == 0){
    2e00:	00004517          	auipc	a0,0x4
    2e04:	a8050513          	addi	a0,a0,-1408 # 6880 <malloc+0x162c>
    2e08:	7d1010ef          	jal	4dd8 <mkdir>
    2e0c:	2a050a63          	beqz	a0,30c0 <subdir+0x4fe>
  if(mkdir("dd/xx/ff") == 0){
    2e10:	00004517          	auipc	a0,0x4
    2e14:	aa050513          	addi	a0,a0,-1376 # 68b0 <malloc+0x165c>
    2e18:	7c1010ef          	jal	4dd8 <mkdir>
    2e1c:	2a050c63          	beqz	a0,30d4 <subdir+0x512>
  if(mkdir("dd/dd/ffff") == 0){
    2e20:	00004517          	auipc	a0,0x4
    2e24:	8d050513          	addi	a0,a0,-1840 # 66f0 <malloc+0x149c>
    2e28:	7b1010ef          	jal	4dd8 <mkdir>
    2e2c:	2a050e63          	beqz	a0,30e8 <subdir+0x526>
  if(unlink("dd/xx/ff") == 0){
    2e30:	00004517          	auipc	a0,0x4
    2e34:	a8050513          	addi	a0,a0,-1408 # 68b0 <malloc+0x165c>
    2e38:	789010ef          	jal	4dc0 <unlink>
    2e3c:	2c050063          	beqz	a0,30fc <subdir+0x53a>
  if(unlink("dd/ff/ff") == 0){
    2e40:	00004517          	auipc	a0,0x4
    2e44:	a4050513          	addi	a0,a0,-1472 # 6880 <malloc+0x162c>
    2e48:	779010ef          	jal	4dc0 <unlink>
    2e4c:	2c050263          	beqz	a0,3110 <subdir+0x54e>
  if(chdir("dd/ff") == 0){
    2e50:	00003517          	auipc	a0,0x3
    2e54:	79850513          	addi	a0,a0,1944 # 65e8 <malloc+0x1394>
    2e58:	789010ef          	jal	4de0 <chdir>
    2e5c:	2c050463          	beqz	a0,3124 <subdir+0x562>
  if(chdir("dd/xx") == 0){
    2e60:	00004517          	auipc	a0,0x4
    2e64:	c3050513          	addi	a0,a0,-976 # 6a90 <malloc+0x183c>
    2e68:	779010ef          	jal	4de0 <chdir>
    2e6c:	2c050663          	beqz	a0,3138 <subdir+0x576>
  if(unlink("dd/dd/ffff") != 0){
    2e70:	00004517          	auipc	a0,0x4
    2e74:	88050513          	addi	a0,a0,-1920 # 66f0 <malloc+0x149c>
    2e78:	749010ef          	jal	4dc0 <unlink>
    2e7c:	2c051863          	bnez	a0,314c <subdir+0x58a>
  if(unlink("dd/ff") != 0){
    2e80:	00003517          	auipc	a0,0x3
    2e84:	76850513          	addi	a0,a0,1896 # 65e8 <malloc+0x1394>
    2e88:	739010ef          	jal	4dc0 <unlink>
    2e8c:	2c051a63          	bnez	a0,3160 <subdir+0x59e>
  if(unlink("dd") == 0){
    2e90:	00003517          	auipc	a0,0x3
    2e94:	73850513          	addi	a0,a0,1848 # 65c8 <malloc+0x1374>
    2e98:	729010ef          	jal	4dc0 <unlink>
    2e9c:	2c050c63          	beqz	a0,3174 <subdir+0x5b2>
  if(unlink("dd/dd") < 0){
    2ea0:	00004517          	auipc	a0,0x4
    2ea4:	c6050513          	addi	a0,a0,-928 # 6b00 <malloc+0x18ac>
    2ea8:	719010ef          	jal	4dc0 <unlink>
    2eac:	2c054e63          	bltz	a0,3188 <subdir+0x5c6>
  if(unlink("dd") < 0){
    2eb0:	00003517          	auipc	a0,0x3
    2eb4:	71850513          	addi	a0,a0,1816 # 65c8 <malloc+0x1374>
    2eb8:	709010ef          	jal	4dc0 <unlink>
    ...
    2ed2:	70250513          	addi	a0,a0,1794 # 65d0 <malloc+0x137c>
    2ed6:	2ca020ef          	jal	51a0 <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    2edc:	695010ef          	jal	4d70 <exit>
    printf("%s: create dd/ff failed\n", s);
    2ee0:	85ca                	mv	a1,s2
    2ee2:	00003517          	auipc	a0,0x3
    2ee6:	70e50513          	addi	a0,a0,1806 # 65f0 <malloc+0x139c>
    2eea:	2b6020ef          	jal	51a0 <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    2ef0:	681010ef          	jal	4d70 <exit>
    printf("%s: unlink dd (non-empty dir) succeeded!\n", s);
    2ef4:	85ca                	mv	a1,s2
    2ef6:	00003517          	auipc	a0,0x3
    2efa:	71a50513          	addi	a0,a0,1818 # 6610 <malloc+0x13bc>
    2efe:	2a2020ef          	jal	51a0 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    2f04:	66d010ef          	jal	4d70 <exit>
    printf("%s: subdir mkdir dd/dd failed\n", s);
    2f08:	85ca                	mv	a1,s2
    2f0a:	00003517          	auipc	a0,0x3
    2f0e:	73e50513          	addi	a0,a0,1854 # 6648 <malloc+0x13f4>
    2f12:	28e020ef          	jal	51a0 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    2f18:	659010ef          	jal	4d70 <exit>
    printf("%s: create dd/dd/ff failed\n", s);
    2f1c:	85ca                	mv	a1,s2
    2f1e:	00003517          	auipc	a0,0x3
    2f22:	75a50513          	addi	a0,a0,1882 # 6678 <malloc+0x1424>
    2f26:	27a020ef          	jal	51a0 <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    2f2c:	645010ef          	jal	4d70 <exit>
    printf("%s: open dd/dd/../ff failed\n", s);
    2f30:	85ca                	mv	a1,s2
    2f32:	00003517          	auipc	a0,0x3
    2f36:	77e50513          	addi	a0,a0,1918 # 66b0 <malloc+0x145c>
    2f3a:	266020ef          	jal	51a0 <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    2f40:	631010ef          	jal	4d70 <exit>
    printf("%s: dd/dd/../ff wrong content\n", s);
    2f44:	85ca                	mv	a1,s2
    2f46:	00003517          	auipc	a0,0x3
    2f4a:	78a50513          	addi	a0,a0,1930 # 66d0 <malloc+0x147c>
    2f4e:	252020ef          	jal	51a0 <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    2f54:	61d010ef          	jal	4d70 <exit>
    printf("%s: link dd/dd/ff dd/dd/ffff failed\n", s);
    2f58:	85ca                	mv	a1,s2
    2f5a:	00003517          	auipc	a0,0x3
    2f5e:	7a650513          	addi	a0,a0,1958 # 6700 <malloc+0x14ac>
    2f62:	23e020ef          	jal	51a0 <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    2f68:	609010ef          	jal	4d70 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    2f6c:	85ca                	mv	a1,s2
    2f6e:	00003517          	auipc	a0,0x3
    2f72:	7ba50513          	addi	a0,a0,1978 # 6728 <malloc+0x14d4>
    2f76:	22a020ef          	jal	51a0 <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    2f7c:	5f5010ef          	jal	4d70 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded\n", s);
    2f80:	85ca                	mv	a1,s2
    2f82:	00003517          	auipc	a0,0x3
    2f86:	7c650513          	addi	a0,a0,1990 # 6748 <malloc+0x14f4>
    2f8a:	216020ef          	jal	51a0 <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    2f90:	5e1010ef          	jal	4d70 <exit>
    printf("%s: chdir dd failed\n", s);
    2f94:	85ca                	mv	a1,s2
    2f96:	00003517          	auipc	a0,0x3
    2f9a:	7da50513          	addi	a0,a0,2010 # 6770 <malloc+0x151c>
    2f9e:	202020ef          	jal	51a0 <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    2fa4:	5cd010ef          	jal	4d70 <exit>
    printf("%s: chdir dd/../../dd failed\n", s);
    2fa8:	85ca                	mv	a1,s2
    2faa:	00003517          	auipc	a0,0x3
    2fae:	7ee50513          	addi	a0,a0,2030 # 6798 <malloc+0x1544>
    2fb2:	1ee020ef          	jal	51a0 <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    2fb8:	5b9010ef          	jal	4d70 <exit>
    printf("%s: chdir dd/../../../dd failed\n", s);
    2fbc:	85ca                	mv	a1,s2
    2fbe:	00004517          	auipc	a0,0x4
    2fc2:	80a50513          	addi	a0,a0,-2038 # 67c8 <malloc+0x1574>
    2fc6:	1da020ef          	jal	51a0 <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    2fcc:	5a5010ef          	jal	4d70 <exit>
    printf("%s: chdir ./.. failed\n", s);
    2fd0:	85ca                	mv	a1,s2
    2fd2:	00004517          	auipc	a0,0x4
    2fd6:	82650513          	addi	a0,a0,-2010 # 67f8 <malloc+0x15a4>
    2fda:	1c6020ef          	jal	51a0 <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    2fe0:	591010ef          	jal	4d70 <exit>
    printf("%s: open dd/dd/ffff failed\n", s);
    2fe4:	85ca                	mv	a1,s2
    2fe6:	00004517          	auipc	a0,0x4
    2fea:	82a50513          	addi	a0,a0,-2006 # 6810 <malloc+0x15bc>
    2fee:	1b2020ef          	jal	51a0 <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    2ff4:	57d010ef          	jal	4d70 <exit>
    printf("%s: read dd/dd/ffff wrong len\n", s);
    2ff8:	85ca                	mv	a1,s2
    2ffa:	00004517          	auipc	a0,0x4
    2ffe:	83650513          	addi	a0,a0,-1994 # 6830 <malloc+0x15dc>
    3002:	19e020ef          	jal	51a0 <printf>
    exit(1);
    3006:	4505                	li	a0,1
    3008:	569010ef          	jal	4d70 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    300c:	85ca                	mv	a1,s2
    300e:	00004517          	auipc	a0,0x4
    3012:	84250513          	addi	a0,a0,-1982 # 6850 <malloc+0x15fc>
    3016:	18a020ef          	jal	51a0 <printf>
    exit(1);
    301a:	4505                	li	a0,1
    301c:	555010ef          	jal	4d70 <exit>
    printf("%s: create dd/ff/ff succeeded!\n", s);
    3020:	85ca                	mv	a1,s2
    3022:	00004517          	auipc	a0,0x4
    3026:	86e50513          	addi	a0,a0,-1938 # 6890 <malloc+0x163c>
    302a:	176020ef          	jal	51a0 <printf>
    exit(1);
    302e:	4505                	li	a0,1
    3030:	541010ef          	jal	4d70 <exit>
    printf("%s: create dd/xx/ff succeeded!\n", s);
    3034:	85ca                	mv	a1,s2
    3036:	00004517          	auipc	a0,0x4
    303a:	88a50513          	addi	a0,a0,-1910 # 68c0 <malloc+0x166c>
    303e:	162020ef          	jal	51a0 <printf>
    exit(1);
    3042:	4505                	li	a0,1
    3044:	52d010ef          	jal	4d70 <exit>
    printf("%s: create dd succeeded!\n", s);
    3048:	85ca                	mv	a1,s2
    304a:	00004517          	auipc	a0,0x4
    304e:	89650513          	addi	a0,a0,-1898 # 68e0 <malloc+0x168c>
    3052:	14e020ef          	jal	51a0 <printf>
    exit(1);
    3056:	4505                	li	a0,1
    3058:	519010ef          	jal	4d70 <exit>
    printf("%s: open dd rdwr succeeded!\n", s);
    305c:	85ca                	mv	a1,s2
    305e:	00004517          	auipc	a0,0x4
    3062:	8a250513          	addi	a0,a0,-1886 # 6900 <malloc+0x16ac>
    3066:	13a020ef          	jal	51a0 <printf>
    exit(1);
    306a:	4505                	li	a0,1
    306c:	505010ef          	jal	4d70 <exit>
    printf("%s: open dd wronly succeeded!\n", s);
    3070:	85ca                	mv	a1,s2
    3072:	00004517          	auipc	a0,0x4
    3076:	8ae50513          	addi	a0,a0,-1874 # 6920 <malloc+0x16cc>
    307a:	126020ef          	jal	51a0 <printf>
    exit(1);
    307e:	4505                	li	a0,1
    3080:	4f1010ef          	jal	4d70 <exit>
    printf("%s: link dd/ff/ff dd/dd/xx succeeded!\n", s);
    3084:	85ca                	mv	a1,s2
    3086:	00004517          	auipc	a0,0x4
    308a:	8ca50513          	addi	a0,a0,-1846 # 6950 <malloc+0x16fc>
    308e:	112020ef          	jal	51a0 <printf>
    exit(1);
    3092:	4505                	li	a0,1
    3094:	4dd010ef          	jal	4d70 <exit>
    printf("%s: link dd/xx/ff dd/dd/xx succeeded!\n", s);
    3098:	85ca                	mv	a1,s2
    309a:	00004517          	auipc	a0,0x4
    309e:	8de50513          	addi	a0,a0,-1826 # 6978 <malloc+0x1724>
    30a2:	0fe020ef          	jal	51a0 <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    30a8:	4c9010ef          	jal	4d70 <exit>
    printf("%s: link dd/ff dd/dd/ffff succeeded!\n", s);
    30ac:	85ca                	mv	a1,s2
    30ae:	00004517          	auipc	a0,0x4
    30b2:	8f250513          	addi	a0,a0,-1806 # 69a0 <malloc+0x174c>
    30b6:	0ea020ef          	jal	51a0 <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    30bc:	4b5010ef          	jal	4d70 <exit>
    printf("%s: mkdir dd/ff/ff succeeded!\n", s);
    30c0:	85ca                	mv	a1,s2
    30c2:	00004517          	auipc	a0,0x4
    30c6:	90650513          	addi	a0,a0,-1786 # 69c8 <malloc+0x1774>
    30ca:	0d6020ef          	jal	51a0 <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    30d0:	4a1010ef          	jal	4d70 <exit>
    printf("%s: mkdir dd/xx/ff succeeded!\n", s);
    30d4:	85ca                	mv	a1,s2
    30d6:	00004517          	auipc	a0,0x4
    30da:	91250513          	addi	a0,a0,-1774 # 69e8 <malloc+0x1794>
    30de:	0c2020ef          	jal	51a0 <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    30e4:	48d010ef          	jal	4d70 <exit>
    printf("%s: mkdir dd/dd/ffff succeeded!\n", s);
    30e8:	85ca                	mv	a1,s2
    30ea:	00004517          	auipc	a0,0x4
    30ee:	91e50513          	addi	a0,a0,-1762 # 6a08 <malloc+0x17b4>
    30f2:	0ae020ef          	jal	51a0 <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    30f8:	479010ef          	jal	4d70 <exit>
    printf("%s: unlink dd/xx/ff succeeded!\n", s);
    30fc:	85ca                	mv	a1,s2
    30fe:	00004517          	auipc	a0,0x4
    3102:	93250513          	addi	a0,a0,-1742 # 6a30 <malloc+0x17dc>
    3106:	09a020ef          	jal	51a0 <printf>
    exit(1);
    310a:	4505                	li	a0,1
    310c:	465010ef          	jal	4d70 <exit>
    printf("%s: unlink dd/ff/ff succeeded!\n", s);
    3110:	85ca                	mv	a1,s2
    3112:	00004517          	auipc	a0,0x4
    3116:	93e50513          	addi	a0,a0,-1730 # 6a50 <malloc+0x17fc>
    311a:	086020ef          	jal	51a0 <printf>
    exit(1);
    311e:	4505                	li	a0,1
    3120:	451010ef          	jal	4d70 <exit>
    printf("%s: chdir dd/ff succeeded!\n", s);
    3124:	85ca                	mv	a1,s2
    3126:	00004517          	auipc	a0,0x4
    312a:	94a50513          	addi	a0,a0,-1718 # 6a70 <malloc+0x181c>
    312e:	072020ef          	jal	51a0 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    3134:	43d010ef          	jal	4d70 <exit>
    printf("%s: chdir dd/xx succeeded!\n", s);
    3138:	85ca                	mv	a1,s2
    313a:	00004517          	auipc	a0,0x4
    313e:	95e50513          	addi	a0,a0,-1698 # 6a98 <malloc+0x1844>
    3142:	05e020ef          	jal	51a0 <printf>
    exit(1);
    3146:	4505                	li	a0,1
    3148:	429010ef          	jal	4d70 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    314c:	85ca                	mv	a1,s2
    314e:	00003517          	auipc	a0,0x3
    3152:	5da50513          	addi	a0,a0,1498 # 6728 <malloc+0x14d4>
    3156:	04a020ef          	jal	51a0 <printf>
    exit(1);
    315a:	4505                	li	a0,1
    315c:	415010ef          	jal	4d70 <exit>
    printf("%s: unlink dd/ff failed\n", s);
    3160:	85ca                	mv	a1,s2
    3162:	00004517          	auipc	a0,0x4
    3166:	95650513          	addi	a0,a0,-1706 # 6ab8 <malloc+0x1864>
    316a:	036020ef          	jal	51a0 <printf>
    exit(1);
    316e:	4505                	li	a0,1
    3170:	401010ef          	jal	4d70 <exit>
    printf("%s: unlink non-empty dd succeeded!\n", s);
    3174:	85ca                	mv	a1,s2
    3176:	00004517          	auipc	a0,0x4
    317a:	96250513          	addi	a0,a0,-1694 # 6ad8 <malloc+0x1884>
    317e:	022020ef          	jal	51a0 <printf>
    exit(1);
    3182:	4505                	li	a0,1
    3184:	3ed010ef          	jal	4d70 <exit>
    printf("%s: unlink dd/dd failed\n", s);
    3188:	85ca                	mv	a1,s2
    318a:	00004517          	auipc	a0,0x4
    318e:	97e50513          	addi	a0,a0,-1666 # 6b08 <malloc+0x18b4>
    3192:	00e020ef          	jal	51a0 <printf>
    exit(1);
    3196:	4505                	li	a0,1
    3198:	3d9010ef          	jal	4d70 <exit>
    printf("%s: unlink dd failed\n", s);
    319c:	85ca                	mv	a1,s2
    319e:	00004517          	auipc	a0,0x4
    31a2:	98a50513          	addi	a0,a0,-1654 # 6b28 <malloc+0x18d4>
    31a6:	7fb010ef          	jal	51a0 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    31ac:	3c5010ef          	jal	4d70 <exit>
...
00000000000031b0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    31c0:	98450513          	addi	a0,a0,-1660 # 6b40 <malloc+0x18ec>
    31c4:	415010ef          	jal	4dd8 <mkdir>
    31c8:	e53d                	bnez	a0,3236 <rmdot+0x86>
  if(chdir("dots") != 0){
    31ca:	00004517          	auipc	a0,0x4
    31ce:	97650513          	addi	a0,a0,-1674 # 6b40 <malloc+0x18ec>
    31d2:	40f010ef          	jal	4de0 <chdir>
    31d6:	e935                	bnez	a0,324a <rmdot+0x9a>
  if(unlink(".") == 0){
    31d8:	00003517          	auipc	a0,0x3
    31dc:	89850513          	addi	a0,a0,-1896 # 5a70 <malloc+0x81c>
    31e0:	3e1010ef          	jal	4dc0 <unlink>
    31e4:	cd2d                	beqz	a0,325e <rmdot+0xae>
  if(unlink("..") == 0){
    31e6:	00003517          	auipc	a0,0x3
    31ea:	3aa50513          	addi	a0,a0,938 # 6590 <malloc+0x133c>
    31ee:	3d3010ef          	jal	4dc0 <unlink>
    31f2:	c141                	beqz	a0,3272 <rmdot+0xc2>
  if(chdir("/") != 0){
    31f4:	00003517          	auipc	a0,0x3
    31f8:	34450513          	addi	a0,a0,836 # 6538 <malloc+0x12e4>
    31fc:	3e5010ef          	jal	4de0 <chdir>
    3200:	e159                	bnez	a0,3286 <rmdot+0xd6>
  if(unlink("dots/.") == 0){
    3202:	00004517          	auipc	a0,0x4
    3206:	9a650513          	addi	a0,a0,-1626 # 6ba8 <malloc+0x1954>
    320a:	3b7010ef          	jal	4dc0 <unlink>
    320e:	c551                	beqz	a0,329a <rmdot+0xea>
  if(unlink("dots/..") == 0){
    3210:	00004517          	auipc	a0,0x4
    3214:	9c050513          	addi	a0,a0,-1600 # 6bd0 <malloc+0x197c>
    3218:	3a9010ef          	jal	4dc0 <unlink>
    321c:	c949                	beqz	a0,32ae <rmdot+0xfe>
  if(unlink("dots") != 0){
    321e:	00004517          	auipc	a0,0x4
    3222:	92250513          	addi	a0,a0,-1758 # 6b40 <malloc+0x18ec>
    3226:	39b010ef          	jal	4dc0 <unlink>
    ...
    323c:	91050513          	addi	a0,a0,-1776 # 6b48 <malloc+0x18f4>
    3240:	761010ef          	jal	51a0 <printf>
    exit(1);
    3244:	4505                	li	a0,1
    3246:	32b010ef          	jal	4d70 <exit>
    printf("%s: chdir dots failed\n", s);
    324a:	85a6                	mv	a1,s1
    324c:	00004517          	auipc	a0,0x4
    3250:	91450513          	addi	a0,a0,-1772 # 6b60 <malloc+0x190c>
    3254:	74d010ef          	jal	51a0 <printf>
    exit(1);
    3258:	4505                	li	a0,1
    325a:	317010ef          	jal	4d70 <exit>
    printf("%s: rm . worked!\n", s);
    325e:	85a6                	mv	a1,s1
    3260:	00004517          	auipc	a0,0x4
    3264:	91850513          	addi	a0,a0,-1768 # 6b78 <malloc+0x1924>
    3268:	739010ef          	jal	51a0 <printf>
    exit(1);
    326c:	4505                	li	a0,1
    326e:	303010ef          	jal	4d70 <exit>
    printf("%s: rm .. worked!\n", s);
    3272:	85a6                	mv	a1,s1
    3274:	00004517          	auipc	a0,0x4
    3278:	91c50513          	addi	a0,a0,-1764 # 6b90 <malloc+0x193c>
    327c:	725010ef          	jal	51a0 <printf>
    exit(1);
    3280:	4505                	li	a0,1
    3282:	2ef010ef          	jal	4d70 <exit>
    printf("%s: chdir / failed\n", s);
    3286:	85a6                	mv	a1,s1
    3288:	00003517          	auipc	a0,0x3
    328c:	2b850513          	addi	a0,a0,696 # 6540 <malloc+0x12ec>
    3290:	711010ef          	jal	51a0 <printf>
    exit(1);
    3294:	4505                	li	a0,1
    3296:	2db010ef          	jal	4d70 <exit>
    printf("%s: unlink dots/. worked!\n", s);
    329a:	85a6                	mv	a1,s1
    329c:	00004517          	auipc	a0,0x4
    32a0:	91450513          	addi	a0,a0,-1772 # 6bb0 <malloc+0x195c>
    32a4:	6fd010ef          	jal	51a0 <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    32aa:	2c7010ef          	jal	4d70 <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    32ae:	85a6                	mv	a1,s1
    32b0:	00004517          	auipc	a0,0x4
    32b4:	92850513          	addi	a0,a0,-1752 # 6bd8 <malloc+0x1984>
    32b8:	6e9010ef          	jal	51a0 <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    32be:	2b3010ef          	jal	4d70 <exit>
    printf("%s: unlink dots failed!\n", s);
    32c2:	85a6                	mv	a1,s1
    32c4:	00004517          	auipc	a0,0x4
    32c8:	93450513          	addi	a0,a0,-1740 # 6bf8 <malloc+0x19a4>
    32cc:	6d5010ef          	jal	51a0 <printf>
    exit(1);
    32d0:	4505                	li	a0,1
    32d2:	29f010ef          	jal	4d70 <exit>
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	93050513          	addi	a0,a0,-1744 # 6c18 <malloc+0x19c4>
    32f0:	2c1010ef          	jal	4db0 <open>
  if(fd < 0){
    32f4:	0c054563          	bltz	a0,33be <dirfile+0xe8>
  close(fd);
    32f8:	2a1010ef          	jal	4d98 <close>
  if(chdir("dirfile") == 0){
    32fc:	00004517          	auipc	a0,0x4
    3300:	91c50513          	addi	a0,a0,-1764 # 6c18 <malloc+0x19c4>
    3304:	2dd010ef          	jal	4de0 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	95450513          	addi	a0,a0,-1708 # 6c60 <malloc+0x1a0c>
    3314:	29d010ef          	jal	4db0 <open>
  if(fd >= 0){
    3318:	0c055763          	bgez	a0,33e6 <dirfile+0x110>
  fd = open("dirfile/xx", O_CREATE);
    331c:	20000593          	li	a1,512
    3320:	00004517          	auipc	a0,0x4
    3324:	94050513          	addi	a0,a0,-1728 # 6c60 <malloc+0x1a0c>
    3328:	289010ef          	jal	4db0 <open>
  if(fd >= 0){
    332c:	0c055763          	bgez	a0,33fa <dirfile+0x124>
  if(mkdir("dirfile/xx") == 0){
    3330:	00004517          	auipc	a0,0x4
    3334:	93050513          	addi	a0,a0,-1744 # 6c60 <malloc+0x1a0c>
    3338:	2a1010ef          	jal	4dd8 <mkdir>
    333c:	0c050963          	beqz	a0,340e <dirfile+0x138>
  if(unlink("dirfile/xx") == 0){
    3340:	00004517          	auipc	a0,0x4
    3344:	92050513          	addi	a0,a0,-1760 # 6c60 <malloc+0x1a0c>
    3348:	279010ef          	jal	4dc0 <unlink>
    334c:	0c050b63          	beqz	a0,3422 <dirfile+0x14c>
  if(link("README", "dirfile/xx") == 0){
    3350:	00004597          	auipc	a1,0x4
    3354:	91058593          	addi	a1,a1,-1776 # 6c60 <malloc+0x1a0c>
    3358:	00002517          	auipc	a0,0x2
    335c:	20850513          	addi	a0,a0,520 # 5560 <malloc+0x30c>
    3360:	271010ef          	jal	4dd0 <link>
    3364:	0c050963          	beqz	a0,3436 <dirfile+0x160>
  if(unlink("dirfile") != 0){
    3368:	00004517          	auipc	a0,0x4
    336c:	8b050513          	addi	a0,a0,-1872 # 6c18 <malloc+0x19c4>
    3370:	251010ef          	jal	4dc0 <unlink>
    3374:	0c051b63          	bnez	a0,344a <dirfile+0x174>
  fd = open(".", O_RDWR);
    3378:	4589                	li	a1,2
    337a:	00002517          	auipc	a0,0x2
    337e:	6f650513          	addi	a0,a0,1782 # 5a70 <malloc+0x81c>
    3382:	22f010ef          	jal	4db0 <open>
  if(fd >= 0){
    3386:	0c055c63          	bgez	a0,345e <dirfile+0x188>
  fd = open(".", 0);
    338a:	4581                	li	a1,0
    338c:	00002517          	auipc	a0,0x2
    3390:	6e450513          	addi	a0,a0,1764 # 5a70 <malloc+0x81c>
    3394:	21d010ef          	jal	4db0 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	05c58593          	addi	a1,a1,92 # 53f8 <malloc+0x1a4>
    33a4:	1ed010ef          	jal	4d90 <write>
    33a8:	0ca04563          	bgtz	a0,3472 <dirfile+0x19c>
  close(fd);
    33ac:	8526                	mv	a0,s1
    33ae:	1eb010ef          	jal	4d98 <close>
}
    ...
    33c4:	86050513          	addi	a0,a0,-1952 # 6c20 <malloc+0x19cc>
    33c8:	5d9010ef          	jal	51a0 <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    33ce:	1a3010ef          	jal	4d70 <exit>
    printf("%s: chdir dirfile succeeded!\n", s);
    33d2:	85ca                	mv	a1,s2
    33d4:	00004517          	auipc	a0,0x4
    33d8:	86c50513          	addi	a0,a0,-1940 # 6c40 <malloc+0x19ec>
    33dc:	5c5010ef          	jal	51a0 <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    33e2:	18f010ef          	jal	4d70 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    33e6:	85ca                	mv	a1,s2
    33e8:	00004517          	auipc	a0,0x4
    33ec:	88850513          	addi	a0,a0,-1912 # 6c70 <malloc+0x1a1c>
    33f0:	5b1010ef          	jal	51a0 <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    33f6:	17b010ef          	jal	4d70 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    33fa:	85ca                	mv	a1,s2
    33fc:	00004517          	auipc	a0,0x4
    3400:	87450513          	addi	a0,a0,-1932 # 6c70 <malloc+0x1a1c>
    3404:	59d010ef          	jal	51a0 <printf>
    exit(1);
    3408:	4505                	li	a0,1
    340a:	167010ef          	jal	4d70 <exit>
    printf("%s: mkdir dirfile/xx succeeded!\n", s);
    340e:	85ca                	mv	a1,s2
    3410:	00004517          	auipc	a0,0x4
    3414:	88850513          	addi	a0,a0,-1912 # 6c98 <malloc+0x1a44>
    3418:	589010ef          	jal	51a0 <printf>
    exit(1);
    341c:	4505                	li	a0,1
    341e:	153010ef          	jal	4d70 <exit>
    printf("%s: unlink dirfile/xx succeeded!\n", s);
    3422:	85ca                	mv	a1,s2
    3424:	00004517          	auipc	a0,0x4
    3428:	89c50513          	addi	a0,a0,-1892 # 6cc0 <malloc+0x1a6c>
    342c:	575010ef          	jal	51a0 <printf>
    exit(1);
    3430:	4505                	li	a0,1
    3432:	13f010ef          	jal	4d70 <exit>
    printf("%s: link to dirfile/xx succeeded!\n", s);
    3436:	85ca                	mv	a1,s2
    3438:	00004517          	auipc	a0,0x4
    343c:	8b050513          	addi	a0,a0,-1872 # 6ce8 <malloc+0x1a94>
    3440:	561010ef          	jal	51a0 <printf>
    exit(1);
    3444:	4505                	li	a0,1
    3446:	12b010ef          	jal	4d70 <exit>
    printf("%s: unlink dirfile failed!\n", s);
    344a:	85ca                	mv	a1,s2
    344c:	00004517          	auipc	a0,0x4
    3450:	8c450513          	addi	a0,a0,-1852 # 6d10 <malloc+0x1abc>
    3454:	54d010ef          	jal	51a0 <printf>
    exit(1);
    3458:	4505                	li	a0,1
    345a:	117010ef          	jal	4d70 <exit>
    printf("%s: open . for writing succeeded!\n", s);
    345e:	85ca                	mv	a1,s2
    3460:	00004517          	auipc	a0,0x4
    3464:	8d050513          	addi	a0,a0,-1840 # 6d30 <malloc+0x1adc>
    3468:	539010ef          	jal	51a0 <printf>
    exit(1);
    346c:	4505                	li	a0,1
    346e:	103010ef          	jal	4d70 <exit>
    printf("%s: write . succeeded!\n", s);
    3472:	85ca                	mv	a1,s2
    3474:	00004517          	auipc	a0,0x4
    3478:	8e450513          	addi	a0,a0,-1820 # 6d58 <malloc+0x1b04>
    347c:	525010ef          	jal	51a0 <printf>
    exit(1);
    3480:	4505                	li	a0,1
    3482:	0ef010ef          	jal	4d70 <exit>
...
0000000000003486 <iref>:
{
    ...
    34a4:	8d0a0a13          	addi	s4,s4,-1840 # 6d70 <malloc+0x1b1c>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	3d048493          	addi	s1,s1,976 # 6878 <malloc+0x1624>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	0b0a8a93          	addi	s5,s5,176 # 5560 <malloc+0x30c>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	7b098993          	addi	s3,s3,1968 # 6c68 <malloc+0x1a14>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	8b450513          	addi	a0,a0,-1868 # 6d78 <malloc+0x1b24>
    34cc:	4d5010ef          	jal	51a0 <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    34d2:	09f010ef          	jal	4d70 <exit>
      printf("%s: chdir irefd failed\n", s);
    34d6:	85da                	mv	a1,s6
    34d8:	00004517          	auipc	a0,0x4
    34dc:	8b850513          	addi	a0,a0,-1864 # 6d90 <malloc+0x1b3c>
    34e0:	4c1010ef          	jal	51a0 <printf>
      exit(1);
    34e4:	4505                	li	a0,1
    34e6:	08b010ef          	jal	4d70 <exit>
      close(fd);
    34ea:	0af010ef          	jal	4d98 <close>
    34ee:	a82d                	j	3528 <iref+0xa2>
    unlink("xx");
    34f0:	854e                	mv	a0,s3
    34f2:	0cf010ef          	jal	4dc0 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    34f6:	397d                	addiw	s2,s2,-1
    34f8:	04090263          	beqz	s2,353c <iref+0xb6>
    if(mkdir("irefd") != 0){
    34fc:	8552                	mv	a0,s4
    34fe:	0db010ef          	jal	4dd8 <mkdir>
    3502:	f161                	bnez	a0,34c2 <iref+0x3c>
    if(chdir("irefd") != 0){
    3504:	8552                	mv	a0,s4
    3506:	0db010ef          	jal	4de0 <chdir>
    350a:	f571                	bnez	a0,34d6 <iref+0x50>
    mkdir("");
    350c:	8526                	mv	a0,s1
    350e:	0cb010ef          	jal	4dd8 <mkdir>
    link("README", "");
    3512:	85a6                	mv	a1,s1
    3514:	8556                	mv	a0,s5
    3516:	0bb010ef          	jal	4dd0 <link>
    fd = open("", O_CREATE);
    351a:	20000593          	li	a1,512
    351e:	8526                	mv	a0,s1
    3520:	091010ef          	jal	4db0 <open>
    if(fd >= 0)
    3524:	fc0553e3          	bgez	a0,34ea <iref+0x64>
    fd = open("xx", O_CREATE);
    3528:	20000593          	li	a1,512
    352c:	854e                	mv	a0,s3
    352e:	083010ef          	jal	4db0 <open>
    if(fd >= 0)
    3532:	fa054fe3          	bltz	a0,34f0 <iref+0x6a>
      close(fd);
    3536:	063010ef          	jal	4d98 <close>
    353a:	bf5d                	j	34f0 <iref+0x6a>
    353c:	03300493          	li	s1,51
    chdir("..");
    3540:	00003997          	auipc	s3,0x3
    3544:	05098993          	addi	s3,s3,80 # 6590 <malloc+0x133c>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	82890913          	addi	s2,s2,-2008 # 6d70 <malloc+0x1b1c>
    chdir("..");
    3550:	854e                	mv	a0,s3
    3552:	08f010ef          	jal	4de0 <chdir>
    unlink("irefd");
    3556:	854a                	mv	a0,s2
    3558:	069010ef          	jal	4dc0 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    355c:	34fd                	addiw	s1,s1,-1
    355e:	f8ed                	bnez	s1,3550 <iref+0xca>
  chdir("/");
    3560:	00003517          	auipc	a0,0x3
    3564:	fd850513          	addi	a0,a0,-40 # 6538 <malloc+0x12e4>
    3568:	079010ef          	jal	4de0 <chdir>
}
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	81c50513          	addi	a0,a0,-2020 # 6da8 <malloc+0x1b54>
    3594:	045010ef          	jal	4dd8 <mkdir>
    3598:	02054a63          	bltz	a0,35cc <openiputtest+0x4c>
  pid = fork();
    359c:	7cc010ef          	jal	4d68 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    35ac:	80050513          	addi	a0,a0,-2048 # 6da8 <malloc+0x1b54>
    35b0:	001010ef          	jal	4db0 <open>
    if(fd >= 0){
    35b4:	04054063          	bltz	a0,35f4 <openiputtest+0x74>
      printf("%s: open directory for write succeeded\n", s);
    35b8:	85a6                	mv	a1,s1
    35ba:	00004517          	auipc	a0,0x4
    35be:	80e50513          	addi	a0,a0,-2034 # 6dc8 <malloc+0x1b74>
    35c2:	3df010ef          	jal	51a0 <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    35c8:	7a8010ef          	jal	4d70 <exit>
    printf("%s: mkdir oidir failed\n", s);
    35cc:	85a6                	mv	a1,s1
    35ce:	00003517          	auipc	a0,0x3
    35d2:	7e250513          	addi	a0,a0,2018 # 6db0 <malloc+0x1b5c>
    35d6:	3cb010ef          	jal	51a0 <printf>
    exit(1);
    35da:	4505                	li	a0,1
    35dc:	794010ef          	jal	4d70 <exit>
    printf("%s: fork failed\n", s);
    35e0:	85a6                	mv	a1,s1
    35e2:	00002517          	auipc	a0,0x2
    35e6:	63650513          	addi	a0,a0,1590 # 5c18 <malloc+0x9c4>
    35ea:	3b7010ef          	jal	51a0 <printf>
    exit(1);
    35ee:	4505                	li	a0,1
    35f0:	780010ef          	jal	4d70 <exit>
    exit(0);
    35f4:	4501                	li	a0,0
    35f6:	77a010ef          	jal	4d70 <exit>
  pause(1);
    35fa:	4505                	li	a0,1
    35fc:	005010ef          	jal	4e00 <pause>
  if(unlink("oidir") != 0){
    3600:	00003517          	auipc	a0,0x3
    3604:	7a850513          	addi	a0,a0,1960 # 6da8 <malloc+0x1b54>
    3608:	7b8010ef          	jal	4dc0 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00002517          	auipc	a0,0x2
    3614:	7f850513          	addi	a0,a0,2040 # 5e08 <malloc+0xbb4>
    3618:	389010ef          	jal	51a0 <printf>
    exit(1);
    361c:	4505                	li	a0,1
    361e:	752010ef          	jal	4d70 <exit>
  wait(&xstatus);
    3622:	fdc40513          	addi	a0,s0,-36
    3626:	752010ef          	jal	4d78 <wait>
  exit(xstatus);
    362a:	fdc42503          	lw	a0,-36(s0)
    362e:	742010ef          	jal	4d70 <exit>
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	7b250513          	addi	a0,a0,1970 # 6df0 <malloc+0x1b9c>
    3646:	77a010ef          	jal	4dc0 <unlink>
  int pid = fork();
    364a:	71e010ef          	jal	4d68 <fork>
  if(pid < 0){
  ...
  pause(20); // two seconds
    3654:	4551                	li	a0,20
    3656:	7aa010ef          	jal	4e00 <pause>
  close(open("stopforking", O_CREATE|O_RDWR));
    365a:	20200593          	li	a1,514
    365e:	00003517          	auipc	a0,0x3
    3662:	79250513          	addi	a0,a0,1938 # 6df0 <malloc+0x1b9c>
    3666:	74a010ef          	jal	4db0 <open>
    366a:	72e010ef          	jal	4d98 <close>
  wait(0);
    366e:	4501                	li	a0,0
    3670:	708010ef          	jal	4d78 <wait>
  pause(10); // one second
    3674:	4529                	li	a0,10
    3676:	78a010ef          	jal	4e00 <pause>
}
    ...
    368a:	75250513          	addi	a0,a0,1874 # 5dd8 <malloc+0xb84>
    368e:	313010ef          	jal	51a0 <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	6dc010ef          	jal	4d70 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	75848493          	addi	s1,s1,1880 # 6df0 <malloc+0x1b9c>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    36a4:	70c010ef          	jal	4db0 <open>
      if(fd >= 0){
    36a8:	02055163          	bgez	a0,36ca <forkforkfork+0x98>
      if(fork() < 0){
    36ac:	6bc010ef          	jal	4d68 <fork>
    36b0:	fe0558e3          	bgez	a0,36a0 <forkforkfork+0x6e>
        close(open("stopforking", O_CREATE|O_RDWR));
    36b4:	20200593          	li	a1,514
    36b8:	00003517          	auipc	a0,0x3
    36bc:	73850513          	addi	a0,a0,1848 # 6df0 <malloc+0x1b9c>
    36c0:	6f0010ef          	jal	4db0 <open>
    36c4:	6d4010ef          	jal	4d98 <close>
    36c8:	bfe1                	j	36a0 <forkforkfork+0x6e>
        exit(0);
    36ca:	4501                	li	a0,0
    36cc:	6a4010ef          	jal	4d70 <exit>
...
00000000000036d0 <killstatus>:
{
    ...
    pause(1);
    36f4:	4505                	li	a0,1
    36f6:	70a010ef          	jal	4e00 <pause>
    kill(pid1);
    36fa:	8526                	mv	a0,s1
    36fc:	6a4010ef          	jal	4da0 <kill>
    wait(&xst);
    3700:	fcc40513          	addi	a0,s0,-52
    3704:	674010ef          	jal	4d78 <wait>
    if(xst != -1) {
  ...
  exit(0);
    3716:	4501                	li	a0,0
    3718:	658010ef          	jal	4d70 <exit>
      printf("%s: fork failed\n", s);
    371c:	85d2                	mv	a1,s4
    371e:	00002517          	auipc	a0,0x2
    3722:	4fa50513          	addi	a0,a0,1274 # 5c18 <malloc+0x9c4>
    3726:	27b010ef          	jal	51a0 <printf>
      exit(1);
    372a:	4505                	li	a0,1
    372c:	644010ef          	jal	4d70 <exit>
        getpid();
    3730:	6c0010ef          	jal	4df0 <getpid>
      while(1) {
    3734:	bff5                	j	3730 <killstatus+0x60>
       printf("%s: status should be -1\n", s);
    3736:	85d2                	mv	a1,s4
    3738:	00003517          	auipc	a0,0x3
    373c:	6c850513          	addi	a0,a0,1736 # 6e00 <malloc+0x1bac>
    3740:	261010ef          	jal	51a0 <printf>
       exit(1);
    3744:	4505                	li	a0,1
    3746:	62a010ef          	jal	4d70 <exit>
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	66c50513          	addi	a0,a0,1644 # 5dd8 <malloc+0xb84>
    3774:	22d010ef          	jal	51a0 <printf>
    exit(1);
    3778:	4505                	li	a0,1
    377a:	5f6010ef          	jal	4d70 <exit>
  pid2 = fork();
    377e:	5ea010ef          	jal	4d68 <fork>
    3782:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    3792:	48a50513          	addi	a0,a0,1162 # 5c18 <malloc+0x9c4>
    3796:	20b010ef          	jal	51a0 <printf>
    exit(1);
    379a:	4505                	li	a0,1
    379c:	5d4010ef          	jal	4d70 <exit>
  pipe(pfds);
    37a0:	fc840513          	addi	a0,s0,-56
    37a4:	5dc010ef          	jal	4d80 <pipe>
  pid3 = fork();
    37a8:	5c0010ef          	jal	4d68 <fork>
    37ac:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  close(pfds[0]);
    ...
    3844:	554010ef          	jal	4d98 <close>
  printf("kill... ");
    3848:	00003517          	auipc	a0,0x3
    384c:	60850513          	addi	a0,a0,1544 # 6e50 <malloc+0x1bfc>
    3850:	151010ef          	jal	51a0 <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
    3856:	54a010ef          	jal	4da0 <kill>
  kill(pid2);
    385a:	854e                	mv	a0,s3
    385c:	544010ef          	jal	4da0 <kill>
  kill(pid3);
    3860:	8552                	mv	a0,s4
    3862:	53e010ef          	jal	4da0 <kill>
  printf("wait... ");
    3866:	00003517          	auipc	a0,0x3
    386a:	5fa50513          	addi	a0,a0,1530 # 6e60 <malloc+0x1c0c>
    386e:	133010ef          	jal	51a0 <printf>
  wait(0);
    3872:	4501                	li	a0,0
    3874:	504010ef          	jal	4d78 <wait>
  wait(0);
    3878:	4501                	li	a0,0
    387a:	4fe010ef          	jal	4d78 <wait>
  wait(0);
    387e:	4501                	li	a0,0
    3880:	4f8010ef          	jal	4d78 <wait>
...
0000000000003886 <reparent>:
{
  ...
  int master_pid = getpid();
    3898:	558010ef          	jal	4df0 <getpid>
    389c:	8a2a                	mv	s4,a0
    389e:	0c800913          	li	s2,200
    int pid = fork();
    38a2:	4c6010ef          	jal	4d68 <fork>
    38a6:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  exit(0);
    38be:	4501                	li	a0,0
    38c0:	4b0010ef          	jal	4d70 <exit>
      printf("%s: fork failed\n", s);
    38c4:	85ce                	mv	a1,s3
    38c6:	00002517          	auipc	a0,0x2
    38ca:	35250513          	addi	a0,a0,850 # 5c18 <malloc+0x9c4>
    38ce:	0d3010ef          	jal	51a0 <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    38d4:	49c010ef          	jal	4d70 <exit>
        printf("%s: wait wrong pid\n", s);
    38d8:	85ce                	mv	a1,s3
    38da:	00002517          	auipc	a0,0x2
    38de:	4c650513          	addi	a0,a0,1222 # 5da0 <malloc+0xb4c>
    38e2:	0bf010ef          	jal	51a0 <printf>
        exit(1);
    38e6:	4505                	li	a0,1
    38e8:	488010ef          	jal	4d70 <exit>
      int pid2 = fork();
    38ec:	47c010ef          	jal	4d68 <fork>
      if(pid2 < 0){
    38f0:	00054563          	bltz	a0,38fa <reparent+0x74>
      exit(0);
    38f4:	4501                	li	a0,0
    38f6:	47a010ef          	jal	4d70 <exit>
        kill(master_pid);
    38fa:	8552                	mv	a0,s4
    38fc:	4a4010ef          	jal	4da0 <kill>
        exit(1);
    3900:	4505                	li	a0,1
    3902:	46e010ef          	jal	4d70 <exit>
...
0000000000003906 <sbrkfail>:
{
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	4a250513          	addi	a0,a0,1186 # 6e78 <malloc+0x1c24>
    39de:	7c2010ef          	jal	51a0 <printf>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    kill(pids[i]);
    39f0:	3b0010ef          	jal	4da0 <kill>
    wait(0);
    39f4:	4501                	li	a0,0
    39f6:	382010ef          	jal	4d78 <wait>
    39fa:	b7ed                	j	39e4 <sbrkfail+0xde>
  if(c == (char*)SBRK_ERROR){
    39fc:	57fd                	li	a5,-1
    39fe:	02fa0a63          	beq	s4,a5,3a32 <sbrkfail+0x12c>
  pid = fork();
    3a02:	366010ef          	jal	4d68 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3a24:	4a850513          	addi	a0,a0,1192 # 6ec8 <malloc+0x1c74>
    3a28:	778010ef          	jal	51a0 <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    3a2e:	342010ef          	jal	4d70 <exit>
    printf("%s: failed sbrk leaked memory\n", s);
    3a32:	85da                	mv	a1,s6
    3a34:	00003517          	auipc	a0,0x3
    3a38:	47450513          	addi	a0,a0,1140 # 6ea8 <malloc+0x1c54>
    3a3c:	764010ef          	jal	51a0 <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    3a42:	32e010ef          	jal	4d70 <exit>
    printf("%s: fork failed\n", s);
    3a46:	85da                	mv	a1,s6
    3a48:	00002517          	auipc	a0,0x2
    3a4c:	1d050513          	addi	a0,a0,464 # 5c18 <malloc+0x9c4>
    3a50:	750010ef          	jal	51a0 <printf>
    exit(1);
    3a54:	4505                	li	a0,1
    3a56:	31a010ef          	jal	4d70 <exit>
      exit(0);
    3a5a:	4501                	li	a0,0
    3a5c:	314010ef          	jal	4d70 <exit>
  wait(&xstatus);
    3a60:	fac40513          	addi	a0,s0,-84
    3a64:	314010ef          	jal	4d78 <wait>
  if(xstatus != 0)
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	702010ef          	jal	51d2 <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	77c010ef          	jal	5254 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	6f4010ef          	jal	51d2 <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    3ae4:	28c010ef          	jal	4d70 <exit>
      printf("%s: couldn't allocate mem?!!\n", s);
    3ae8:	85ce                	mv	a1,s3
    3aea:	00003517          	auipc	a0,0x3
    3aee:	40e50513          	addi	a0,a0,1038 # 6ef8 <malloc+0x1ca4>
    3af2:	6ae010ef          	jal	51a0 <printf>
      exit(1);
    3af6:	4505                	li	a0,1
    3af8:	278010ef          	jal	4d70 <exit>
      exit(0);
    3afc:	4501                	li	a0,0
    3afe:	272010ef          	jal	4d70 <exit>
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	40a50513          	addi	a0,a0,1034 # 6f18 <malloc+0x1cc4>
    3b16:	2aa010ef          	jal	4dc0 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	3fa50513          	addi	a0,a0,1018 # 6f18 <malloc+0x1cc4>
    3b26:	28a010ef          	jal	4db0 <open>
  if(fd < 0){
  ...
  if(pid == 0) {
    ...
    3b8c:	3a050513          	addi	a0,a0,928 # 6f28 <malloc+0x1cd4>
    3b90:	610010ef          	jal	51a0 <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    3b96:	1da010ef          	jal	4d70 <exit>
      printf("%s: write sharedfd failed\n", s);
    3b9a:	85d2                	mv	a1,s4
    3b9c:	00003517          	auipc	a0,0x3
    3ba0:	3b450513          	addi	a0,a0,948 # 6f50 <malloc+0x1cfc>
    3ba4:	5fc010ef          	jal	51a0 <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
    3baa:	1c6010ef          	jal	4d70 <exit>
    wait(&xstatus);
    3bae:	f9c40513          	addi	a0,s0,-100
    3bb2:	1c6010ef          	jal	4d78 <wait>
    if(xstatus != 0)
    3bb6:	f9c42983          	lw	s3,-100(s0)
    3bba:	00098563          	beqz	s3,3bc4 <sharedfd+0xc2>
      exit(xstatus);
    3bbe:	854e                	mv	a0,s3
    3bc0:	1b0010ef          	jal	4d70 <exit>
  close(fd);
    3bc4:	854a                	mv	a0,s2
    3bc6:	1d2010ef          	jal	4d98 <close>
  fd = open("sharedfd", 0);
    3bca:	4581                	li	a1,0
    3bcc:	00003517          	auipc	a0,0x3
    3bd0:	34c50513          	addi	a0,a0,844 # 6f18 <malloc+0x1cc4>
    3bd4:	1dc010ef          	jal	4db0 <open>
    3bd8:	8baa                	mv	s7,a0
  nc = np = 0;
    3bda:	8ace                	mv	s5,s3
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	36c50513          	addi	a0,a0,876 # 6f70 <malloc+0x1d1c>
    3c0c:	594010ef          	jal	51a0 <printf>
    exit(1);
    3c10:	4505                	li	a0,1
    3c12:	15e010ef          	jal	4d70 <exit>
        nc++;
  ...
  close(fd);
    3c2e:	855e                	mv	a0,s7
    3c30:	168010ef          	jal	4d98 <close>
  unlink("sharedfd");
    3c34:	00003517          	auipc	a0,0x3
    3c38:	2e450513          	addi	a0,a0,740 # 6f18 <malloc+0x1cc4>
    3c3c:	184010ef          	jal	4dc0 <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	34250513          	addi	a0,a0,834 # 6f98 <malloc+0x1d44>
    3c5e:	542010ef          	jal	51a0 <printf>
    exit(1);
    3c62:	4505                	li	a0,1
    3c64:	10c010ef          	jal	4d70 <exit>
    exit(0);
    3c68:	4501                	li	a0,0
    3c6a:	106010ef          	jal	4d70 <exit>
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	32278793          	addi	a5,a5,802 # 6fb0 <malloc+0x1d5c>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	31e78793          	addi	a5,a5,798 # 6fb8 <malloc+0x1d64>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	31a78793          	addi	a5,a5,794 # 6fc0 <malloc+0x1d6c>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	31678793          	addi	a5,a5,790 # 6fc8 <malloc+0x1d74>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    unlink(fname);
    3ccc:	854e                	mv	a0,s3
    3cce:	0f2010ef          	jal	4dc0 <unlink>
    pid = fork();
    3cd2:	096010ef          	jal	4d68 <fork>
    if(pid < 0){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f0450513          	addi	a0,a0,-252 # 5c18 <malloc+0x9c4>
    3d1c:	484010ef          	jal	51a0 <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    3d22:	04e010ef          	jal	4d70 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    3d26:	20200593          	li	a1,514
    3d2a:	854e                	mv	a0,s3
    3d2c:	084010ef          	jal	4db0 <open>
    3d30:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    3d6c:	f4e5                	bnez	s1,3d54 <fourfiles+0xe6>
      exit(0);
    3d6e:	4501                	li	a0,0
    3d70:	000010ef          	jal	4d70 <exit>
        printf("%s: create failed\n", s);
    3d74:	85e6                	mv	a1,s9
    3d76:	00002517          	auipc	a0,0x2
    3d7a:	f3a50513          	addi	a0,a0,-198 # 5cb0 <malloc+0xa5c>
    3d7e:	422010ef          	jal	51a0 <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	7ed000ef          	jal	4d70 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	24850513          	addi	a0,a0,584 # 6fd0 <malloc+0x1d7c>
    3d90:	410010ef          	jal	51a0 <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    3d96:	7db000ef          	jal	4d70 <exit>
      exit(xstatus);
    3d9a:	8556                	mv	a0,s5
    3d9c:	7d5000ef          	jal	4d70 <exit>
          printf("%s: wrong char\n", s);
    3da0:	85e6                	mv	a1,s9
    3da2:	00003517          	auipc	a0,0x3
    3da6:	24650513          	addi	a0,a0,582 # 6fe8 <malloc+0x1d94>
    3daa:	3f6010ef          	jal	51a0 <printf>
          exit(1);
    3dae:	4505                	li	a0,1
    3db0:	7c1000ef          	jal	4d70 <exit>
      total += n;
    ...
    close(fd);
    3de2:	854e                	mv	a0,s3
    3de4:	7b5000ef          	jal	4d98 <close>
    if(total != N*SZ){
    3de8:	03a91463          	bne	s2,s10,3e10 <fourfiles+0x1a2>
    unlink(fname);
    3dec:	8562                	mv	a0,s8
    3dee:	7d3000ef          	jal	4dc0 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	1e650513          	addi	a0,a0,486 # 6ff8 <malloc+0x1da4>
    3e1a:	386010ef          	jal	51a0 <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
    3e20:	751000ef          	jal	4d70 <exit>
}
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	1a4b8b93          	addi	s7,s7,420 # 7010 <malloc+0x1dbc>
  for(i = 0; i < N; i++){
    ...
    3e9a:	717000ef          	jal	4db0 <open>
      if(fd < 0){
    3e9e:	1e055063          	bgez	a0,407e <concreate+0x23c>
        printf("concreate create %s failed\n", file);
    3ea2:	fa840593          	addi	a1,s0,-88
    3ea6:	00003517          	auipc	a0,0x3
    3eaa:	17250513          	addi	a0,a0,370 # 7018 <malloc+0x1dc4>
    3eae:	2f2010ef          	jal	51a0 <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    3eb4:	6bd000ef          	jal	4d70 <exit>
      link("C0", file);
    3eb8:	fa840593          	addi	a1,s0,-88
    3ebc:	00003517          	auipc	a0,0x3
    3ec0:	15450513          	addi	a0,a0,340 # 7010 <malloc+0x1dbc>
    3ec4:	70d000ef          	jal	4dd0 <link>
      exit(0);
    3ec8:	4501                	li	a0,0
    3eca:	6a7000ef          	jal	4d70 <exit>
        exit(1);
    3ece:	4505                	li	a0,1
    3ed0:	6a1000ef          	jal	4d70 <exit>
  memset(fa, 0, sizeof(fa));
    3ed4:	02800613          	li	a2,40
    3ed8:	4581                	li	a1,0
    3eda:	f8040513          	addi	a0,s0,-128
    3ede:	481000ef          	jal	4b5e <memset>
  fd = open(".", 0);
    3ee2:	4581                	li	a1,0
    3ee4:	00002517          	auipc	a0,0x2
    3ee8:	b8c50513          	addi	a0,a0,-1140 # 5a70 <malloc+0x81c>
    3eec:	6c5000ef          	jal	4db0 <open>
    3ef0:	892a                	mv	s2,a0
  n = 0;
    3ef2:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	0e450513          	addi	a0,a0,228 # 7038 <malloc+0x1de4>
    3f5c:	244010ef          	jal	51a0 <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    3f62:	60f000ef          	jal	4d70 <exit>
        printf("%s: concreate duplicate file %s\n", s, de.name);
    3f66:	f7240613          	addi	a2,s0,-142
    3f6a:	85ce                	mv	a1,s3
    3f6c:	00003517          	auipc	a0,0x3
    3f70:	0ec50513          	addi	a0,a0,236 # 7058 <malloc+0x1e04>
    3f74:	22c010ef          	jal	51a0 <printf>
        exit(1);
    3f78:	4505                	li	a0,1
    3f7a:	5f7000ef          	jal	4d70 <exit>
  close(fd);
    3f7e:	854a                	mv	a0,s2
    3f80:	619000ef          	jal	4d98 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	0e850513          	addi	a0,a0,232 # 7080 <malloc+0x1e2c>
    3fa0:	200010ef          	jal	51a0 <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    3fa6:	5cb000ef          	jal	4d70 <exit>
      printf("%s: fork failed\n", s);
    3faa:	85ce                	mv	a1,s3
    3fac:	00002517          	auipc	a0,0x2
    3fb0:	c6c50513          	addi	a0,a0,-916 # 5c18 <malloc+0x9c4>
    3fb4:	1ec010ef          	jal	51a0 <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
    3fba:	5b7000ef          	jal	4d70 <exit>
      close(open(file, 0));
    3fbe:	4581                	li	a1,0
    3fc0:	fa840513          	addi	a0,s0,-88
    3fc4:	5ed000ef          	jal	4db0 <open>
    3fc8:	5d1000ef          	jal	4d98 <close>
      close(open(file, 0));
    3fcc:	4581                	li	a1,0
    3fce:	fa840513          	addi	a0,s0,-88
    3fd2:	5df000ef          	jal	4db0 <open>
    3fd6:	5c3000ef          	jal	4d98 <close>
      close(open(file, 0));
    3fda:	4581                	li	a1,0
    3fdc:	fa840513          	addi	a0,s0,-88
    3fe0:	5d1000ef          	jal	4db0 <open>
    3fe4:	5b5000ef          	jal	4d98 <close>
      close(open(file, 0));
    3fe8:	4581                	li	a1,0
    3fea:	fa840513          	addi	a0,s0,-88
    3fee:	5c3000ef          	jal	4db0 <open>
    3ff2:	5a7000ef          	jal	4d98 <close>
      close(open(file, 0));
    3ff6:	4581                	li	a1,0
    3ff8:	fa840513          	addi	a0,s0,-88
    3ffc:	5b5000ef          	jal	4db0 <open>
    4000:	599000ef          	jal	4d98 <close>
      close(open(file, 0));
    4004:	4581                	li	a1,0
    4006:	fa840513          	addi	a0,s0,-88
    400a:	5a7000ef          	jal	4db0 <open>
    400e:	58b000ef          	jal	4d98 <close>
    if(pid == 0)
    4012:	06090363          	beqz	s2,4078 <concreate+0x236>
      wait(0);
    4016:	4501                	li	a0,0
    4018:	561000ef          	jal	4d78 <wait>
  for(i = 0; i < N; i++){
    ...
    404a:	577000ef          	jal	4dc0 <unlink>
      unlink(file);
    404e:	fa840513          	addi	a0,s0,-88
    4052:	56f000ef          	jal	4dc0 <unlink>
      unlink(file);
    4056:	fa840513          	addi	a0,s0,-88
    405a:	567000ef          	jal	4dc0 <unlink>
      unlink(file);
    405e:	fa840513          	addi	a0,s0,-88
    4062:	55f000ef          	jal	4dc0 <unlink>
      unlink(file);
    4066:	fa840513          	addi	a0,s0,-88
    406a:	557000ef          	jal	4dc0 <unlink>
      unlink(file);
    406e:	fa840513          	addi	a0,s0,-88
    4072:	54f000ef          	jal	4dc0 <unlink>
    4076:	bf71                	j	4012 <concreate+0x1d0>
      exit(0);
    4078:	4501                	li	a0,0
    407a:	4f7000ef          	jal	4d70 <exit>
      close(fd);
    407e:	51b000ef          	jal	4d98 <close>
    if(pid == 0) {
    4082:	b599                	j	3ec8 <concreate+0x86>
      close(fd);
    4084:	515000ef          	jal	4d98 <close>
      wait(&xstatus);
    4088:	f6c40513          	addi	a0,s0,-148
    408c:	4ed000ef          	jal	4d78 <wait>
      if(xstatus != 0)
  ...
  for(i = 0; i < N; i++){
    ...
    40aa:	517000ef          	jal	4dc0 <unlink>
    pid = fork();
    40ae:	4bb000ef          	jal	4d68 <fork>
    if(pid && (i % 3) == 1){
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	fbe50513          	addi	a0,a0,-66 # 70b8 <malloc+0x1e64>
    4102:	4bf000ef          	jal	4dc0 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	fae50513          	addi	a0,a0,-82 # 70b8 <malloc+0x1e64>
    4112:	49f000ef          	jal	4db0 <open>
    4116:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4118:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    412c:	85a6                	mv	a1,s1
    412e:	854a                	mv	a0,s2
    4130:	22f000ef          	jal	4b5e <memset>
    if(write(fd, buf, SZ) != SZ){
    4134:	25800613          	li	a2,600
    4138:	85ca                	mv	a1,s2
    413a:	854e                	mv	a0,s3
    413c:	455000ef          	jal	4d90 <write>
  ...
  close(fd);
    414e:	854e                	mv	a0,s3
    4150:	449000ef          	jal	4d98 <close>
  fd = open("bigfile.dat", 0);
    4154:	4581                	li	a1,0
    4156:	00003517          	auipc	a0,0x3
    415a:	f6250513          	addi	a0,a0,-158 # 70b8 <malloc+0x1e64>
    415e:	453000ef          	jal	4db0 <open>
    4162:	8a2a                	mv	s4,a0
  total = 0;
    4164:	4981                	li	s3,0
  for(i = 0; ; i++){
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f1650513          	addi	a0,a0,-234 # 70c8 <malloc+0x1e74>
    41ba:	7e7000ef          	jal	51a0 <printf>
    exit(1);
    41be:	4505                	li	a0,1
    41c0:	3b1000ef          	jal	4d70 <exit>
      printf("%s: write bigfile failed\n", s);
    41c4:	85d6                	mv	a1,s5
    41c6:	00003517          	auipc	a0,0x3
    41ca:	f2250513          	addi	a0,a0,-222 # 70e8 <malloc+0x1e94>
    41ce:	7d3000ef          	jal	51a0 <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    41d4:	39d000ef          	jal	4d70 <exit>
    printf("%s: cannot open bigfile\n", s);
    41d8:	85d6                	mv	a1,s5
    41da:	00003517          	auipc	a0,0x3
    41de:	f2e50513          	addi	a0,a0,-210 # 7108 <malloc+0x1eb4>
    41e2:	7bf000ef          	jal	51a0 <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    41e8:	389000ef          	jal	4d70 <exit>
      printf("%s: read bigfile failed\n", s);
    41ec:	85d6                	mv	a1,s5
    41ee:	00003517          	auipc	a0,0x3
    41f2:	f3a50513          	addi	a0,a0,-198 # 7128 <malloc+0x1ed4>
    41f6:	7ab000ef          	jal	51a0 <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    41fc:	375000ef          	jal	4d70 <exit>
      printf("%s: short read bigfile\n", s);
    4200:	85d6                	mv	a1,s5
    4202:	00003517          	auipc	a0,0x3
    4206:	f4650513          	addi	a0,a0,-186 # 7148 <malloc+0x1ef4>
    420a:	797000ef          	jal	51a0 <printf>
      exit(1);
    420e:	4505                	li	a0,1
    4210:	361000ef          	jal	4d70 <exit>
      printf("%s: read bigfile wrong data\n", s);
    4214:	85d6                	mv	a1,s5
    4216:	00003517          	auipc	a0,0x3
    421a:	f4a50513          	addi	a0,a0,-182 # 7160 <malloc+0x1f0c>
    421e:	783000ef          	jal	51a0 <printf>
      exit(1);
    4222:	4505                	li	a0,1
    4224:	34d000ef          	jal	4d70 <exit>
  close(fd);
    4228:	8552                	mv	a0,s4
    422a:	36f000ef          	jal	4d98 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    423c:	e8050513          	addi	a0,a0,-384 # 70b8 <malloc+0x1e64>
    4240:	381000ef          	jal	4dc0 <unlink>
}
    ...
    425c:	f2850513          	addi	a0,a0,-216 # 7180 <malloc+0x1f2c>
    4260:	741000ef          	jal	51a0 <printf>
    exit(1);
    4264:	4505                	li	a0,1
    4266:	30b000ef          	jal	4d70 <exit>
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f2a50513          	addi	a0,a0,-214 # 71a0 <malloc+0x1f4c>
    427e:	343000ef          	jal	4dc0 <unlink>
  pid = fork();
    4282:	2e7000ef          	jal	4d68 <fork>
  if(pid == 0){
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f0450513          	addi	a0,a0,-252 # 71a0 <malloc+0x1f4c>
    42a4:	30d000ef          	jal	4db0 <open>
  if(fd < 0){
    42a8:	08054663          	bltz	a0,4334 <bigargtest+0xca>
  close(fd);
    42ac:	2ed000ef          	jal	4d98 <close>
}
    ...
    42fa:	09250513          	addi	a0,a0,146 # 5388 <malloc+0x134>
    42fe:	2ab000ef          	jal	4da8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	e9a50513          	addi	a0,a0,-358 # 71a0 <malloc+0x1f4c>
    430e:	2a3000ef          	jal	4db0 <open>
    close(fd);
    4312:	287000ef          	jal	4d98 <close>
    exit(0);
    4316:	4501                	li	a0,0
    4318:	259000ef          	jal	4d70 <exit>
    printf("%s: bigargtest: fork failed\n", s);
    431c:	85a6                	mv	a1,s1
    431e:	00003517          	auipc	a0,0x3
    4322:	e9250513          	addi	a0,a0,-366 # 71b0 <malloc+0x1f5c>
    4326:	67b000ef          	jal	51a0 <printf>
    exit(1);
    432a:	4505                	li	a0,1
    432c:	245000ef          	jal	4d70 <exit>
    exit(xstatus);
    4330:	241000ef          	jal	4d70 <exit>
    printf("%s: bigarg test failed!\n", s);
    4334:	85a6                	mv	a1,s1
    4336:	00003517          	auipc	a0,0x3
    433a:	e9a50513          	addi	a0,a0,-358 # 71d0 <malloc+0x1f7c>
    433e:	663000ef          	jal	51a0 <printf>
    exit(1);
    4342:	4505                	li	a0,1
    4344:	22d000ef          	jal	4d70 <exit>
...
0000000000004348 <lazy_alloc>:
{
  ...
  prev_end = sbrklazy(REGION_SZ);
    ...
    4354:	1ff000ef          	jal	4d52 <sbrklazy>
  ...
  exit(0);
    4388:	4501                	li	a0,0
    438a:	1e7000ef          	jal	4d70 <exit>
    printf("sbrklazy() failed\n");
    438e:	00003517          	auipc	a0,0x3
    4392:	e6250513          	addi	a0,a0,-414 # 71f0 <malloc+0x1f9c>
    4396:	60b000ef          	jal	51a0 <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	1d5000ef          	jal	4d70 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	e6850513          	addi	a0,a0,-408 # 7208 <malloc+0x1fb4>
    43a8:	5f9000ef          	jal	51a0 <printf>
      exit(1);
    43ac:	4505                	li	a0,1
    43ae:	1c3000ef          	jal	4d70 <exit>
...
00000000000043b2 <lazy_unmap>:
{
  ...
  prev_end = sbrklazy(REGION_SZ);
    ...
    43be:	195000ef          	jal	4d52 <sbrklazy>
  if (prev_end == (char*)SBRK_ERROR) {
    43c2:	57fd                	li	a5,-1
  ...
  exit(0);
    440a:	4501                	li	a0,0
    440c:	165000ef          	jal	4d70 <exit>
    4410:	f426                	sd	s1,40(sp)
    4412:	f04a                	sd	s2,32(sp)
    4414:	ec4e                	sd	s3,24(sp)
    printf("sbrklazy() failed\n");
    4416:	00003517          	auipc	a0,0x3
    441a:	dda50513          	addi	a0,a0,-550 # 71f0 <malloc+0x1f9c>
    441e:	583000ef          	jal	51a0 <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	14d000ef          	jal	4d70 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	e0850513          	addi	a0,a0,-504 # 7230 <malloc+0x1fdc>
    4430:	571000ef          	jal	51a0 <printf>
      exit(1);
    4434:	4505                	li	a0,1
    4436:	13b000ef          	jal	4d70 <exit>
      sbrklazy(-1L * REGION_SZ);
    443a:	c0000537          	lui	a0,0xc0000
    443e:	115000ef          	jal	4d52 <sbrklazy>
      *(char **)i = i;
    4442:	01293023          	sd	s2,0(s2) # 1000 <badarg>
      exit(0);
    4446:	4501                	li	a0,0
    4448:	129000ef          	jal	4d70 <exit>
        printf("memory not unmapped\n");
    444c:	00003517          	auipc	a0,0x3
    4450:	df450513          	addi	a0,a0,-524 # 7240 <malloc+0x1fec>
    4454:	54d000ef          	jal	51a0 <printf>
        exit(1);
    4458:	4505                	li	a0,1
    445a:	117000ef          	jal	4d70 <exit>
...
000000000000445e <lazy_copy>:
{
    ...
    char *p = sbrk(0);
    4472:	4501                	li	a0,0
    4474:	0c9000ef          	jal	4d3c <sbrk>
    4478:	84aa                	mv	s1,a0
    sbrklazy(4*PGSIZE);
    447a:	6511                	lui	a0,0x4
    447c:	0d7000ef          	jal	4d52 <sbrklazy>
    open(p + 8192, 0);
    4480:	4581                	li	a1,0
    4482:	6509                	lui	a0,0x2
    4484:	9526                	add	a0,a0,s1
    4486:	12b000ef          	jal	4db0 <open>
    void *xx = sbrk(0);
    448a:	4501                	li	a0,0
    448c:	0b1000ef          	jal	4d3c <sbrk>
    4490:	84aa                	mv	s1,a0
    void *ret = sbrk(-(((uint64) xx)+1));
    4492:	fff54513          	not	a0,a0
    4496:	2501                	sext.w	a0,a0
    4498:	0a5000ef          	jal	4d3c <sbrk>
    if(ret != xx){
    449c:	00a48c63          	beq	s1,a0,44b4 <lazy_copy+0x56>
    44a0:	85aa                	mv	a1,a0
      printf("sbrk(sbrk(0)+1) returned %p, not old sz\n", ret);
    44a2:	00003517          	auipc	a0,0x3
    44a6:	db650513          	addi	a0,a0,-586 # 7258 <malloc+0x2004>
    44aa:	4f7000ef          	jal	51a0 <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	0c1000ef          	jal	4d70 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	41c78793          	addi	a5,a5,1052 # 78d0 <malloc+0x267c>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	078a0a13          	addi	s4,s4,120 # 5560 <malloc+0x30c>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	f80a8a93          	addi	s5,s5,-128 # 5470 <malloc+0x21c>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
    44fc:	0b5000ef          	jal	4db0 <open>
    4500:	84aa                	mv	s1,a0
    ...
    450e:	85ce                	mv	a1,s3
    4510:	079000ef          	jal	4d88 <read>
    4514:	04055663          	bgez	a0,4560 <lazy_copy+0x102>
    close(fd);
    4518:	8526                	mv	a0,s1
    451a:	07f000ef          	jal	4d98 <close>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    451e:	60200593          	li	a1,1538
    4522:	8556                	mv	a0,s5
    4524:	08d000ef          	jal	4db0 <open>
    4528:	84aa                	mv	s1,a0
    ...
    4532:	85ce                	mv	a1,s3
    4534:	05d000ef          	jal	4d90 <write>
    4538:	04055663          	bgez	a0,4584 <lazy_copy+0x126>
    close(fd);
    453c:	8526                	mv	a0,s1
    453e:	05b000ef          	jal	4d98 <close>
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    4542:	0921                	addi	s2,s2,8
    4544:	fb691ae3          	bne	s2,s6,44f8 <lazy_copy+0x9a>
  exit(0);
    4548:	4501                	li	a0,0
    454a:	027000ef          	jal	4d70 <exit>
    if(fd < 0) { printf("cannot open README\n"); exit(1); }
    454e:	00003517          	auipc	a0,0x3
    4552:	d3a50513          	addi	a0,a0,-710 # 7288 <malloc+0x2034>
    4556:	44b000ef          	jal	51a0 <printf>
    455a:	4505                	li	a0,1
    455c:	015000ef          	jal	4d70 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	d4050513          	addi	a0,a0,-704 # 72a0 <malloc+0x204c>
    4568:	439000ef          	jal	51a0 <printf>
    456c:	4505                	li	a0,1
    456e:	003000ef          	jal	4d70 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	d3e50513          	addi	a0,a0,-706 # 72b0 <malloc+0x205c>
    457a:	427000ef          	jal	51a0 <printf>
    457e:	4505                	li	a0,1
    4580:	7f0000ef          	jal	4d70 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	d4450513          	addi	a0,a0,-700 # 72c8 <malloc+0x2074>
    458c:	415000ef          	jal	51a0 <printf>
    4590:	4505                	li	a0,1
    4592:	7de000ef          	jal	4d70 <exit>
...
0000000000004596 <lazy_sbrk>:
{
  ...
  while ((uint64)p < MAXVA-(1<<30)) {
    ...
    45ba:	798000ef          	jal	4d52 <sbrklazy>
    p = sbrklazy(0);
    45be:	4501                	li	a0,0
    45c0:	792000ef          	jal	4d52 <sbrklazy>
    45c4:	84aa                	mv	s1,a0
  while ((uint64)p < MAXVA-(1<<30)) {
  ...
  char *p1 = sbrklazy(n);
    45d0:	854a                	mv	a0,s2
    45d2:	780000ef          	jal	4d52 <sbrklazy>
    45d6:	862a                	mv	a2,a0
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d0050513          	addi	a0,a0,-768 # 72e0 <malloc+0x208c>
    45e8:	3b9000ef          	jal	51a0 <printf>
    exit(1);
    45ec:	4505                	li	a0,1
    45ee:	782000ef          	jal	4d70 <exit>
  p = sbrk(PGSIZE);
    45f2:	6505                	lui	a0,0x1
    45f4:	748000ef          	jal	4d3c <sbrk>
    45f8:	862a                	mv	a2,a0
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d0850513          	addi	a0,a0,-760 # 7310 <malloc+0x20bc>
    4610:	391000ef          	jal	51a0 <printf>
    exit(1);
    4614:	4505                	li	a0,1
    4616:	75a000ef          	jal	4d70 <exit>
  p[0] = 1;
  ...
  if (p[1] != 0) {
    ...
    4632:	d1a50513          	addi	a0,a0,-742 # 7348 <malloc+0x20f4>
    4636:	36b000ef          	jal	51a0 <printf>
    exit(1);
    463a:	4505                	li	a0,1
    463c:	734000ef          	jal	4d70 <exit>
  p = sbrk(1);
    4640:	4505                	li	a0,1
    4642:	6fa000ef          	jal	4d3c <sbrk>
    4646:	85aa                	mv	a1,a0
  if ((uint64)p != -1) {
    4648:	57fd                	li	a5,-1
    ...
    4652:	d2250513          	addi	a0,a0,-734 # 7370 <malloc+0x211c>
    4656:	34b000ef          	jal	51a0 <printf>
    exit(1);
    465a:	4505                	li	a0,1
    465c:	714000ef          	jal	4d70 <exit>
  p = sbrklazy(1);
    4660:	4505                	li	a0,1
    4662:	6f0000ef          	jal	4d52 <sbrklazy>
    4666:	85aa                	mv	a1,a0
  if ((uint64)p != -1) {
    4668:	57fd                	li	a5,-1
    ...
    4672:	d2a50513          	addi	a0,a0,-726 # 7398 <malloc+0x2144>
    4676:	32b000ef          	jal	51a0 <printf>
    exit(1);
    467a:	4505                	li	a0,1
    467c:	6f4000ef          	jal	4d70 <exit>
  exit(0);
    4680:	4501                	li	a0,0
    4682:	6ee000ef          	jal	4d70 <exit>
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d2650513          	addi	a0,a0,-730 # 73c8 <malloc+0x2174>
    46aa:	2f7000ef          	jal	51a0 <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	d1ac8c93          	addi	s9,s9,-742 # 73d8 <malloc+0x2184>
    name[0] = 'f';
    ...
    470a:	8566                	mv	a0,s9
    470c:	295000ef          	jal	51a0 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    4710:	20200593          	li	a1,514
    4714:	f6040513          	addi	a0,s0,-160
    4718:	698000ef          	jal	4db0 <open>
    471c:	892a                	mv	s2,a0
    if(fd < 0){
    ...
    472a:	cc250513          	addi	a0,a0,-830 # 73e8 <malloc+0x2194>
    472e:	273000ef          	jal	51a0 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	c7450513          	addi	a0,a0,-908 # 7408 <malloc+0x21b4>
    479c:	205000ef          	jal	51a0 <printf>
}
    ...
    47e6:	c1650513          	addi	a0,a0,-1002 # 73f8 <malloc+0x21a4>
    47ea:	1b7000ef          	jal	51a0 <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
    47f0:	5a8000ef          	jal	4d98 <close>
    if(total == 0)
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c1450513          	addi	a0,a0,-1004 # 7420 <malloc+0x21cc>
    4814:	18d000ef          	jal	51a0 <printf>
  if((pid = fork()) < 0) {
    4818:	550000ef          	jal	4d68 <fork>
  ...
  if(pid == 0) {
    ...
    4826:	552000ef          	jal	4d78 <wait>
    if(xstatus != 0) 
    482a:	fdc42783          	lw	a5,-36(s0)
    482e:	cf9d                	beqz	a5,486c <run+0x70>
      printf("FAILED\n");
    4830:	00003517          	auipc	a0,0x3
    4834:	c1850513          	addi	a0,a0,-1000 # 7448 <malloc+0x21f4>
    4838:	169000ef          	jal	51a0 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	be050513          	addi	a0,a0,-1056 # 7430 <malloc+0x21dc>
    4858:	149000ef          	jal	51a0 <printf>
    exit(1);
    485c:	4505                	li	a0,1
    485e:	512000ef          	jal	4d70 <exit>
    f(s);
    4862:	854a                	mv	a0,s2
    4864:	9482                	jalr	s1
    exit(0);
    4866:	4501                	li	a0,0
    4868:	508000ef          	jal	4d70 <exit>
      printf("OK\n");
    486c:	00003517          	auipc	a0,0x3
    4870:	be450513          	addi	a0,a0,-1052 # 7450 <malloc+0x21fc>
    4874:	12d000ef          	jal	51a0 <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	b9a50513          	addi	a0,a0,-1126 # 7458 <malloc+0x2204>
    48c6:	0db000ef          	jal	51a0 <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
countfree()
{
  ...
  while(1){
    ...
    490c:	430000ef          	jal	4d3c <sbrk>
    if(a == SBRK_ERROR){
    4910:	ff251ce3          	bne	a0,s2,4908 <countfree+0x1c>
  }
  sbrk(-((uint64)sbrk(0) - sz0));  
    4914:	4501                	li	a0,0
    4916:	426000ef          	jal	4d3c <sbrk>
    491a:	40a9853b          	subw	a0,s3,a0
    491e:	41e000ef          	jal	4d3c <sbrk>
  return n;
}
    4922:	8526                	mv	a0,s1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    4956:	00003b17          	auipc	s6,0x3
    495a:	b1ab0b13          	addi	s6,s6,-1254 # 7470 <malloc+0x221c>
    // int free0 = countfree();
    int free0 = 0;
    int free1 = 0;
    int ntests = 0;
    ...
    495e:	00004a97          	auipc	s5,0x4
    4962:	6b2a8a93          	addi	s5,s5,1714 # 9010 <quicktests>
    if (n < 0) {
      if(continuous != 2) {
    4966:	4b89                	li	s7,2
    int ntests = 0;
    ...
    496a:	00005c17          	auipc	s8,0x5
    496e:	ab6c0c13          	addi	s8,s8,-1354 # 9420 <slowtests>
        printf("usertests slow tests starting\n");
    4972:	00003d97          	auipc	s11,0x3
    4976:	b16d8d93          	addi	s11,s11,-1258 # 7488 <malloc+0x2234>
      } else {
        ntests += n;
      }
    }
    ...
    497a:	00003d17          	auipc	s10,0x3
    497e:	b2ed0d13          	addi	s10,s10,-1234 # 74a8 <malloc+0x2254>
    4982:	a025                	j	49aa <drivetests+0x78>
      if(continuous != 2) {
    4984:	07791d63          	bne	s2,s7,49fe <drivetests+0xcc>
    int ntests = 0;
    4988:	84e6                	mv	s1,s9
    498a:	a81d                	j	49c0 <drivetests+0x8e>
        printf("usertests slow tests starting\n");
    498c:	856e                	mv	a0,s11
    498e:	013000ef          	jal	51a0 <printf>
    4992:	a81d                	j	49c8 <drivetests+0x96>
        if(continuous != 2) {
    4994:	07791763          	bne	s2,s7,4a02 <drivetests+0xd0>
    if((free1 = countfree()) < free0) {
    4998:	f55ff0ef          	jal	48ec <countfree>
    499c:	02054f63          	bltz	a0,49da <drivetests+0xa8>
      if(continuous != 2) {
        return 1;
      }
    }
    if (justone != 0 && ntests == 0) {
    49a0:	00098363          	beqz	s3,49a6 <drivetests+0x74>
    49a4:	c4a9                	beqz	s1,49ee <drivetests+0xbc>
      printf("NO TESTS EXECUTED\n");
      return 1;
    }
  } while(continuous);
    49a6:	06090263          	beqz	s2,4a0a <drivetests+0xd8>
    printf("usertests starting\n");
    49aa:	855a                	mv	a0,s6
    49ac:	7f4000ef          	jal	51a0 <printf>
    n = runtests(quicktests, justone, continuous);
    49b0:	864a                	mv	a2,s2
    49b2:	85ce                	mv	a1,s3
    49b4:	8556                	mv	a0,s5
    49b6:	ec5ff0ef          	jal	487a <runtests>
    49ba:	84aa                	mv	s1,a0
    if (n < 0) {
    49bc:	fc0544e3          	bltz	a0,4984 <drivetests+0x52>
    if(!quick) {
    49c0:	fc0a1ce3          	bnez	s4,4998 <drivetests+0x66>
      if (justone == 0)
    49c4:	fc0984e3          	beqz	s3,498c <drivetests+0x5a>
      n = runtests(slowtests, justone, continuous);
    49c8:	864a                	mv	a2,s2
    49ca:	85ce                	mv	a1,s3
    49cc:	8562                	mv	a0,s8
    49ce:	eadff0ef          	jal	487a <runtests>
      if (n < 0) {
    49d2:	fc0541e3          	bltz	a0,4994 <drivetests+0x62>
        ntests += n;
    49d6:	9ca9                	addw	s1,s1,a0
    49d8:	b7c1                	j	4998 <drivetests+0x66>
      printf("FAILED -- lost some free pages %d (out of %d)\n", free1, free0);
    49da:	8666                	mv	a2,s9
    49dc:	85aa                	mv	a1,a0
    49de:	856a                	mv	a0,s10
    49e0:	7c0000ef          	jal	51a0 <printf>
      if(continuous != 2) {
    49e4:	03791163          	bne	s2,s7,4a06 <drivetests+0xd4>
    if (justone != 0 && ntests == 0) {
    49e8:	fa099ee3          	bnez	s3,49a4 <drivetests+0x72>
    49ec:	bf7d                	j	49aa <drivetests+0x78>
      printf("NO TESTS EXECUTED\n");
    49ee:	00003517          	auipc	a0,0x3
    49f2:	aea50513          	addi	a0,a0,-1302 # 74d8 <malloc+0x2284>
    49f6:	7aa000ef          	jal	51a0 <printf>
      return 1;
    49fa:	4505                	li	a0,1
    49fc:	a801                	j	4a0c <drivetests+0xda>
        return 1;
    49fe:	4505                	li	a0,1
    4a00:	a031                	j	4a0c <drivetests+0xda>
          return 1;
    4a02:	4505                	li	a0,1
    4a04:	a021                	j	4a0c <drivetests+0xda>
        return 1;
    4a06:	4505                	li	a0,1
    4a08:	a011                	j	4a0c <drivetests+0xda>
  return 0;
    4a0a:	854a                	mv	a0,s2
}
    4a0c:	70a6                	ld	ra,104(sp)
    4a0e:	7406                	ld	s0,96(sp)
    4a10:	64e6                	ld	s1,88(sp)
    4a12:	6946                	ld	s2,80(sp)
    4a14:	69a6                	ld	s3,72(sp)
    4a16:	6a06                	ld	s4,64(sp)
    4a18:	7ae2                	ld	s5,56(sp)
    4a1a:	7b42                	ld	s6,48(sp)
    4a1c:	7ba2                	ld	s7,40(sp)
    4a1e:	7c02                	ld	s8,32(sp)
    4a20:	6ce2                	ld	s9,24(sp)
    4a22:	6d42                	ld	s10,16(sp)
    4a24:	6da2                	ld	s11,8(sp)
    4a26:	6165                	addi	sp,sp,112
    4a28:	8082                	ret

0000000000004a2a <main>:

int
main(int argc, char *argv[])
{
    4a2a:	1101                	addi	sp,sp,-32
    4a2c:	ec06                	sd	ra,24(sp)
    4a2e:	e822                	sd	s0,16(sp)
    4a30:	e426                	sd	s1,8(sp)
    4a32:	e04a                	sd	s2,0(sp)
    4a34:	1000                	addi	s0,sp,32
    4a36:	84aa                	mv	s1,a0
  int continuous = 0;
  int quick = 0;
  char *justone = 0;
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    4a38:	4789                	li	a5,2
    4a3a:	00f50e63          	beq	a0,a5,4a56 <main+0x2c>
    continuous = 1;
    ...
    4a3e:	4785                	li	a5,1
    4a40:	06a7c663          	blt	a5,a0,4aac <main+0x82>
  char *justone = 0;
    4a44:	4601                	li	a2,0
  int quick = 0;
    4a46:	4501                	li	a0,0
  ...
  if (drivetests(quick, continuous, justone)) {
    4a4a:	ee9ff0ef          	jal	4932 <drivetests>
    4a4e:	cd35                	beqz	a0,4aca <main+0xa0>
    exit(1);
    4a50:	4505                	li	a0,1
    4a52:	31e000ef          	jal	4d70 <exit>
    4a56:	892e                	mv	s2,a1
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    4a58:	00003597          	auipc	a1,0x3
    4a5c:	a9858593          	addi	a1,a1,-1384 # 74f0 <malloc+0x229c>
    4a60:	00893503          	ld	a0,8(s2) # ffffffffffffd008 <base+0xfffffffffffed350>
    4a64:	0a4000ef          	jal	4b08 <strcmp>
    4a68:	85aa                	mv	a1,a0
    4a6a:	e501                	bnez	a0,4a72 <main+0x48>
  char *justone = 0;
    4a6c:	4601                	li	a2,0
    quick = 1;
    4a6e:	4505                	li	a0,1
    4a70:	bfe9                	j	4a4a <main+0x20>
  } else if(argc == 2 && strcmp(argv[1], "-c") == 0){
    4a72:	00003597          	auipc	a1,0x3
    4a76:	a8658593          	addi	a1,a1,-1402 # 74f8 <malloc+0x22a4>
    4a7a:	00893503          	ld	a0,8(s2)
    4a7e:	08a000ef          	jal	4b08 <strcmp>
    4a82:	cd15                	beqz	a0,4abe <main+0x94>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    4a84:	00003597          	auipc	a1,0x3
    4a88:	ac458593          	addi	a1,a1,-1340 # 7548 <malloc+0x22f4>
    4a8c:	00893503          	ld	a0,8(s2)
    4a90:	078000ef          	jal	4b08 <strcmp>
    4a94:	c905                	beqz	a0,4ac4 <main+0x9a>
  } else if(argc == 2 && argv[1][0] != '-'){
    4a96:	00893603          	ld	a2,8(s2)
    4a9a:	00064703          	lbu	a4,0(a2) # 1000 <badarg>
    4a9e:	02d00793          	li	a5,45
    4aa2:	00f70563          	beq	a4,a5,4aac <main+0x82>
  int quick = 0;
    4aa6:	4501                	li	a0,0
  int continuous = 0;
    4aa8:	4581                	li	a1,0
    4aaa:	b745                	j	4a4a <main+0x20>
    printf("Usage: usertests [-c] [-C] [-q] [testname]\n");
    4aac:	00003517          	auipc	a0,0x3
    4ab0:	a5450513          	addi	a0,a0,-1452 # 7500 <malloc+0x22ac>
    4ab4:	6ec000ef          	jal	51a0 <printf>
    exit(1);
    4ab8:	4505                	li	a0,1
    4aba:	2b6000ef          	jal	4d70 <exit>
  char *justone = 0;
    4abe:	4601                	li	a2,0
    continuous = 1;
    4ac0:	4585                	li	a1,1
    4ac2:	b761                	j	4a4a <main+0x20>
    continuous = 2;
    4ac4:	85a6                	mv	a1,s1
  char *justone = 0;
    4ac6:	4601                	li	a2,0
    4ac8:	b749                	j	4a4a <main+0x20>
  }
  printf("ALL TESTS PASSED\n");
    4aca:	00003517          	auipc	a0,0x3
    4ace:	a6650513          	addi	a0,a0,-1434 # 7530 <malloc+0x22dc>
    4ad2:	6ce000ef          	jal	51a0 <printf>
  exit(0);
    4ad6:	4501                	li	a0,0
    4ad8:	298000ef          	jal	4d70 <exit>

0000000000004adc <start>:
//
...
start(int argc, char **argv)
{
    ...
    4ade:	e406                	sd	ra,8(sp)
    4ae0:	e022                	sd	s0,0(sp)
    4ae2:	0800                	addi	s0,sp,16
  int r;
  extern int main(int argc, char **argv);
  r = main(argc, argv);
    4ae4:	f47ff0ef          	jal	4a2a <main>
  exit(r);
    4ae8:	288000ef          	jal	4d70 <exit>

0000000000004aec <strcpy>:
}

char*
strcpy(char *s, const char *t)
{
    4aec:	1141                	addi	sp,sp,-16
    4aee:	e422                	sd	s0,8(sp)
    4af0:	0800                	addi	s0,sp,16
  char *os;
  ...
  while((*s++ = *t++) != 0)
    ...
    4af8:	fff5c703          	lbu	a4,-1(a1)
    4afc:	fee78fa3          	sb	a4,-1(a5)
    4b00:	fb75                	bnez	a4,4af4 <strcpy+0x8>
    ;
  return os;
}
    4b02:	6422                	ld	s0,8(sp)
    4b04:	0141                	addi	sp,sp,16
    4b06:	8082                	ret

0000000000004b08 <strcmp>:

int
strcmp(const char *p, const char *q)
{
    4b08:	1141                	addi	sp,sp,-16
    4b0a:	e422                	sd	s0,8(sp)
    4b0c:	0800                	addi	s0,sp,16
  while(*p && *p == *q)
    4b0e:	00054783          	lbu	a5,0(a0)
    4b12:	cb91                	beqz	a5,4b26 <strcmp+0x1e>
    4b14:	0005c703          	lbu	a4,0(a1)
    4b18:	00f71763          	bne	a4,a5,4b26 <strcmp+0x1e>
    p++, q++;
    4b1c:	0505                	addi	a0,a0,1
    4b1e:	0585                	addi	a1,a1,1
  while(*p && *p == *q)
    4b20:	00054783          	lbu	a5,0(a0)
    4b24:	fbe5                	bnez	a5,4b14 <strcmp+0xc>
  return (uchar)*p - (uchar)*q;
    4b26:	0005c503          	lbu	a0,0(a1)
}
    4b2a:	40a7853b          	subw	a0,a5,a0
    4b2e:	6422                	ld	s0,8(sp)
    4b30:	0141                	addi	sp,sp,16
    4b32:	8082                	ret

0000000000004b34 <strlen>:

uint
strlen(const char *s)
{
    4b34:	1141                	addi	sp,sp,-16
    4b36:	e422                	sd	s0,8(sp)
    4b38:	0800                	addi	s0,sp,16
  int n;

  for(n = 0; s[n]; n++)
    4b3a:	00054783          	lbu	a5,0(a0)
    4b3e:	cf91                	beqz	a5,4b5a <strlen+0x26>
    4b40:	0505                	addi	a0,a0,1
    4b42:	87aa                	mv	a5,a0
    4b44:	86be                	mv	a3,a5
    4b46:	0785                	addi	a5,a5,1
    4b48:	fff7c703          	lbu	a4,-1(a5)
    4b4c:	ff65                	bnez	a4,4b44 <strlen+0x10>
    4b4e:	40a6853b          	subw	a0,a3,a0
    4b52:	2505                	addiw	a0,a0,1
    ;
  return n;
}
    4b54:	6422                	ld	s0,8(sp)
    4b56:	0141                	addi	sp,sp,16
    4b58:	8082                	ret
  for(n = 0; s[n]; n++)
    4b5a:	4501                	li	a0,0
    4b5c:	bfe5                	j	4b54 <strlen+0x20>

0000000000004b5e <memset>:

void*
memset(void *dst, int c, uint n)
{
    4b5e:	1141                	addi	sp,sp,-16
    4b60:	e422                	sd	s0,8(sp)
    4b62:	0800                	addi	s0,sp,16
  char *cdst = (char *) dst;
  int i;
  for(i = 0; i < n; i++){
    4b64:	ca19                	beqz	a2,4b7a <memset+0x1c>
    4b66:	87aa                	mv	a5,a0
    4b68:	1602                	slli	a2,a2,0x20
    4b6a:	9201                	srli	a2,a2,0x20
    4b6c:	00a60733          	add	a4,a2,a0
    cdst[i] = c;
    4b70:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
    4b74:	0785                	addi	a5,a5,1
    4b76:	fee79de3          	bne	a5,a4,4b70 <memset+0x12>
  }
  return dst;
}
    4b7a:	6422                	ld	s0,8(sp)
    4b7c:	0141                	addi	sp,sp,16
    4b7e:	8082                	ret

0000000000004b80 <strchr>:

char*
strchr(const char *s, char c)
{
    4b80:	1141                	addi	sp,sp,-16
    4b82:	e422                	sd	s0,8(sp)
    4b84:	0800                	addi	s0,sp,16
  for(; *s; s++)
    4b86:	00054783          	lbu	a5,0(a0)
    4b8a:	cb99                	beqz	a5,4ba0 <strchr+0x20>
    if(*s == c)
    4b8c:	00f58763          	beq	a1,a5,4b9a <strchr+0x1a>
  for(; *s; s++)
    4b90:	0505                	addi	a0,a0,1
    4b92:	00054783          	lbu	a5,0(a0)
    4b96:	fbfd                	bnez	a5,4b8c <strchr+0xc>
      return (char*)s;
  return 0;
    4b98:	4501                	li	a0,0
}
    4b9a:	6422                	ld	s0,8(sp)
    4b9c:	0141                	addi	sp,sp,16
    4b9e:	8082                	ret
  return 0;
    4ba0:	4501                	li	a0,0
    4ba2:	bfe5                	j	4b9a <strchr+0x1a>

0000000000004ba4 <gets>:

char*
gets(char *buf, int max)
{
    4ba4:	711d                	addi	sp,sp,-96
    4ba6:	ec86                	sd	ra,88(sp)
    4ba8:	e8a2                	sd	s0,80(sp)
    4baa:	e4a6                	sd	s1,72(sp)
    4bac:	e0ca                	sd	s2,64(sp)
    4bae:	fc4e                	sd	s3,56(sp)
    4bb0:	f852                	sd	s4,48(sp)
    4bb2:	f456                	sd	s5,40(sp)
    4bb4:	f05a                	sd	s6,32(sp)
    4bb6:	ec5e                	sd	s7,24(sp)
    4bb8:	1080                	addi	s0,sp,96
    4bba:	8baa                	mv	s7,a0
    4bbc:	8a2e                	mv	s4,a1
  int i, cc;
  char c;
  ...
  for(i=0; i+1 < max; ){
    4bc6:	89a6                	mv	s3,s1
    4bc8:	2485                	addiw	s1,s1,1
    4bca:	0344d663          	bge	s1,s4,4bf6 <gets+0x52>
    cc = read(0, &c, 1);
    4bce:	4605                	li	a2,1
    4bd0:	faf40593          	addi	a1,s0,-81
    4bd4:	4501                	li	a0,0
    4bd6:	1b2000ef          	jal	4d88 <read>
    if(cc < 1)
    4bda:	00a05e63          	blez	a0,4bf6 <gets+0x52>
    buf[i++] = c;
    4bde:	faf44783          	lbu	a5,-81(s0)
    4be2:	00f90023          	sb	a5,0(s2)
    if(c == '\n' || c == '\r')
    4be6:	01578763          	beq	a5,s5,4bf4 <gets+0x50>
    4bea:	0905                	addi	s2,s2,1
    4bec:	fd679de3          	bne	a5,s6,4bc6 <gets+0x22>
    buf[i++] = c;
    4bf0:	89a6                	mv	s3,s1
    4bf2:	a011                	j	4bf6 <gets+0x52>
    4bf4:	89a6                	mv	s3,s1
      break;
  }
  buf[i] = '\0';
    4bf6:	99de                	add	s3,s3,s7
    4bf8:	00098023          	sb	zero,0(s3)
  return buf;
}
    4bfc:	855e                	mv	a0,s7
    4bfe:	60e6                	ld	ra,88(sp)
    4c00:	6446                	ld	s0,80(sp)
    4c02:	64a6                	ld	s1,72(sp)
    4c04:	6906                	ld	s2,64(sp)
    4c06:	79e2                	ld	s3,56(sp)
    4c08:	7a42                	ld	s4,48(sp)
    4c0a:	7aa2                	ld	s5,40(sp)
    4c0c:	7b02                	ld	s6,32(sp)
    4c0e:	6be2                	ld	s7,24(sp)
    4c10:	6125                	addi	sp,sp,96
    4c12:	8082                	ret

0000000000004c14 <stat>:
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    4c20:	4581                	li	a1,0
    4c22:	18e000ef          	jal	4db0 <open>
  if(fd < 0)
    4c26:	02054263          	bltz	a0,4c4a <stat+0x36>
    4c2a:	e426                	sd	s1,8(sp)
    4c2c:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
    4c2e:	85ca                	mv	a1,s2
    4c30:	198000ef          	jal	4dc8 <fstat>
    4c34:	892a                	mv	s2,a0
  close(fd);
    4c36:	8526                	mv	a0,s1
    4c38:	160000ef          	jal	4d98 <close>
  return r;
    4c3c:	64a2                	ld	s1,8(sp)
}
    4c3e:	854a                	mv	a0,s2
    4c40:	60e2                	ld	ra,24(sp)
    4c42:	6442                	ld	s0,16(sp)
    4c44:	6902                	ld	s2,0(sp)
    4c46:	6105                	addi	sp,sp,32
    4c48:	8082                	ret
    return -1;
    4c4a:	597d                	li	s2,-1
    4c4c:	bfcd                	j	4c3e <stat+0x2a>

0000000000004c4e <atoi>:

int
atoi(const char *s)
{
    4c4e:	1141                	addi	sp,sp,-16
    4c50:	e422                	sd	s0,8(sp)
    4c52:	0800                	addi	s0,sp,16
  int n;

  n = 0;
  while('0' <= *s && *s <= '9')
    4c54:	00054683          	lbu	a3,0(a0)
    4c58:	fd06879b          	addiw	a5,a3,-48 # 3ffd0 <base+0x30318>
    4c5c:	0ff7f793          	zext.b	a5,a5
    4c60:	4625                	li	a2,9
    4c62:	02f66863          	bltu	a2,a5,4c92 <atoi+0x44>
    4c66:	872a                	mv	a4,a0
  n = 0;
    4c68:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
    4c6a:	0705                	addi	a4,a4,1 # 1000001 <base+0xff0349>
    4c6c:	0025179b          	slliw	a5,a0,0x2
    4c70:	9fa9                	addw	a5,a5,a0
    4c72:	0017979b          	slliw	a5,a5,0x1
    4c76:	9fb5                	addw	a5,a5,a3
    4c78:	fd07851b          	addiw	a0,a5,-48
  while('0' <= *s && *s <= '9')
    4c7c:	00074683          	lbu	a3,0(a4)
    4c80:	fd06879b          	addiw	a5,a3,-48
    4c84:	0ff7f793          	zext.b	a5,a5
    4c88:	fef671e3          	bgeu	a2,a5,4c6a <atoi+0x1c>
  return n;
}
    4c8c:	6422                	ld	s0,8(sp)
    4c8e:	0141                	addi	sp,sp,16
    4c90:	8082                	ret
  n = 0;
    4c92:	4501                	li	a0,0
    4c94:	bfe5                	j	4c8c <atoi+0x3e>

0000000000004c96 <memmove>:

void*
memmove(void *vdst, const void *vsrc, int n)
{
    4c96:	1141                	addi	sp,sp,-16
    4c98:	e422                	sd	s0,8(sp)
    4c9a:	0800                	addi	s0,sp,16
  char *dst;
  const char *src;
  ...
  src = vsrc;
  if (src > dst) {
    4c9c:	02b57463          	bgeu	a0,a1,4cc4 <memmove+0x2e>
    while(n-- > 0)
    4ca0:	00c05f63          	blez	a2,4cbe <memmove+0x28>
    4ca4:	1602                	slli	a2,a2,0x20
    4ca6:	9201                	srli	a2,a2,0x20
    4ca8:	00c507b3          	add	a5,a0,a2
  dst = vdst;
    4cac:	872a                	mv	a4,a0
      *dst++ = *src++;
    4cae:	0585                	addi	a1,a1,1
    4cb0:	0705                	addi	a4,a4,1
    4cb2:	fff5c683          	lbu	a3,-1(a1)
    4cb6:	fed70fa3          	sb	a3,-1(a4)
    while(n-- > 0)
    4cba:	fef71ae3          	bne	a4,a5,4cae <memmove+0x18>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
  return vdst;
    ...
    4cbe:	6422                	ld	s0,8(sp)
    4cc0:	0141                	addi	sp,sp,16
    4cc2:	8082                	ret
    dst += n;
    4cc4:	00c50733          	add	a4,a0,a2
    src += n;
    4cc8:	95b2                	add	a1,a1,a2
    while(n-- > 0)
    4cca:	fec05ae3          	blez	a2,4cbe <memmove+0x28>
    4cce:	fff6079b          	addiw	a5,a2,-1
    4cd2:	1782                	slli	a5,a5,0x20
    4cd4:	9381                	srli	a5,a5,0x20
    4cd6:	fff7c793          	not	a5,a5
    4cda:	97ba                	add	a5,a5,a4
      *--dst = *--src;
    4cdc:	15fd                	addi	a1,a1,-1
    4cde:	177d                	addi	a4,a4,-1
    4ce0:	0005c683          	lbu	a3,0(a1)
    4ce4:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
    4ce8:	fee79ae3          	bne	a5,a4,4cdc <memmove+0x46>
    4cec:	bfc9                	j	4cbe <memmove+0x28>

0000000000004cee <memcmp>:
...
memcmp(const void *s1, const void *s2, uint n)
{
  ...
  while (n-- > 0) {
    4cf4:	ca05                	beqz	a2,4d24 <memcmp+0x36>
    4cf6:	fff6069b          	addiw	a3,a2,-1
    4cfa:	1682                	slli	a3,a3,0x20
    4cfc:	9281                	srli	a3,a3,0x20
    4cfe:	0685                	addi	a3,a3,1
    4d00:	96aa                	add	a3,a3,a0
    if (*p1 != *p2) {
    4d02:	00054783          	lbu	a5,0(a0)
    4d06:	0005c703          	lbu	a4,0(a1)
    4d0a:	00e79863          	bne	a5,a4,4d1a <memcmp+0x2c>
      return *p1 - *p2;
    }
    p1++;
    4d0e:	0505                	addi	a0,a0,1
    p2++;
    4d10:	0585                	addi	a1,a1,1
  while (n-- > 0) {
    4d12:	fed518e3          	bne	a0,a3,4d02 <memcmp+0x14>
  }
  return 0;
    4d16:	4501                	li	a0,0
    4d18:	a019                	j	4d1e <memcmp+0x30>
      return *p1 - *p2;
    4d1a:	40e7853b          	subw	a0,a5,a4
}
    4d1e:	6422                	ld	s0,8(sp)
    4d20:	0141                	addi	sp,sp,16
    4d22:	8082                	ret
  return 0;
    4d24:	4501                	li	a0,0
    4d26:	bfe5                	j	4d1e <memcmp+0x30>

0000000000004d28 <memcpy>:

void *
memcpy(void *dst, const void *src, uint n)
{
    4d28:	1141                	addi	sp,sp,-16
    4d2a:	e406                	sd	ra,8(sp)
    4d2c:	e022                	sd	s0,0(sp)
    4d2e:	0800                	addi	s0,sp,16
  return memmove(dst, src, n);
    4d30:	f67ff0ef          	jal	4c96 <memmove>
}
    4d34:	60a2                	ld	ra,8(sp)
    4d36:	6402                	ld	s0,0(sp)
    4d38:	0141                	addi	sp,sp,16
    4d3a:	8082                	ret

0000000000004d3c <sbrk>:

char *
sbrk(int n) {
    4d3c:	1141                	addi	sp,sp,-16
    4d3e:	e406                	sd	ra,8(sp)
    4d40:	e022                	sd	s0,0(sp)
    4d42:	0800                	addi	s0,sp,16
  ...
  return sys_sbrk(n, SBRK_EAGER);
    4d44:	4585                	li	a1,1
    4d46:	0b2000ef          	jal	4df8 <sys_sbrk>
}
    4d4a:	60a2                	ld	ra,8(sp)
    4d4c:	6402                	ld	s0,0(sp)
    4d4e:	0141                	addi	sp,sp,16
    4d50:	8082                	ret

0000000000004d52 <sbrklazy>:

char *
sbrklazy(int n) {
    4d52:	1141                	addi	sp,sp,-16
    4d54:	e406                	sd	ra,8(sp)
    4d56:	e022                	sd	s0,0(sp)
    4d58:	0800                	addi	s0,sp,16
  return sys_sbrk(n, SBRK_LAZY);
    4d5a:	4589                	li	a1,2
    4d5c:	09c000ef          	jal	4df8 <sys_sbrk>
}
    4d60:	60a2                	ld	ra,8(sp)
    4d62:	6402                	ld	s0,0(sp)
    4d64:	0141                	addi	sp,sp,16
    4d66:	8082                	ret

0000000000004d68 <fork>:
...
putc(int fd, char c)
{
    ...
    4e20:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4e24:	4605                	li	a2,1
    4e26:	fef40593          	addi	a1,s0,-17
    4e2a:	f67ff0ef          	jal	4d90 <write>
}
    4e2e:	60e2                	ld	ra,24(sp)
    4e30:	6442                	ld	s0,16(sp)
    4e32:	6105                	addi	sp,sp,32
    4e34:	8082                	ret

0000000000004e36 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4e36:	715d                	addi	sp,sp,-80
    4e38:	e486                	sd	ra,72(sp)
    4e3a:	e0a2                	sd	s0,64(sp)
    4e3c:	f84a                	sd	s2,48(sp)
    4e3e:	0880                	addi	s0,sp,80
    4e40:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4e42:	c299                	beqz	a3,4e48 <printint+0x12>
    4e44:	0805c363          	bltz	a1,4eca <printint+0x94>
  neg = 0;
    4e48:	4881                	li	a7,0
    4e4a:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4e54:	b2850513          	addi	a0,a0,-1240 # 7978 <digits>
    4e58:	883e                	mv	a6,a5
    4e5a:	2785                	addiw	a5,a5,1
    4e5c:	02c5f733          	remu	a4,a1,a2
    4e60:	972a                	add	a4,a4,a0
    4e62:	00074703          	lbu	a4,0(a4)
    4e66:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4e6a:	872e                	mv	a4,a1
    4e6c:	02c5d5b3          	divu	a1,a1,a2
    4e70:	0685                	addi	a3,a3,1
    4e72:	fec773e3          	bgeu	a4,a2,4e58 <printint+0x22>
  if(neg)
    4e76:	00088b63          	beqz	a7,4e8c <printint+0x56>
    buf[i++] = '-';
    4e7a:	fd078793          	addi	a5,a5,-48
    4e7e:	97a2                	add	a5,a5,s0
    4e80:	02d00713          	li	a4,45
    4e84:	fee78423          	sb	a4,-24(a5)
    4e88:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4e8c:	02f05a63          	blez	a5,4ec0 <printint+0x8a>
    4e90:	fc26                	sd	s1,56(sp)
    4e92:	f44e                	sd	s3,40(sp)
    4e94:	fb840713          	addi	a4,s0,-72
    4e98:	00f704b3          	add	s1,a4,a5
    4e9c:	fff70993          	addi	s3,a4,-1
    4ea0:	99be                	add	s3,s3,a5
    4ea2:	37fd                	addiw	a5,a5,-1
    4ea4:	1782                	slli	a5,a5,0x20
    4ea6:	9381                	srli	a5,a5,0x20
    4ea8:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4eac:	fff4c583          	lbu	a1,-1(s1)
    4eb0:	854a                	mv	a0,s2
    4eb2:	f67ff0ef          	jal	4e18 <putc>
  while(--i >= 0)
    4eb6:	14fd                	addi	s1,s1,-1
    4eb8:	ff349ae3          	bne	s1,s3,4eac <printint+0x76>
    4ebc:	74e2                	ld	s1,56(sp)
    4ebe:	79a2                	ld	s3,40(sp)
}
    4ec0:	60a6                	ld	ra,72(sp)
    4ec2:	6406                	ld	s0,64(sp)
    4ec4:	7942                	ld	s2,48(sp)
    4ec6:	6161                	addi	sp,sp,80
    4ec8:	8082                	ret
    x = -xx;
    4eca:	40b005b3          	neg	a1,a1
    neg = 1;
    4ece:	4885                	li	a7,1
    x = -xx;
    4ed0:	bfad                	j	4e4a <printint+0x14>

0000000000004ed2 <vprintf>:
}
...
{
    4ed2:	711d                	addi	sp,sp,-96
    4ed4:	ec86                	sd	ra,88(sp)
    4ed6:	e8a2                	sd	s0,80(sp)
    4ed8:	e0ca                	sd	s2,64(sp)
    4eda:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4edc:	0005c903          	lbu	s2,0(a1)
    4ee0:	28090663          	beqz	s2,516c <vprintf+0x29a>
    4ee4:	e4a6                	sd	s1,72(sp)
    4ee6:	fc4e                	sd	s3,56(sp)
    4ee8:	f852                	sd	s4,48(sp)
    4eea:	f456                	sd	s5,40(sp)
    4eec:	f05a                	sd	s6,32(sp)
    4eee:	ec5e                	sd	s7,24(sp)
    4ef0:	e862                	sd	s8,16(sp)
    4ef2:	e466                	sd	s9,8(sp)
    4ef4:	8b2a                	mv	s6,a0
    4ef6:	8a2e                	mv	s4,a1
    4ef8:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4f00:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4f04:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4f08:	06c00c93          	li	s9,108
    4f0c:	a005                	j	4f2c <vprintf+0x5a>
        putc(fd, c0);
    4f0e:	85ca                	mv	a1,s2
    4f10:	855a                	mv	a0,s6
    4f12:	f07ff0ef          	jal	4e18 <putc>
    4f16:	a019                	j	4f1c <vprintf+0x4a>
    } else if(state == '%'){
    4f18:	03598263          	beq	s3,s5,4f3c <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4f1c:	2485                	addiw	s1,s1,1
    4f1e:	8726                	mv	a4,s1
    4f20:	009a07b3          	add	a5,s4,s1
    4f24:	0007c903          	lbu	s2,0(a5)
    4f28:	22090a63          	beqz	s2,515c <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4f2c:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4f30:	fe0994e3          	bnez	s3,4f18 <vprintf+0x46>
      if(c0 == '%'){
    4f34:	fd579de3          	bne	a5,s5,4f0e <vprintf+0x3c>
        state = '%';
    4f38:	89be                	mv	s3,a5
    4f3a:	b7cd                	j	4f1c <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4f3c:	00ea06b3          	add	a3,s4,a4
    4f40:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4f44:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4f46:	c681                	beqz	a3,4f4e <vprintf+0x7c>
    4f48:	9752                	add	a4,a4,s4
    4f4a:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4f4e:	05878363          	beq	a5,s8,4f94 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4f52:	05978d63          	beq	a5,s9,4fac <vprintf+0xda>
    ...
    4f56:	07500713          	li	a4,117
    4f5a:	0ee78763          	beq	a5,a4,5048 <vprintf+0x176>
    ...
    4f5e:	07800713          	li	a4,120
    4f62:	12e78963          	beq	a5,a4,5094 <vprintf+0x1c2>
    ...
    4f66:	07000713          	li	a4,112
    4f6a:	14e78e63          	beq	a5,a4,50c6 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4f6e:	06300713          	li	a4,99
    4f72:	18e78e63          	beq	a5,a4,510e <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4f76:	07300713          	li	a4,115
    4f7a:	1ae78463          	beq	a5,a4,5122 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4f7e:	02500713          	li	a4,37
    4f82:	04e79563          	bne	a5,a4,4fcc <vprintf+0xfa>
        putc(fd, '%');
    4f86:	02500593          	li	a1,37
    4f8a:	855a                	mv	a0,s6
    4f8c:	e8dff0ef          	jal	4e18 <putc>
    ...
    4fa0:	855a                	mv	a0,s6
    4fa2:	e95ff0ef          	jal	4e36 <printint>
    4fa6:	8bca                	mv	s7,s2
      state = 0;
    4fa8:	4981                	li	s3,0
    4faa:	bf8d                	j	4f1c <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4fac:	06400793          	li	a5,100
    4fb0:	02f68963          	beq	a3,a5,4fe2 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4fb4:	06c00793          	li	a5,108
    4fb8:	04f68263          	beq	a3,a5,4ffc <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4fbc:	07500793          	li	a5,117
    4fc0:	0af68063          	beq	a3,a5,5060 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    4fc4:	07800793          	li	a5,120
    4fc8:	0ef68263          	beq	a3,a5,50ac <vprintf+0x1da>
        putc(fd, '%');
    4fcc:	02500593          	li	a1,37
    4fd0:	855a                	mv	a0,s6
    4fd2:	e47ff0ef          	jal	4e18 <putc>
        putc(fd, c0);
    4fd6:	85ca                	mv	a1,s2
    4fd8:	855a                	mv	a0,s6
    4fda:	e3fff0ef          	jal	4e18 <putc>
      state = 0;
    4fde:	4981                	li	s3,0
    4fe0:	bf35                	j	4f1c <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    4fee:	855a                	mv	a0,s6
    4ff0:	e47ff0ef          	jal	4e36 <printint>
        i += 1;
    4ff4:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    4ff6:	8bca                	mv	s7,s2
      state = 0;
    4ff8:	4981                	li	s3,0
        i += 1;
    4ffa:	b70d                	j	4f1c <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ffc:	06400793          	li	a5,100
    5000:	02f60763          	beq	a2,a5,502e <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5004:	07500793          	li	a5,117
    5008:	06f60963          	beq	a2,a5,507a <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    500c:	07800793          	li	a5,120
    5010:	faf61ee3          	bne	a2,a5,4fcc <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    5020:	855a                	mv	a0,s6
    5022:	e15ff0ef          	jal	4e36 <printint>
        i += 2;
    ...
    503a:	855a                	mv	a0,s6
    503c:	dfbff0ef          	jal	4e36 <printint>
        i += 2;
    5040:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    5042:	8bca                	mv	s7,s2
      state = 0;
    5044:	4981                	li	s3,0
        i += 2;
    5046:	bdd9                	j	4f1c <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5048:	008b8913          	addi	s2,s7,8
    504c:	4681                	li	a3,0
    504e:	4629                	li	a2,10
    5050:	000be583          	lwu	a1,0(s7)
    5054:	855a                	mv	a0,s6
    5056:	de1ff0ef          	jal	4e36 <printint>
    505a:	8bca                	mv	s7,s2
      state = 0;
    505c:	4981                	li	s3,0
    505e:	bd7d                	j	4f1c <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    506c:	855a                	mv	a0,s6
    506e:	dc9ff0ef          	jal	4e36 <printint>
        i += 1;
    ...
    5086:	855a                	mv	a0,s6
    5088:	dafff0ef          	jal	4e36 <printint>
        i += 2;
    ...
    50a0:	855a                	mv	a0,s6
    50a2:	d95ff0ef          	jal	4e36 <printint>
    50a6:	8bca                	mv	s7,s2
      state = 0;
    50a8:	4981                	li	s3,0
    50aa:	bd8d                	j	4f1c <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    50b8:	855a                	mv	a0,s6
    50ba:	d7dff0ef          	jal	4e36 <printint>
        i += 1;
    ...
    50c2:	4981                	li	s3,0
        i += 1;
    50c4:	bda1                	j	4f1c <vprintf+0x4a>
    50c6:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    50c8:	008b8d13          	addi	s10,s7,8
    50cc:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    50d0:	03000593          	li	a1,48
    50d4:	855a                	mv	a0,s6
    50d6:	d43ff0ef          	jal	4e18 <putc>
  putc(fd, 'x');
    50da:	07800593          	li	a1,120
    50de:	855a                	mv	a0,s6
    50e0:	d39ff0ef          	jal	4e18 <putc>
    50e4:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    50e6:	00003b97          	auipc	s7,0x3
    50ea:	892b8b93          	addi	s7,s7,-1902 # 7978 <digits>
    50ee:	03c9d793          	srli	a5,s3,0x3c
    50f2:	97de                	add	a5,a5,s7
    50f4:	0007c583          	lbu	a1,0(a5)
    50f8:	855a                	mv	a0,s6
    50fa:	d1fff0ef          	jal	4e18 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    50fe:	0992                	slli	s3,s3,0x4
    5100:	397d                	addiw	s2,s2,-1
    5102:	fe0916e3          	bnez	s2,50ee <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5106:	8bea                	mv	s7,s10
      state = 0;
    5108:	4981                	li	s3,0
    510a:	6d02                	ld	s10,0(sp)
    510c:	bd01                	j	4f1c <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    510e:	008b8913          	addi	s2,s7,8
    5112:	000bc583          	lbu	a1,0(s7)
    5116:	855a                	mv	a0,s6
    5118:	d01ff0ef          	jal	4e18 <putc>
    511c:	8bca                	mv	s7,s2
      state = 0;
    511e:	4981                	li	s3,0
    5120:	bbf5                	j	4f1c <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    5122:	008b8993          	addi	s3,s7,8
    5126:	000bb903          	ld	s2,0(s7)
    512a:	00090f63          	beqz	s2,5148 <vprintf+0x276>
        for(; *s; s++)
    512e:	00094583          	lbu	a1,0(s2)
    5132:	c195                	beqz	a1,5156 <vprintf+0x284>
          putc(fd, *s);
    5134:	855a                	mv	a0,s6
    5136:	ce3ff0ef          	jal	4e18 <putc>
        for(; *s; s++)
    513a:	0905                	addi	s2,s2,1
    513c:	00094583          	lbu	a1,0(s2)
    5140:	f9f5                	bnez	a1,5134 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5142:	8bce                	mv	s7,s3
      state = 0;
    5144:	4981                	li	s3,0
    5146:	bbd9                	j	4f1c <vprintf+0x4a>
          s = "(null)";
    5148:	00002917          	auipc	s2,0x2
    514c:	78090913          	addi	s2,s2,1920 # 78c8 <malloc+0x2674>
        for(; *s; s++)
    5150:	02800593          	li	a1,40
    5154:	b7c5                	j	5134 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5156:	8bce                	mv	s7,s3
      state = 0;
    5158:	4981                	li	s3,0
    515a:	b3c9                	j	4f1c <vprintf+0x4a>
    515c:	64a6                	ld	s1,72(sp)
    515e:	79e2                	ld	s3,56(sp)
    5160:	7a42                	ld	s4,48(sp)
    5162:	7aa2                	ld	s5,40(sp)
    5164:	7b02                	ld	s6,32(sp)
    5166:	6be2                	ld	s7,24(sp)
    5168:	6c42                	ld	s8,16(sp)
    516a:	6ca2                	ld	s9,8(sp)
    }
  }
}
    516c:	60e6                	ld	ra,88(sp)
    516e:	6446                	ld	s0,80(sp)
    5170:	6906                	ld	s2,64(sp)
    5172:	6125                	addi	sp,sp,96
    5174:	8082                	ret

0000000000005176 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5176:	715d                	addi	sp,sp,-80
    5178:	ec06                	sd	ra,24(sp)
    517a:	e822                	sd	s0,16(sp)
    517c:	1000                	addi	s0,sp,32
    517e:	e010                	sd	a2,0(s0)
    5180:	e414                	sd	a3,8(s0)
    5182:	e818                	sd	a4,16(s0)
    5184:	ec1c                	sd	a5,24(s0)
    5186:	03043023          	sd	a6,32(s0)
    518a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    518e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5192:	8622                	mv	a2,s0
    5194:	d3fff0ef          	jal	4ed2 <vprintf>
}
    5198:	60e2                	ld	ra,24(sp)
    519a:	6442                	ld	s0,16(sp)
    519c:	6161                	addi	sp,sp,80
    519e:	8082                	ret

00000000000051a0 <printf>:

void
printf(const char *fmt, ...)
{
    51a0:	711d                	addi	sp,sp,-96
    51a2:	ec06                	sd	ra,24(sp)
    51a4:	e822                	sd	s0,16(sp)
    51a6:	1000                	addi	s0,sp,32
    51a8:	e40c                	sd	a1,8(s0)
    51aa:	e810                	sd	a2,16(s0)
    51ac:	ec14                	sd	a3,24(s0)
    51ae:	f018                	sd	a4,32(s0)
    51b0:	f41c                	sd	a5,40(s0)
    51b2:	03043823          	sd	a6,48(s0)
    51b6:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    51ba:	00840613          	addi	a2,s0,8
    51be:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    51c2:	85aa                	mv	a1,a0
    51c4:	4505                	li	a0,1
    51c6:	d0dff0ef          	jal	4ed2 <vprintf>
}
    51ca:	60e2                	ld	ra,24(sp)
    51cc:	6442                	ld	s0,16(sp)
    51ce:	6125                	addi	sp,sp,96
    51d0:	8082                	ret

00000000000051d2 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    51d2:	1141                	addi	sp,sp,-16
    51d4:	e422                	sd	s0,8(sp)
    51d6:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    51d8:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    51dc:	00004797          	auipc	a5,0x4
    51e0:	2b47b783          	ld	a5,692(a5) # 9490 <freep>
    51e4:	a02d                	j	520e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    51e6:	4618                	lw	a4,8(a2)
    51e8:	9f2d                	addw	a4,a4,a1
    51ea:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    51ee:	6398                	ld	a4,0(a5)
    51f0:	6310                	ld	a2,0(a4)
    51f2:	a83d                	j	5230 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    51f4:	ff852703          	lw	a4,-8(a0)
    51f8:	9f31                	addw	a4,a4,a2
    51fa:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    51fc:	ff053683          	ld	a3,-16(a0)
    5200:	a091                	j	5244 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5202:	6398                	ld	a4,0(a5)
    5204:	00e7e463          	bltu	a5,a4,520c <free+0x3a>
    5208:	00e6ea63          	bltu	a3,a4,521c <free+0x4a>
{
    520c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    520e:	fed7fae3          	bgeu	a5,a3,5202 <free+0x30>
    5212:	6398                	ld	a4,0(a5)
    5214:	00e6e463          	bltu	a3,a4,521c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5218:	fee7eae3          	bltu	a5,a4,520c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    521c:	ff852583          	lw	a1,-8(a0)
    5220:	6390                	ld	a2,0(a5)
    5222:	02059813          	slli	a6,a1,0x20
    5226:	01c85713          	srli	a4,a6,0x1c
    522a:	9736                	add	a4,a4,a3
    522c:	fae60de3          	beq	a2,a4,51e6 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5230:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5234:	4790                	lw	a2,8(a5)
    5236:	02061593          	slli	a1,a2,0x20
    523a:	01c5d713          	srli	a4,a1,0x1c
    523e:	973e                	add	a4,a4,a5
    5240:	fae68ae3          	beq	a3,a4,51f4 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5244:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5246:	00004717          	auipc	a4,0x4
    524a:	24f73523          	sd	a5,586(a4) # 9490 <freep>
}
    524e:	6422                	ld	s0,8(sp)
    5250:	0141                	addi	sp,sp,16
    5252:	8082                	ret

0000000000005254 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5254:	7139                	addi	sp,sp,-64
    5256:	fc06                	sd	ra,56(sp)
    5258:	f822                	sd	s0,48(sp)
    525a:	f426                	sd	s1,40(sp)
    525c:	ec4e                	sd	s3,24(sp)
    525e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5260:	02051493          	slli	s1,a0,0x20
    5264:	9081                	srli	s1,s1,0x20
    5266:	04bd                	addi	s1,s1,15
    5268:	8091                	srli	s1,s1,0x4
    526a:	0014899b          	addiw	s3,s1,1
    526e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5270:	00004517          	auipc	a0,0x4
    5274:	22053503          	ld	a0,544(a0) # 9490 <freep>
    5278:	c915                	beqz	a0,52ac <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    527a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    527c:	4798                	lw	a4,8(a5)
    527e:	08977a63          	bgeu	a4,s1,5312 <malloc+0xbe>
  ...
  if(nu < 4096)
    528a:	8a4e                	mv	s4,s3
    528c:	0009871b          	sext.w	a4,s3
    5290:	6685                	lui	a3,0x1
    5292:	00d77363          	bgeu	a4,a3,5298 <malloc+0x44>
    5296:	6a05                	lui	s4,0x1
    5298:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    529c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    52a0:	00004917          	auipc	s2,0x4
    52a4:	1f090913          	addi	s2,s2,496 # 9490 <freep>
  if(p == SBRK_ERROR)
    52a8:	5afd                	li	s5,-1
    52aa:	a081                	j	52ea <malloc+0x96>
    52ac:	f04a                	sd	s2,32(sp)
    52ae:	e852                	sd	s4,16(sp)
    52b0:	e456                	sd	s5,8(sp)
    52b2:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    52b4:	0000b797          	auipc	a5,0xb
    52b8:	a0478793          	addi	a5,a5,-1532 # fcb8 <base>
    52bc:	00004717          	auipc	a4,0x4
    52c0:	1cf73a23          	sd	a5,468(a4) # 9490 <freep>
    52c4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    52c6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    52ca:	b7c1                	j	528a <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    52cc:	6398                	ld	a4,0(a5)
    52ce:	e118                	sd	a4,0(a0)
    52d0:	a8a9                	j	532a <malloc+0xd6>
  hp->s.size = nu;
    52d2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    52d6:	0541                	addi	a0,a0,16
    52d8:	efbff0ef          	jal	51d2 <free>
  return freep;
    52dc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    52e0:	c12d                	beqz	a0,5342 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    52e2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    52e4:	4798                	lw	a4,8(a5)
    52e6:	02977263          	bgeu	a4,s1,530a <malloc+0xb6>
    if(p == freep)
    52ea:	00093703          	ld	a4,0(s2)
    52ee:	853e                	mv	a0,a5
    52f0:	fef719e3          	bne	a4,a5,52e2 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    52f4:	8552                	mv	a0,s4
    52f6:	a47ff0ef          	jal	4d3c <sbrk>
  if(p == SBRK_ERROR)
    52fa:	fd551ce3          	bne	a0,s5,52d2 <malloc+0x7e>
        return 0;
    52fe:	4501                	li	a0,0
    5300:	7902                	ld	s2,32(sp)
    5302:	6a42                	ld	s4,16(sp)
    5304:	6aa2                	ld	s5,8(sp)
    5306:	6b02                	ld	s6,0(sp)
    5308:	a03d                	j	5336 <malloc+0xe2>
    530a:	7902                	ld	s2,32(sp)
    530c:	6a42                	ld	s4,16(sp)
    530e:	6aa2                	ld	s5,8(sp)
    5310:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5312:	fae48de3          	beq	s1,a4,52cc <malloc+0x78>
        p->s.size -= nunits;
    5316:	4137073b          	subw	a4,a4,s3
    531a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    531c:	02071693          	slli	a3,a4,0x20
    5320:	01c6d713          	srli	a4,a3,0x1c
    5324:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5326:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    532a:	00004717          	auipc	a4,0x4
    532e:	16a73323          	sd	a0,358(a4) # 9490 <freep>
      return (void*)(p + 1);
    5332:	01078513          	addi	a0,a5,16
  }
}
    5336:	70e2                	ld	ra,56(sp)
    5338:	7442                	ld	s0,48(sp)
    533a:	74a2                	ld	s1,40(sp)
    533c:	69e2                	ld	s3,24(sp)
    533e:	6121                	addi	sp,sp,64
    5340:	8082                	ret
    5342:	7902                	ld	s2,32(sp)
    5344:	6a42                	ld	s4,16(sp)
    5346:	6aa2                	ld	s5,8(sp)
    5348:	6b02                	ld	s6,0(sp)
    534a:	b7f5                	j	5336 <malloc+0xe2>
